...
mysql_select_db($database_CostaverdeFM, $CostaverdeFM);
$query_equipe = "SELECT * FROM programacao ORDER BY nome ASC";
                ...
                <tr>
                  <th align="center" valign="top" scope="row"><?php do { ?>
                      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" class="borda_pont_preta_botton">
                        <tr>
                          <th width="20%" align="center" valign="top" scope="col">&nbsp;<a href="programa.php?id=<?php echo $row_equipe['id']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("", "fotos/", "{equipe.imagem}", 100, 0, true); ?>" border="0" class="borda_preta_1px" /></a></th>
                          <th width="80%" align="left" valign="top" class="top_num" scope="col"><?php echo $row_equipe['nome']; ?><br />
                            <table width="97" border="0" cellpadding="0" cellspacing="2" class="borda_preta_1px" id="link">
                                  <tr>
                                    <th width="91" align="center" scope="col"><span class="top_musica"><a href="programa.php?id=<?php echo $row_equipe['id']; ?>">Leia  mais</a></span></th>
                                  </tr>
                                </table></th>
                        </tr>
                      </table>
                      <?php } while ($row_equipe = mysql_fetch_assoc($equipe)); ?></th>
                </tr>
              </table></th>
