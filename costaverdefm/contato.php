...
if ( isset( $_POST["submit"] ) ) 
{
	...
	$remetente = "sorteio@costaverdefm.com.br";
	$cabecalho = "From: \"Costa Verde FM\" <sorteio@costaverdefm.com.br>\n";
                  ...
                  <th width="61%" scope="col"><table width="100%" border="0" cellspacing="3" cellpadding="0">
                      ...
                      <tr>
                        <th align="center" valign="top" scope="row"><table width="73%" border="0" cellspacing="4" cellpadding="0">
                          <tr>
                            <th height="77" align="left" valign="top" scope="row"><p>Para entrar em contato com a R&aacute;dio envie mensagem para os seguintes emails:</p>
                              <ul>
                                <li>contato@costaverdefm.com.br</li>
                                <li>promocao@costaverdefm.com.br </li>
                              </ul></th>
                          </tr>
                          <tr>
                            <th height="30" align="left" valign="top" scope="row"><span class="top_num">Se preferir  preencha o formul&aacute;rio abaixo!<br />
    ...
    <td align="center"><table width="100%" border="0" cellpadding="6" cellspacing="2" bordercolor="#FFFFFF">
      ...
      <tr>
        <th height="54" align="left" valign="top" scope="col"><div id="conteudo_interno" class="left">
          ...
          <div>
              <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" onsubmit="MM_validateForm('Nome','','R','Idade','','R','Email','','RisEmail','Telefone','','R','Mensagem','','R');return document.MM_returnValue">
                ...
                <label for="Endereco" class="titulo_coment">Mensagem:</label>
