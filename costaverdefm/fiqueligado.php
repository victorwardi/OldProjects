              ...
              <th width="73%" align="center" valign="top" scope="col"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr>
                  <th align="left" valign="top" scope="row"><?php do { ?>
                      <table width="95%" border="0" cellpadding="0" cellspacing="2" class="borda_pont_preta_botton">
                        <tr>
                            <th width="19%" rowspan="2" align="left" valign="top" scope="col">&nbsp;<a href="verligado.php?id=<?php echo $row_ligado['id']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("", "fotos/", "{ligado.imagem}", 80, 60, false); ?>" border="0" class="borda_preta_1px" /></a></th>
                            <th width="81%" align="left" valign="middle" class="top_num" scope="col"><?php echo $row_ligado['titulo']; ?> - <?php echo $row_ligado['data']; ?></th>
                        </tr>
                        <tr>
                            <td align="left" valign="top" class="recado"><a href="verligado.php?id=<?php echo $row_ligado['id']; ?>" class="recado"><?php echo $row_ligado['descricao']; ?></a></td>
                        </tr>
                        <tr>
                      ...
                      <?php } while ($row_ligado = mysql_fetch_assoc($ligado)); ?></th>
                </tr>
              </table></th>
