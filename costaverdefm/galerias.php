              ...
              <th width="73%" align="center" valign="top" scope="col"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr>
                  <th align="left" scope="row"><?php do { ?>
                      <table width="100%" border="0" cellpadding="0" cellspacing="2" class="borda_pont_preta_botton">
                        <tr>
                          <th width="20%" rowspan="2" align="center" valign="top" scope="col">&nbsp;<a href="galeria.php?id=<?php echo $row_galerias['id']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("", "fotos/", "{galerias.imagem}", 100, 75, false); ?>" alt="<?php echo $row_galerias['nome']; ?>" border="0" class="borda_preta_1px" /></a></th>
                          <th width="80%" align="left" valign="top" scope="col"><span class="top_cantor"><?php echo $row_galerias['nome']; ?> - <?php echo $row_galerias['data']; ?></span><span class="top_musica"><br />
                            <?php echo $row_galerias['descricao']; ?></span></th>
                        </tr>
                        <tr>
                          <th align="left" valign="top" scope="col"><table width="100" border="0" cellpadding="0" cellspacing="2" class="borda_preta_1px" id="link">
                            <tr>
                              <th scope="col"><span class="top_musica"><a href="galeria.php?id=<?php echo $row_galerias['id']; ?>">Ver Galeria</a> </span></th>
                            </tr>
                          </table></th>
                        </tr>
                                            </table>
                      <?php } while ($row_galerias = mysql_fetch_assoc($galerias)); ?></th>
                </tr>
                <tr>
                  <th scope="row">&nbsp;</th>
                </tr>
