...
mysql_select_db($database_CostaverdeFM, $CostaverdeFM);
$query_equipe = "SELECT * FROM equipe ORDER BY nome ASC";
          ...
          <table width="100%" border="0" cellspacing="2" cellpadding="0">
            <tr>
              <th width="73%" align="center" valign="top" scope="col"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr>
                  <th align="center" valign="top" scope="row"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" class="borda_pont_preta_botton">
                    <tr>
                      <th width="20%" align="center" valign="top" scope="col">&nbsp;<img src="<?php echo tNG_showDynamicThumbnail("", "fotos/", "{equipe.foto}", 100, 0, true); ?>" class="borda_preta_1px" /></th>
                      <th width="80%" align="left" valign="top" class="top_num" scope="col"><?php echo $row_equipe['nome']; ?><br />
                        <span class="top_musica"><?php echo $row_equipe['idade']; ?></span></th>
                    </tr>
