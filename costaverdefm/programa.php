...
mysql_select_db($database_CostaverdeFM, $CostaverdeFM);
$query_equipe = sprintf("SELECT * FROM programacao WHERE id = %s ORDER BY nome ASC", $colname_equipe);
$equipe = mysql_query($query_equipe, $CostaverdeFM) or die(mysql_error());
              ...
              <th width="73%" align="center" valign="top" scope="col"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <th scope="col"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="titulos">
                    <tr>
                      <th scope="col">Programa&ccedil;&atilde;o</th>
                    </tr>
                  </table></th>
                </tr>
                <tr>
                ...
                <tr>
                  <th align="center" valign="top" scope="row"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
                    
                    <tr>
                      <th height="48" align="center" valign="top" scope="col">&nbsp;<img src="<?php echo tNG_showDynamicImage("", "fotos/", "{equipe.imagem}");?>" class="borda_preta_1px" /></th>
                      </tr>
                    <tr>
                      <th height="22" align="center" valign="top" scope="col"><span class="top_num"><?php echo $row_equipe['nome']; ?></span></th>
                    </tr>
                    <tr>
                      <th height="19" align="center" valign="middle" scope="col"><span class="top_musica_index">hor&aacute;rio: <?php echo $row_equipe['horario']; ?></span></th>
                      </tr>
                    <tr>
                      <th align="center" valign="top" class="recado" scope="col"><?php echo $row_equipe['descricao']; ?></th>
                    </tr>
