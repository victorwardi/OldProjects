...
$query_noticia = sprintf("SELECT * FROM noticias WHERE id = %s", $colname_noticia);
$noticia = mysql_query($query_noticia, $CostaverdeFM) or die(mysql_error());
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <th align="left" valign="top" scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <th width="73%" height="70" align="left" valign="top" scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                    <tr>
                      <th align="left" valign="top" class="Titulo_Not" scope="col"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="titulos">
                          <tr>
                            <th scope="col">Not&iacute;cias</th>
                          </tr>
                      </table></th>
                    </tr>
                    <tr>
                      <th align="left" valign="top" class="titulo_noticia" scope="row"><?php echo $row_noticia['titulo']; ?></th>
                    </tr>
                    <tr>
                      <th align="left" valign="top" scope="row"><table width="100%" border="0" cellpadding="0" cellspacing="4" bgcolor="#FFFFFF">
                          <tr>
                            <td height="20" align="left"><span class="top_cantor">Fonte:</span> <span class="top_musica"><?php echo $row_noticia['fonte']; ?></span></td>
                            <td align="left"><span class="top_cantor">Data:</span> <span class="top_musica"><?php echo $row_noticia['data']; ?> </span></td>
                          </tr>
                          <tr>
                            <td height="108" colspan="2" align="left" bgcolor="#FFFFFF"><table width="58" border="0" align="right" cellpadding="4" cellspacing="2">
                                <tr>
                                  <td width="54" align="center"><table width="100%" border="0" cellpadding="4" bgcolor="#9EF1AD" class="borda_preta_1px">
                                      <tr>
                                        <td align="left"><img src="<?php echo tNG_showDynamicThumbnail("", "fotos/", "{noticia.imagem}", 200, 0, true); ?>" /><br />
                                            <span class="top_musica">Foto:<?php echo $row_noticia['descricao_imagem']; ?></span></td>
                                      </tr>
                                    </table>
                                      <br />
                                  </td>
                                ...
                                <div align="justify"><?php echo $row_noticia['materia']; ?></div></td>
                          </tr>
                      </table></th>
                    </tr>
                    <tr>
                  ...
                  <th width="27%" align="right" valign="top" scope="col"><table width="200" border="0" align="right" cellpadding="0" cellspacing="0" >
                    <tr>
