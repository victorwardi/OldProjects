...
$ins_ligado->registerTrigger("END", "Trigger_Default_Redirect", 99, "ligado_edite.php");
...
$upd_ligado->registerTrigger("END", "Trigger_Default_Redirect", 99, "ligado_edite.php");
        ...
        <tr>
          <td>&nbsp;
            <table width="100%" border="0" cellpadding="0" cellspacing="2" class="titulos">
              <tr>
                <th height="27" align="left" scope="col">Inserir Fique Ligado </th>
              </tr>
            </table>
            <div class="KT_tng">
