...
?>
        <div class="KT_tng">
          <table width="100%" border="0" cellpadding="0" cellspacing="2" class="titulos">
            <tr>
              <th height="27" align="left" scope="col">Galeria de Fotos </th>
            </tr>
          </table>
...
?>
                <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                  ...
                  <tr>
                    ...
                    <td><textarea name="descricao_<?php echo $cnt1; ?>" cols="35" rows="4" id="descricao_<?php echo $cnt1; ?>"><?php echo KT_escapeAttribute($row_rsgaleria['descricao']); ?></textarea>
