...
mysql_select_db($database_CostaverdeFM, $CostaverdeFM);
$query_destaques = "SELECT * FROM noticias ORDER BY id DESC";
$destaques = mysql_query($query_destaques, $CostaverdeFM) or die(mysql_error());
              ...
              <th width="73%" align="center" valign="top" scope="col"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr>
                  <th align="left" valign="top" scope="row"><?php do { ?>
                      <table width="95%" border="0" cellspacing="4" cellpadding="0">
                        <tr>
                          <th scope="col"><table width="95%" border="0" cellpadding="0" cellspacing="2" class="borda_pont_preta_botton">
                            <tr>
                              <th width="20%" rowspan="2" align="left" valign="top" scope="col">&nbsp;<a href="noticia.php?id=<?php echo $row_destaques['id']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("", "fotos/", "{destaques.imagem}", 80, 0, true); ?>" border="0" class="borda_preta_1px" /></a></th>
                              <th width="80%" align="left" valign="top" class="top_num" scope="col"><?php echo $row_destaques['titulo']; ?> - <?php echo $row_destaques['data']; ?></th>
                            </tr>
                            <tr>
                              <th align="left" valign="top" class="top_num" scope="col"><table width="97" border="0" cellpadding="0" cellspacing="2" class="borda_preta_1px" id="link">
                                <tr>
                                  <th width="91" align="center" scope="col"><span class="top_musica"><a href="noticia.php?id=<?php echo $row_destaques['id']; ?>">Leia  mais</a></span></th>
                                </tr>
                              </table></th>
                            </tr>
                      ...
                      <?php } while ($row_destaques = mysql_fetch_assoc($destaques)); ?></th>
                </tr>
                <tr>
