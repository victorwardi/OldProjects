...
$colname_mostra_anuncio = "-1";
if (isset($_GET['id'])) {
  $colname_mostra_anuncio = (get_magic_quotes_gpc()) ? $_GET['id'] : addslashes($_GET['id']);
}
mysql_select_db($database_CostaverdeFM, $CostaverdeFM);
$query_mostra_anuncio = sprintf("SELECT * FROM anuncios WHERE id = %s ORDER BY id ASC", $colname_mostra_anuncio);
$mostra_anuncio = mysql_query($query_mostra_anuncio, $CostaverdeFM) or die(mysql_error());
$row_mostra_anuncio = mysql_fetch_assoc($mostra_anuncio);
$totalRows_mostra_anuncio = mysql_num_rows($mostra_anuncio);
          ...
          <table width="100%" border="0" cellspacing="2" cellpadding="0">
            <tr>
              <th width="73%" align="center" valign="top" scope="col"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr>
                  <th align="center" valign="top" scope="row"><table width="95%" border="0" cellpadding="4" cellspacing="0" class="borda_verde_1px">
                    <tr>
                      <td align="center" bgcolor="#10831E" class="titulo_anuncio"><?php echo $row_mostra_anuncio['empresa']; ?></td>
                    </tr>
                    <tr>
                      <th align="center" valign="top" class="titulo_noticia" scope="row">&nbsp;<img src="<?php echo tNG_showDynamicImage("", "fotos/", "{mostra_anuncio.banner}");?>" border="0" class="borda_preta_1px" /></th>
                    </tr>
                    <tr>
                      <th align="left" valign="top" class="titulo_noticia" scope="row"><span class="top_cantor">Endere&ccedil;o:</span> <span class="top_musica"><?php echo $row_mostra_anuncio['endereco']; ?></span></th>
                    </tr>
                    <tr>
                      <th align="left" valign="top" scope="row"><span class="top_cantor">Telefone: </span><span class="top_musica"><?php echo $row_mostra_anuncio['telefone']; ?></span></th>
                    </tr>
                    <tr>
                      <td align="left" class="fonte_11_lighter"><?php echo $row_mostra_anuncio['descricao']; ?></td>
                    </tr>
                    <tr>
                      <td align="left" class="fonte_11_lighter">&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" class="fonte_11_lighter"><p class="top_num">Para anunciar entre em contato conosco:</p>
                        <ul>
                          <li> Email: contato@costaverdefm.com.br </li>
                          <li> Telefone: 21 8888 88</li>
                        </ul></td>
                    </tr>
                  </table></th>
                </tr>
...
mysql_free_result($mostra_anuncio);
?>
