...
?>
            <div class="KT_tng">
              <table width="100%" border="0" cellpadding="0" cellspacing="2" class="titulos">
                <tr>
                  <th height="27" align="left" scope="col">Foto </th>
                </tr>
              </table>
...
do {  
?>
                            <option value="<?php echo $row_galeria['id']?>"<?php if (!(strcmp($row_galeria['id'], $row_rsfotos['id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_galeria['nome']?></option>
                            <?php
