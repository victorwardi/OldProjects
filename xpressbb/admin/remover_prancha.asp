...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "prancha"
  MM_editColumn = "CodNoticia"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "remover_prancha.asp"
...
RsAltera.Source = "SELECT * FROM prancha ORDER BY CodNoticia DESC"
...
<table width="741" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="739" height="25" bgcolor="#66CC99"><div align="center"><span class="tur"> <span class="style2"><span class="style1">:: Remover Prancha :: <br>
...
%>
          <td><table width="100" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl">
                <tr>
                  <td width="100" height="18" align="left" valign="middle"><strong> </strong>
                    <table width="100" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <th scope="col"><strong><img src="../fotos/prancha/<%=(RsAltera.Fields.Item("Foto").Value)%>" alt="" width="60" height="80" border="1" class="brdnoticia"></strong></th>
                      </tr>
                      <tr>
                        <td><div align="center"><strong class="descmar">
                          <input name="MM_recordId" type="radio" value="<%=(RsAltera.Fields.Item("CodNoticia").Value)%>">
                          <%=(RsAltera.Fields.Item("titulo").Value)%></strong></div></td>
                      </tr>
                                    </table></td>
                </tr>
          </table></td>
