...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "removerfotos_galeria.asp"
...
<table width="638" height="239" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="638" height="25" bordercolor="#E0DFE3" bgcolor="#66CC99"><div align="center"><span class="tur style1">:: Remover Fotos das Galerias::            <span class="style7"> </span><br>
    </span></div></td>
  </tr>
  <tr>
    <td align="center">
