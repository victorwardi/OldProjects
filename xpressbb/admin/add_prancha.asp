...
destino= pasta & "fotos\prancha\" & nomecompletoimg

	File.SaveAs pasta & "fotos\prancha\original\" & File.OriginalFileName
...
<table width="463" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999">
  <tr>
    <td width="459" height="25" align="center" bgcolor="#66CC99"><div align="center"><span class="tur"><span class="style2">:: Adicionar Prancha:: </span></span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
      <form action="add_prancha.asp" method="post" enctype="multipart/form-data" target="_self" id=form>
        <div align="center">
          <center>
            <table width="459" border="0" cellpadding="5" cellspacing="0" class="tbl">
              <tr>
                <td width="58" valign="top"><div align="center">Modelo:</div></td>
                <td width="381"><input name="titulo" type="text" id="textarea10" style="border-style: solid; border-width: 0" value="<%=titulo%>" size="45"></td>
              </tr>
              <tr>
                <td valign="top"><div align="center">Detalhes:</div></td>
                <td><textarea name="resumo" cols="45" rows="4" id="textarea10" style="border-style: solid; border-width: 0"><%=resumo%></textarea></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><table width="215" border="0" cellpadding="0" cellspacing="0" class="tbl">
                    ...
                    <tr>
                      <td height="36" colspan="2" valign="top"><img src="../fotos/prancha/<%=Session("nomedb")%>" alt="" border="0"></td>
                      <td width="144">&nbsp;</td>
