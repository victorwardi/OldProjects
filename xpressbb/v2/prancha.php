...
$query_noticia = sprintf("SELECT * FROM pranchas WHERE id = %s ORDER BY id DESC", $colname_noticia);
      ...
      <table width="100%" border="0" cellspacing="4" cellpadding="0">
        <tr>
          <th colspan="2" align="left" valign="top" bgcolor="#585F89" class="titulo_not" scope="col"><table width="100%" border="0" cellspacing="4" cellpadding="0">
              <tr>
                <th align="left" valign="middle" class="branco_14" scope="col">Prancha -  <?php echo $row_noticia['nome']; ?></th>
              </tr>
          </table></th>
        </tr>
        
        <tr>
          <th width="9%" align="left" valign="top" scope="col"><img src="<?php echo tNG_showDynamicThumbnail("../", "../uploads/fotos/", "{noticia.foto}", 250, 0, true); ?>" class="borda_4px" /></th>
          <th width="91%" align="left" valign="top" class="fonte_menu" scope="col"><?php echo $row_noticia['descricao']; ?></th>
        </tr>
        <tr>
        ...
        <tr>
          <th height="25" colspan="2" align="left" valign="middle" bgcolor="#585F89" scope="col"><table width="100%" border="0" cellspacing="4" cellpadding="0">
              <tr>
                <th align="left" valign="middle" class="branco_14" scope="col">Gostou  dessa prancha?</th>
              </tr>
          </table></th>
        </tr>
        <tr>
          <th colspan="2" align="left" valign="top" scope="col"><span class="fonte_menu">Entre em contato conosco <a href="contato.php" class="texto_titulo">clicando aqui </a><br />
ou compre pela internet, acessando: </span>
            <ul>
