...
$query_pranchas = "SELECT * FROM pranchas ORDER BY id DESC";
          ...
          <th align="left" valign="top" scope="col"><table width="100%" border="0" cellspacing="4" cellpadding="0">
            <tr>
              <th align="left" valign="top" bgcolor="#585F89" class="titulo_not" scope="col"><table width="100%" border="0" cellspacing="4" cellpadding="0">
                  <tr>
                    <th align="left" valign="middle" bgcolor="#585F89" class="branco_14" scope="col">Pranchas</th>
                  </tr>
              </table></th>
            </tr>
            <tr>
              <th align="left" valign="top" class="sub_not_data" scope="col">Confira todos os shapes produzidos pela Xpress e escolha o melhor para voc&ecirc;! </th>
            </tr>
            <tr>
...
?>
                    <td height="103"><table width="100" border="0" cellspacing="0" cellpadding="2">
                          <tr>
                              <th align="center" valign="top" scope="col">&nbsp;<a href="prancha.php?id=<?php echo $row_pranchas['id']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("../", "../uploads/fotos/", "{pranchas.foto}", 120, 0, true); ?>" border="0" class="borda_2px" /></a></th>
                          </tr>
                          <tr>
                              <th height="43" align="center" valign="middle" class="fonte" scope="row"><a href="prancha.php?id=<?php echo $row_pranchas['id']; ?>"><?php echo $row_pranchas['nome']; ?></a></th>
                          </tr>
                        </table></td>
                    <?php
    $row_pranchas = mysql_fetch_assoc($pranchas);
...
?>
            ...
            <tr>
              <th align="left" valign="top" bgcolor="#585F89" class="branco_14" scope="col"><table width="100%" border="0" cellspacing="4" cellpadding="0">
                  <tr>
                    <th align="left" valign="middle" class="branco_14" scope="col">Gostou de alguma dessas pranchas? </th>
                  </tr>
                </table></th>
            </tr>
            <tr>
              <th align="left" valign="top" scope="col"><span class="fonte_menu">Entre em contato conosco <a href="contato.php" class="texto_titulo">clicando aqui </a><br />
                ou compre pela internet, acessando: 
                  </span>
                <ul>
                    <li class="fonte_menu"><a href="http://www.lacquashop.com.br">www.lacquashop.com.br</a> </li>
                    <li class="fonte_menu"><a href="http://www.lacquashop.com.br">www.vibbeshop.com</a></li>
                  </ul>                
                  <p><span class="fonte_menu">OBS: N&atilde;o gostou de nenhuma! N&atilde;o tem problema, fazemos a prancha do jeito que voc&ecirc; quiser!                    <br />
                  Fale conosco e saiba como ter um Shape </span><span class="total">personalizado</span><span class="fonte_menu">, de acordo com seu peso, altura e prefer&ecirc;ncias</span>. </p>
                  <p>&nbsp;</p></th>
            </tr>
