          ...
          <th align="left" scope="col"><table width="100%" border="0" cellspacing="4" cellpadding="0">
            <tr>
              <th colspan="2" align="left" valign="top" bgcolor="#585F89" class="titulo_not" scope="col"><table width="100%" border="0" cellspacing="4" cellpadding="0">
                  <tr>
                    <th align="left" valign="middle" class="branco_14" scope="col">Novidades - Arquivo </th>
                  </tr>
              </table></th>
            </tr>
            <tr>
              <th width="2%" rowspan="3" align="left" valign="top" scope="col">&nbsp;</th>
              <th align="left" valign="top" class="sub_not_data" scope="col"><?php do { ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="0" class="linha_1px_pontilhada">
                    <tr>
                      ...
                      <th width="91%" align="left" valign="top" class="fonte_menu" scope="col"><?php echo $row_noticia['titulo']; ?><br />
                        <span class="sub_not_data"><?php echo $row_noticia['data']; ?></span></th>
                    </tr>
                    <tr>
                        <td align="left" valign="top" class="sub_not_data"><table width="100" border="1" cellpadding="1" cellspacing="0" bordercolor="#052C4B" bgcolor="#FFFFFF">
                          <tr>
                            <th align="center" valign="middle" scope="col"><a href="novidade.php?id=<?php echo $row_noticia['id']; ?>">Ler Novidade </a></th>
                          </tr>
                        </table></td>
                    </tr>
                                    </table>
            ...
            <tr>
              <th align="left" valign="top" class="sub_not_data" scope="col">&nbsp;</th>
            </tr>
            <tr>
              <th width="98%" align="left" valign="top" scope="col">&nbsp;</th>
            </tr>
          </table></th>
        </tr>
      </table>
