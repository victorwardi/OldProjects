...
$query_noticia = sprintf("SELECT * FROM equipe WHERE id = %s ORDER BY id DESC", $colname_noticia);
      ...
      <table width="100%" border="0" cellspacing="4" cellpadding="0">
        <tr>
          <th colspan="2" align="left" valign="top" bgcolor="#585F89" class="titulo_not" scope="col"><table width="100%" border="0" cellspacing="4" cellpadding="0">
              <tr>
                <th align="left" valign="middle" class="branco_14" scope="col">Equipe -  <?php echo $row_noticia['nome']; ?></th>
              </tr>
          </table></th>
        </tr>
