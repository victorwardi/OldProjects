      ...
      <table width="100%" border="0" cellspacing="4" cellpadding="0">
        <tr>
          <th colspan="2" align="left" valign="top" bgcolor="#585F89" class="titulo_not" scope="col"><table width="100%" border="0" cellspacing="4" cellpadding="0">
              <tr>
                <th align="left" valign="middle" class="branco_14" scope="col">Oferta - Promo&ccedil;&atilde;o - <?php echo $row_noticia['nome']; ?></th>
              </tr>
          </table></th>
        </tr>
        <tr>
          ...
          <th align="left" valign="top" class="sub_not_data" scope="col"><span class="fonte">Pre&ccedil;o: </span><span class="total"><?php echo $row_noticia['preco']; ?><br />
            <br />
            <span class="fonte_menu"><?php echo $row_noticia['descricao']; ?></span></span></th>
        </tr>
        <tr>
