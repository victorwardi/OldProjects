...
if (isset($_SESSION['MM_Username'])) {
  $colname_home = (get_magic_quotes_gpc()) ? $_SESSION['MM_Username'] : addslashes($_SESSION['MM_Username']);
}
mysql_select_db($database_ConBD, $ConBD);
$query_home = sprintf("SELECT * FROM lojas WHERE login = '%s'", $colname_home);
            ...
            <td><table width="553" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="355" valign="top" class="txt_02"><table width="355" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="left" valign="top"><img src="<?php echo tNG_showDynamicImage("../", "../Uploads/fotos/", "{home.logotipo}");?>" /></td>
                  </tr>
                  <tr>
                    <td height="20">&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    <td height="20"><?php if ($row_home ['promocao1'] == "") { // Show if recordset empty ?>
                        <span class="txt_09">Nenhuma promo&ccedil;&atilde;o cadastrada!</span>                        <?php } // Show if recordset empty ?></td>
                  </tr>
                  <tr>
              ...
              <tr>
				...
				<script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','543','height','263','src','<?php echo $objDynamicMedia1->Execute(); ?>','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','<?php echo $objDynamicMedia1->Execute(); ?>' ); //end AC code
</script><noscript>
              ...
              <tr>
                <td align="left" valign="top">&nbsp;</td>
                <td colspan="4" valign="top" class="txt_02">				</td>
              </tr>
              <tr>
                <td align="left" valign="top">&nbsp;</td>
                <td height="40" colspan="4" valign="bottom" class="txt_02"><table width="163" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="145" align="left"><a href="editar.php">Editar</a></td>
                  </tr>
                </table>
                  <br />
                  <table width="163" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="13"><img src="../img/marcador_mais_01.jpg" width="13" height="13" /></td>
                      <td width="5" valign="top"><div align="left"></div></td>
                      <td width="145" align="left"><a href="<?php echo $logoutAction ?>">Sair</a></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
