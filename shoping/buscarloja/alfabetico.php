...
<?php
$colname_RsAfalbetico = "-1";
if (isset($_GET['nome'])) {
  $colname_RsAfalbetico = (get_magic_quotes_gpc()) ? $_GET['nome'] : addslashes($_GET['nome']);
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsAfalbetico = sprintf("SELECT * FROM lojas WHERE nome LIKE '%s%%'", $colname_RsAfalbetico);
$RsAfalbetico = mysql_query($query_RsAfalbetico, $ConBD) or die(mysql_error());
$row_RsAfalbetico = mysql_fetch_assoc($RsAfalbetico);
$totalRows_RsAfalbetico = mysql_num_rows($RsAfalbetico);
            ...
            <td align="left" valign="top"><table width="551" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="32" align="left" class="txt_03">Lojas com a letra &quot;<?php echo $_GET['nome']; ?>&quot;</td>
                    </tr>
                  </table>
                    <?php if ($totalRows_RsAfalbetico > 0) { // Show if recordset not empty ?>
                      <table width="529" cellspacing="0" cellpadding="0">

                        <tr class="txt_02">
                            <td width="215" height="25" class="txt_09">NOME</td>
                            <td width="122" align="center" class="txt_09">TELEFONE</td>
                            <td width="95" align="center" class="txt_09">ANDAR</td>
                            <td width="95" align="center" class="txt_09">N&Uacute;MERO</td>
                        </tr>
                        <tr class="txt_02">
                            <td height="25" colspan="4" align="left" valign="top" class="txt_09"><?php do { ?>
                                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linhaembaixo03">
                                    ...
                                    <tr>
                                      <td height="40" align="left" valign="middle" ><div class="terceiro"><a href="../lojas/lj.php?id=<?php echo $row_RsAfalbetico['id']; ?>"><?php echo $row_RsAfalbetico['nome']; ?></a><br />
                                            <span class="txt_01"><?php echo $row_RsAfalbetico['categoria']; ?></span></div></td>
                                      <td align="center" ><?php echo $row_RsAfalbetico['telefone']; ?></td>
                                      <td align="center" ><?php echo $row_RsAfalbetico['andar']; ?></td>
                                      <td align="center" ><?php echo $row_RsAfalbetico['numero']; ?></td>
                                    </tr>
                                  </table>
                                  <?php } while ($row_RsAfalbetico = mysql_fetch_assoc($RsAfalbetico)); ?></td>
                        </tr>
                          </table>
                      <?php } // Show if recordset not empty ?><p><span class="txt_09">
                    <?php if ($totalRows_RsAfalbetico == 0) { // Show if recordset empty ?>
                      N&atilde;o foram encontradas lojas cadastradas!
                ...
                <tr>
                  <td height="40" valign="bottom"><table width="183" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="165" align="left"><a href="index.php">Exibir todas as buscas </a></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
...
<?php
mysql_free_result($RsAfalbetico);
?>
