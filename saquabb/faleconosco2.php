		...
		<div id="conteudo" class="left">
			...
			<div id="conteudo_interno" class="left">
			    ...
			    <br />
				 ...
				 <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" onsubmit="MM_validateForm('Nome','','R','Email','','RisEmail','Idade','','R','Telefone','','R','Endereco','','R','Mensagem','','R');return document.MM_returnValue">
					<fieldset>
					<label for="Nome" class="titulo_coment">Nome:</label>
						...
						<input name="Idade" type="text" tabindex="3" value="" size="37" maxlength="50" class="textbox" />
                       ...
                       <option value="Outros">Outros</option>
						...
						<input name="Endereco" type="text" tabindex="5" value="" size="37" maxlength="50" class="textbox" />
						<label for="Mensagem" class="titulo_coment">Mensagem:</label>
						<textarea name="Mensagem" cols="36" rows="6" tabindex="6" class="textbox"></textarea>
						<input name="submit" id="botao" type="submit" tabindex="7" value="Enviar" />
					</fieldset>
				</form>
			  </div>
			</div>
