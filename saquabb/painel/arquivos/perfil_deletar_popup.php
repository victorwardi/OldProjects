...
$query_deletar = sprintf("SELECT id, nome, foto FROM perfil WHERE id = %s ORDER BY id ASC", $colname_deletar);
...
$del_perfil = new tNG_delete($conn_saquabb);
$tNGs->addTransaction($del_perfil);
// Register triggers
$del_perfil->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "deletar");
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td width="306" align="center" valign="middle" bgcolor="#FFCC00" class="fonte">Tem certeza que deseja deletar este perfil? </td>
  </tr>
  <tr>
    <td height="132" align="center" valign="bottom" bgcolor="#FFFFCC"><table width="20%" border="1" cellpadding="0" cellspacing="2" bordercolor="#000000" bgcolor="#FFFFFF">
      <tr>
