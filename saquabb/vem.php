      ...
      <tr>
        ...
        <td width="539" height="193" align="center" valign="top"><!-- InstanceBeginEditable name="conteudo" -->
          <table width="100%" border="0" cellspacing="2" cellpadding="0">
            <tr>
              <td><table width="575" border="0" cellpadding="0" cellspacing="6" class="borda_fundo_destaque">
                <tr>
                  <td height="30" colspan="2" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="borda_topo">
                      <tr>
                        <td><img src="imagens/titulos/vem_ai.jpg" width="128" height="20" /></td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td colspan="2" align="center" valign="middle" class="perfil_nome"></td>
                </tr>
                <tr>
                  <td height="36" colspan="2" align="center" valign="middle" class="perfil_nome"><?php echo $row_vemai['nome']; ?></td>
                </tr>
                <tr>
                    ...
                    <table width="200" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><table width="200" border="0" cellpadding="4" cellspacing="0" class="borda_tabela">
                            <tr>
                              <td align="center" valign="top" bgcolor="#FCE285"><img src="<?php echo tNG_showDynamicThumbnail("", "uploads/fotos/", "{vemai.flyer}", 500, 0, true); ?>" border="0" class="borda_tabela" /></td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
...
?><a href="javascript:abrir_janela('ver_foto.php?id=<?php echo $row_noticias['id']; ?>','fotos','','400','380','true')"> </td>
                </tr>
                <tr>
                  <td width="60%" valign="top"><div align="justify" class="tiutlo_not">Data: <?php echo $row_vemai['data']; ?></div></td>
                  <td width="40%" align="center" valign="top">&nbsp;</td>
                </tr>
                <tr>
                  <td colspan="2" align="center" valign="top"><div align="left"><?php echo $row_vemai['descricao']; ?><br />
                    <br />
                  </div></td>
                </tr>
              </table></td>
