      ...
      <tr>
        ...
        <td width="539" height="193" align="center" valign="top"><!-- InstanceBeginEditable name="conteudo" -->
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <th colspan="2" scope="row"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td align="center" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                      <tr>
                        <td align="center" valign="top"><table width="314" border="0" cellpadding="2" cellspacing="0" class="borda_tabela">
                            ...
                            <tr>
                              <td height="87" align="center" valign="top" id="espaco_celulas"><span class="fonte_not"><br />
                                </span>
                        ...
                        <td align="center" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                            <tr>
                              <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="borda_tabela">
                                  ...
                                  <td height="66" colspan="2" align="left" valign="top"><table width="100%" border="0" cellpadding="2">
                                      <tr>
                                        <td align="left" valign="top"><?php do { ?>
                                            <table width="100%" height="69" border="0" align="left" cellpadding="2" cellspacing="0" class="borda_pontilhada_noticias">
                                              <tr>
                                ...
                                <tr>
                                  <td colspan="2" align="right" valign="top" bgcolor="#3399FD" class="tiutlo_not" ><p><a href="arquivo.php"><img src="imagens/titulos/mais_not.jpg" width="94" height="16" border="0" /></a></p></td>
                                </tr>
                              </table></td>
                            </tr>
                        </table></td>
