...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <th scope="col"> <?php do { ?>
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="95" colspan="3" align="right" valign="top"><table width="90%" border="0" cellspacing="4" cellpadding="0">
                <tr>
                  <th width="52%" align="left" class="nome" scope="col"><?php echo $row_fotos['descricao']; ?></th>
                  <th rowspan="4" align="center" valign="middle" class="negrito" scope="col"><a href="javascript:enviar('comprar.php?id_foto=<?php echo $row_fotos['id_foto']; ?>&amp;id=<?php echo $row_fotos['id']; ?>')"><img src="imagens/comprar.jpg" alt="Comprar!" width="150" height="70" border="0" /></a></th>
                </tr>
                <tr>
                  <th height="21" align="left" class="fonte" scope="row"><span class="negrito">Local :</span> <?php echo $row_fotos['local']; ?></th>
                </tr>
                <tr>
                  <th height="19" align="left" class="fonte" scope="col"><span class="negrito">Fot&oacute;grafo :</span> <?php echo $row_fotos['fotografo']; ?></th>
                </tr>
                <tr>
        ...
        <?php } while ($row_fotos = mysql_fetch_assoc($fotos)); ?></th>
  </tr>
  <tr>
    <th scope="row">&nbsp;
      <table border="0" width="50%" align="center">
        <tr>
          <td width="23%" align="center"><?php if ($pageNum_fotos > 0) { // Show if not first page ?>
              <a href="<?php printf("%s?pageNum_fotos=%d%s", $currentPage, 0, $queryString_fotos); ?>">First</a>
              <?php } // Show if not first page ?>
          </td>
          <td width="31%" align="center"><?php if ($pageNum_fotos > 0) { // Show if not first page ?>
              <a href="<?php printf("%s?pageNum_fotos=%d%s", $currentPage, max(0, $pageNum_fotos - 1), $queryString_fotos); ?>">Previous</a>
              <?php } // Show if not first page ?>
          </td>
          <td width="23%" align="center"><?php if ($pageNum_fotos < $totalPages_fotos) { // Show if not last page ?>
              <a href="<?php printf("%s?pageNum_fotos=%d%s", $currentPage, min($totalPages_fotos, $pageNum_fotos + 1), $queryString_fotos); ?>">Next</a>
              <?php } // Show if not last page ?>
          </td>
          <td width="23%" align="center"><?php if ($pageNum_fotos < $totalPages_fotos) { // Show if not last page ?>
              <a href="<?php printf("%s?pageNum_fotos=%d%s", $currentPage, $totalPages_fotos, $queryString_fotos); ?>">Last</a>
              <?php } // Show if not last page ?>
          </td>
        </tr>
      </table></th>
  ...
  <tr>
    <th scope="row"><img src="imagens/rodape.jpg" width="600" height="28" /></th>
  </tr>
</table>
</body>
</html>
