...
$ins_noticias->registerTrigger("END", "Trigger_Default_Redirect", 99, "../includes/nxt/back.php");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="topo" height="50" colspan="2">&nbsp;</td>
  </tr>
  <tr>
    <td id="menu" >&nbsp;</td>
    <td rowspan="6" align="center" valign="top" id="meio"><!-- InstanceBeginEditable name="conteudo" -->
    <?php
...
?>
          <table width="741" cellpadding="2" cellspacing="0" class="KT_tngtable">
            <tr>
              ...
              <td><textarea name="titulo_<?php echo $cnt1; ?>" id="titulo_<?php echo $cnt1; ?>" cols="50" rows="5"><?php echo KT_escapeAttribute($row_rsnoticias['titulo']); ?></textarea>
