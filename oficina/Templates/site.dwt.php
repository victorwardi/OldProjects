...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','277','height','346','src','../flash/menu','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','wmode','Transparent','wmode','Transparent','movie','../flash/menu' ); //end AC code
  ...
  <tr>
    <td height="48" colspan="2" align="center" valign="middle"><!-- TemplateBeginEditable name="Titulo" --><img src="../img/jpg/titulos.jpg" width="800" height="57" /><!-- TemplateEndEditable --></td>
  </tr>
  <tr>
    <td height="163" colspan="2" align="center" valign="top" background="../img/png/fundo_tabela.png"><!-- TemplateBeginEditable name="conteudo" -->
