...
if (isset($_GET['tipo'])) {
  $colname_RsProdutos = $_GET['tipo'];
}
mysql_select_db($database_ConVBS, $ConVBS);
$query_RsProdutos = sprintf("SELECT * FROM produtos WHERE tipo = %s ORDER BY id DESC", GetSQLValueString($colname_RsProdutos, "text"));
...
$colname_RsMostraTipo = "-1";
if (isset($_GET['tipo'])) {
  $colname_RsMostraTipo = $_GET['tipo'];
}
mysql_select_db($database_ConVBS, $ConVBS);
$query_RsMostraTipo = sprintf("SELECT * FROM tipo WHERE id_tipo = %s", GetSQLValueString($colname_RsMostraTipo, "int"));
$RsMostraTipo = mysql_query($query_RsMostraTipo, $ConVBS) or die(mysql_error());
$row_RsMostraTipo = mysql_fetch_assoc($RsMostraTipo);
$totalRows_RsMostraTipo = mysql_num_rows($RsMostraTipo);
        ...
        <tr>
          <td height="25" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="4">
              ...
              <td width="59%" rowspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left" valign="top"><!-- InstanceBeginEditable name="banner" --> <img src="img/prop.jpg" alt="Produtos" width="468" height="44" class="borda_preta" /> <!-- InstanceEndEditable --></td>
                </tr>
                <tr>
                  <td rowspan="2" align="center" valign="top"><!-- InstanceBeginEditable name="conteudo" -->
                    <div>
                      ...
                      <div>
                        <div align="left">Produtos listados pelo tipo: <strong><?php echo $row_RsMostraTipo['nome']; ?></strong><br />
                            <br />
                        </div>
                      </div>
...
mysql_free_result($RsMostraTipo);
?>
