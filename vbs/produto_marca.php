...
$objDynamicThumb3->setRenameRule("{RsMostraMarca.foto}");
$objDynamicThumb3->setResize(468, 0, true);
...
if (isset($_GET['marca'])) {
  $colname_RsProdutos = $_GET['marca'];
}
mysql_select_db($database_ConVBS, $ConVBS);
$query_RsProdutos = sprintf("SELECT * FROM produtos WHERE marca = %s ORDER BY id DESC", GetSQLValueString($colname_RsProdutos, "text"));
        ...
        <tr>
          <td height="25" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="4">
              ...
              <td width="59%" rowspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left" valign="top"><!-- InstanceBeginEditable name="banner" --> <img src="<?php echo $objDynamicThumb3->Execute(); ?>" border="0" class="borda_preta" /> <!-- InstanceEndEditable --></td>
                </tr>
                <tr>
...
?>
        <td width="151"><table width="153" border="0" cellpadding="2" cellspacing="0" class="borda_cinza">
          <tr>
            <td width="146" align="center"><a href="produto.php?id=<?php echo $row_RsProdutos['id']; ?>&amp;marca=<?php echo $row_RsProdutos['marca']; ?>"><img src="<?php echo $objDynamicThumb2->Execute(); ?>" alt="" border="0" /></a></td>
          </tr>
          <tr>
