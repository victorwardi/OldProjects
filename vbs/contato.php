        ...
        <tr>
          <td height="25" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="4">
              ...
              <td width="59%" rowspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left" valign="top"><!-- InstanceBeginEditable name="banner" --><img src="img/contato_pg.jpg" alt="Promo&ccedil;&atilde;o" width="468" height="44" class="borda_preta" /><!-- InstanceEndEditable --></td>
                </tr>
                <tr>
                  <td rowspan="2" align="center" valign="top"><!-- InstanceBeginEditable name="conteudo" -->
                    <div>
                      <table width="96%" border="0" align="center" cellpadding="0" cellspacing="4">
                        <tr>
                          <th height="77" align="left" valign="top" scope="row"><p>&nbsp;</p>
                            <p>Para entrar em contato com a Vila Beach Surfing utilize: </p>
                            <ul>
                                <li>MSN: vbs_saqua@hotmail.com </li>
                                <li>EMAIL: contato@vilabeachsurfing.com.br</li>
                                <li>TEL: (22) 2651 - 0463 <br />
                                </li>
                              </ul></th>
                        </tr>
                        <tr>
                                      ...
                                      <th height="54" align="left" valign="top" scope="col"><div id="conteudo_interno" class="left">
                                        ...
                                        <div>
                                            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" onsubmit="MM_validateForm('Nome','','R','Cidade','','R','Email','','RisEmail','Telefone','','R');return document.MM_returnValue">
                                              ...
                                              <label for="Cidade" class="titulo_coment">Cidade:</label>
