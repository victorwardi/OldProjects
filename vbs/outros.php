...
mysql_select_db($database_ConVBS, $ConVBS);
$query_RsProdutos = "SELECT * FROM produtos WHERE categoria = 'outros' ORDER BY id DESC";
        ...
        <tr>
          <td height="25" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="4">
              ...
              <td width="59%" rowspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left" valign="top"><!-- InstanceBeginEditable name="banner" --><img src="img/outros-_produtos_pg.jpg" alt="Outros" width="468" height="44" class="borda_preta" /><!-- InstanceEndEditable --></td>
                </tr>
                <tr>
