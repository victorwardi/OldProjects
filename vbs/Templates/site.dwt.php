        ...
        <tr>
          <td height="25" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="4">
              ...
              <td width="59%" rowspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left" valign="top"><!-- TemplateBeginEditable name="banner" --><img src="../img/procurar.jpg" width="468" height="44" border="0" class="borda_preta" /><!-- TemplateEndEditable --></td>
                </tr>
                <tr>
                  <td rowspan="2" align="center" valign="top"><!-- TemplateBeginEditable name="conteudo" -->
                    <div>Content for News</div>
