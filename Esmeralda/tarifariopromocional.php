        ...
        <tr>
            ...
            <tr>
              <td width="59%" align="left" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0" class="subTitulo">
                ...
                <tr>
                  ...
                  <td bgcolor="#CCC6A2">R$                                   266,00</td>
                </tr>
                <tr>
                  <td width="79%" bgcolor="#BCB483"><strong>3&ordf; PESSOA (EM QQ. ACOMODA&Ccedil;&Atilde;O) </strong></td>
                  <td bgcolor="#CCC6A2">R$                                   120,00&nbsp;&nbsp;</td>
                </tr>
                <tr>
                  <td width="79%" bgcolor="#BCB483"><strong>ACOMODA&Ccedil;AO SGL APTO STD</strong></td>
                  <td bgcolor="#CCC6A2">R$                                   250,00</td>
                </tr>
              </table>
                <br />
                ...
                <table width="100%" cellpadding="4" cellspacing="2">
                  ...
                  <tr>
                    ...
                    <td width="21%" align="left" bgcolor="#CCC6A2">R$                     74,00 </td>
                  </tr>
                  <tr>
                    <td width="79%" bgcolor="#BCB483"><strong>7 a 9 anos</strong></td>
                    <td width="21%" align="left" bgcolor="#CCC6A2">R$                                 104,00</td>
                  </tr>
                </table></td>
          ...
          <table border="0" cellpadding="8" cellspacing="0" width="100%">
            <tbody>
              ...
              <tr>
                <td align="left" valign="middle"><p><strong>Per&iacute;odo:</strong> Mar&ccedil;o a Junho, Agosto a Novembro.<br />
                  (Exceto Pacotes e Feriados).</p>
                  </td>
              </tr>
              <tr>
