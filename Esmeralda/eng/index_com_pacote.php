        ...
        <table width="100%" border="0" cellspacing="6" cellpadding="2">
          <tr>
					...
					if($temPacote == 2)
			{
			 ...
			 {
			 echo "<td><a href='tarifariopromocional.php#link'><img src='imagens/tarifario_promo.png' alt='Special Rates' width='238' height='136' border='0' /></a></td>";}
			?>
                  <td><a href="hotel.php#hotel"><img src="../imagens/hotel.jpg" alt="Hotel Pousada Esmeralda" width="238" height="136" border="0" /></a></td>

                	
                  <td><a href="comochegar.php#comochegar"><img src="../imagens/como_chegar.png" alt="How to Arrive" width="238" height="136" border="0" /></a></td>
                </tr>
              </table></td>
          </tr>
        </table>
