          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                <tr>
                  <td><a name="pacotes" id="pacotes">Christmas</a> 2013</td>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td colspan="2" align="center" valign="top" bgcolor="#E5D8B5"><table width="33%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                <tr>
                  <td><img src="natalEng.jpg" alt="" border="0" /></td>
                </tr>
              </table></td>
            </tr>
            <tr>
              ...
              <td width="95%" align="left" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0" class="subTitulo">
                ...
                <table border="0" cellpadding="8" cellspacing="0" width="100%">
                  <tbody>
                    <tr>
                      <td align="left" valign="middle"><p><strong>Periods</strong><br />
                      </p>
                        <p>                          20/12 to 25/12 (Friday to Wednesday), or 21/12 to 25/12 (Saturday to Wednesday)</p>
                        <p>                          <strong>Supper Christmas Special</strong><br />
                          <br />
                          &raquo;Nuts, chestnuts, hazelnuts, dates, raisins, candied fruit, fruit carols,<br />
                          turkey, tender, tenderloin, cod, wine, desserts and traditional Christmas toast<br />
                          <strong>.<br />
                          Ecological Events</strong><br />
                          <br />
                          &raquo;Hike to the Prateleiras and Pico das Agulhas Negras with expert guide (optional).<br />
                          &raquo;Ride the trails and waterfalls in the region with Manga Larga (optional).</p>
                        <p>* Minimum of 5 nights.</p>
                        <p>Reservations<br />
                          Information through our Central Reservations.<br />
                          55 (24) 3352-1643<br />
                          info@pousadaesmeralda.com.br</p>
                        <p><strong><br />
                        </strong></p></td>
                    </tr>
                    <tr>
