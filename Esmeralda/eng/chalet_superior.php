          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td width="100%" height="36"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="link" id="link">Chalet Superior</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td align="left" valign="top"><br />
              Fireplace   at the foot of the bed, minibar, TV with DVD system, safe, intercom,   mini-kitchen, queen-size bed, balcony and parking..<br />
                <br />
                <br />
                <table width="92%" border="0" align="center" cellpadding="4" cellspacing="2">
                  <tr>
                    <td width="45%" align="center" bgcolor="#D7D2B5"><table width="94%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="../fotos/2011/Chalet Superior/04.jpg" rel="lightbox[fotos]" title="Superior Chalet"><img src="../fotos/2011/Chalet Superior/mini/chalet_superior_mini.jpg" width="270" height="160" border="0" /></a></td>
                        </tr>
                      </table></td>
                    <td width="10%">&nbsp;</td>
                    <td width="45%" align="center" valign="middle" bgcolor="#D7D2B5"><table width="88%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="../fotos/2011/Chalet Superior/02.jpg" rel="lightbox[fotos]" title="Superior Chalet"><img src="../fotos/2011/Chalet Superior/mini/superior.jpg" width="270" height="160" border="0" /></a></td>
                        </tr>
                      </table></td>
                  </tr>
                <tr>
                ...
                <tr>
                  <td align="center" bgcolor="#D7D2B5"><table width="90%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="../fotos/2011/Chalet Superior/01.jpg" rel="lightbox[fotos]" title="Superior Chalet"><img src="../fotos/2011/Chalet Superior/mini/superior_luamel_mini.jpg" alt="" width="270" height="160" border="0" /></a></td>
                      </tr>
                    </table></td>
                  <td>&nbsp;</td>
                  <td align="center" valign="middle" bgcolor="#D7D2B5"><table width="73%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="../fotos/2011/Chalet Superior/05.jpg" rel="lightbox[fotos]" title="Superior Chalet"><img src="../fotos/2011/Chalet Superior/mini/superior_interior.jpg" alt="" width="270" height="160" border="0" /></a></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="center" bgcolor="#D7D2B5"><table width="90%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="../fotos/2011/Chalet Superior/06.jpg" rel="lightbox[fotos]" title="Superior Chalet"><img src="../fotos/2011/Chalet Superior/mini/06.jpg" alt="" width="270" height="160" border="0" /></a></td>
                    </tr>
                  </table></td>
                  <td>&nbsp;</td>
                  <td align="center" valign="middle" bgcolor="#D7D2B5"><table width="73%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="../fotos/2011/Chalet Superior/03.jpg" rel="lightbox[fotos]" title="Superior Chalet"><img src="../fotos/2011/Chalet Superior/mini/superior_ext_mini.jpg" alt="" width="270" height="160" border="0" /></a></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
