          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                <tr>
                  <td><a name="pacotes" id="pacotes">Reveillon</a> 2013/2014</td>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td colspan="2" align="center" valign="top" bgcolor="#E5D8B5"><table width="33%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                <tr>
                  <td><img src="reveillonEng.jpg" alt="" border="0" /></td>
                </tr>
              </table></td>
            </tr>
            <tr>
              ...
              <td width="95%" align="left" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0" class="subTitulo">
                ...
                <table border="0" cellpadding="8" cellspacing="0" width="100%">
                  <tbody>
                    <tr>
                      <td align="left" valign="middle"><p><strong>Period</strong><br />
                        &raquo;12/27/2013 to 01/01/2014 (Friday to Wednesday)</p>
                        <p><strong>Gastronomic Plan</strong><br />
                          &raquo;New Year's Eve Dinner with live music.<br />
                          &raquo;Trout Festival|<br />
                          <br />
                          <strong>Ecological Events</strong><br />
                          <br />
                          &raquo;Hike to the shelves and Pico das Agulhas Negras with expert guide (optional).<br />
                          &raquo;Ride the trails and waterfalls in the region with Manga Larga (optional).</p>
                        <p>* Minimum of 5 nights.</p>
                        <p><strong>Reservations</strong></p>
                        <p>                          Information through our Central Reservations.<br />
                          55 (24) 3352-1643<br />
