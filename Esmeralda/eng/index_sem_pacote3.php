            ...
            <td><table width="200" border="0" cellspacing="4" cellpadding="4">
                <tr>
				  ...
				  $temPacote = 2;
					if($temPacote == 2)
			{
			 echo "<td><a href='pacotes/index.php#pacotes'><img src='pacotes/capa.jpg' alt='Pacote' width='238' height='136' border='0' /></a></td>";
			 }else
			 {
			 echo "<td><a href='tarifariopromocional.php#link'><img src='imagens/tarifario_promo.png' alt='Tarifario Promocional' width='238' height='136' border='0' /></a></td>";}
			?>
                  <td><a href="hotel.php#hotel"><img src="imagens/hotel.jpg" alt="Hotel Pousada Esmeralda" width="238" height="136" border="0" /></a></td>

                	
                  <td><a href="comochegar.php#comochegar"><img src="imagens/como_chegar.png" alt="Como Chegar" width="238" height="136" border="0" /></a></td>
                </tr>
              </table></td>
          </tr>
        </table>
