  ...
  <tr>
	...
	<!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellpadding="2" cellspacing="6">
        <tr>
          <td><table width="100%" border="0" cellpadding="0" cellspacing="3" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="link" id="link">Chalets</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td width="50%" align="left" valign="top" class="txt14px"> <p><span onmouseover="_tipon(this)" onmouseout="_tipoff()">Check out more details about our accommodations</span>:</p>
                <p class="txt14px">- <a href="chalet_master.php#link" class="txt14px">Master Chalet</a><br />
                  <br />
                  - <a href="chalet_superior.php#link" class="txt14px">Superior Chalet</a><br />
                  <br />
                  - <a href="chalet_geminado.php#link" class="txt14px">Twin Chalet </a><br />
                  <br />
                  - <a href="apartamento.php#link" class="txt14px">Apartment</a></p></td>
              <td width="50%" align="left" valign="top" class="txt14px"><table width="94%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                <tr>
                  <td><a href="../fotos/2011/Apartamento STD/01.JPG" rel="lightbox[fotos]" title="Apartamento STD"><img src="../fotos/2011/chalets.jpg" width="400" height="160" border="0" /></a></td>
                </tr>
              </table></td>
              </tr>
          </table></td>
