...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/modelo_eng.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  <tr>
    <td align="right"><table width="63" border="0" cellspacing="0" cellpadding="4">
      <tr>
        ...
        <td width="23"><a href="index.php"><img src="../imagens/layout/inglaterra.jpg" alt="English Version" width="24" height="20" border="0" /></a></td>
      </tr>
    </table></td>
  </tr>
</table>
  ...
  <tr>
    <td height="522" align="center" valign="top"><table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td><img src="../imagens/layout/eng/layout_eng_02.jpg" width="499" height="44" /></td>
        <td rowspan="3"><img src="../imagens/layout/eng/layout_eng_03.jpg" width="19" height="522" /></td>
      </tr>
      <tr>
        <td height="241">		
   <script type="text/javascript">
  ...
  <tr>
	...
	<!-- InstanceBeginEditable name="conteudo" -->
        <table width="100%" border="0" cellpadding="2" cellspacing="6">
          <tr>
            <td height="712"><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
                <tr>
                  <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                      <tr>
                        <td><a name="link" id="link">The Hotel</a></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                  <td width="69%" height="561" align="left" valign="top"><p><strong>Hotel Pousada Esmeralda,</strong> located in the National Park, in a privileged area, between the   mountains, offering guests comfort and tranquility, with charming and   cozy environment.</span>  It integrates seamlessly in one place: comfort, nature and recreation.</span></p>
                    <table border="0" cellpadding="0" cellspacing="2" width="100%">
                      <tbody>
                        <tr>
                          <td class="subTitulo"> Attractions</td>
                        </tr>
                      </tbody>
                    </table>
                    <strong>Full board</strong> (Breakfast breakfast, lunch and dinner).</span>
                    <p><strong>Coffee Morning:</strong></span></p>
                    <ul>
                      <li>Cakes, breads, cheese bread and biscuits.</span></li>
                      <li>Milk, coffee, tea and chocolate.</span></li>
                      <li>Cold cuts and cheeses.</span></li>
                      <li>Juices.</span></li>
                      <li>Seasonal fruits.</span></li>
                      <li>Jellies, butter and cheese.</span></li>
                      <li>  Breakfast cereals.</span></li>
                    </ul>
                    <p><strong>Lunch and dinner:</strong></span></p>
                    <ul>
                      <li>Fancy menu with a selection of various dishes.</span></li>
                      <li>The best candy.</span></li>
                    </ul>
                    <table border="0" cellpadding="0" cellspacing="2" width="100%">
                      <tbody>
                        <tr>
                          <td class="subTitulo"><strong>Passeios</strong> <strong>Tours</strong></td>
                        </tr>
                      </tbody>
                    </table>
                     We have agreements with farms and specialized guides to give our customers the best in the region.</span>
                    <ul>
                      <li>Hike to the shelves and Pico das Agulhas Negras with specialized guide.</span></li>
                      <li>  Ride the trails and waterfalls in the region with Manga-Larga.</span></li>
                    </ul>
                    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                      <tbody>
                        <tr>
                          <td><span onmouseover="_tipon(this)" onmouseout="_tipoff()"><strong>News</strong></span></td>
                        </tr>
                      </tbody>
                    </table>
                    <table width="100" border="0" cellspacing="6" cellpadding="0">
                      <tr>
                        <td><img src="../imagens/layout/eng/internet.jpg" alt="Computador com acesso &agrave; internet"/></td>
                      </tr>
                  </table></td>
                  <td width="31%" align="left" valign="top"><table width="51%" border="0" cellspacing="6" cellpadding="0">
                      <tr>
                        <td width="33%"><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                            <tr>
                              <td><a href="../fotos/placa_entrada.jpg" rel="lightbox[fotos]" title="Pousada Esmeralda"><img src="../fotos/placa_p.jpg" alt="" width="200" height="120" border="0" /></a></td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
                        <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                            <tr>
                              <td><a href="../fotos/recepcao.jpg" rel="lightbox[fotos]" title=""><img src="../fotos/recepcao_p.jpg" alt="" width="200" height="120" border="0" /></a></td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
                        <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                            <tr>
                              <td><a href="../fotos/lago_montanha.jpg" rel="lightbox[fotos]" title=""><img src="../fotos/lago_montanha_mini.jpg" width="200" height="120" border="0" /></a></td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
                        <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                            <tr>
                              <td><a href="fotos/lareira.jpg" rel="lightbox[fotos]" title="Living"><img src="../imagens/lareira_mini.jpg" width="200" height="120" border="0" /></a></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table></td>
                ...
                <tr>
                  <td height="144" colspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="6" cellpadding="0">
                    <tr>
                      <td width="34%"><table width="81%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                        <tr>
                          <td><a href="../fotos/relogio.jpg" rel="lightbox[fotos]" title="Relógio inglês final século XIX"><img src="../fotos/relogio_mini.jpg" width="200" height="120" border="0" /></a></td>
                        </tr>
                      </table></td>
                      <td width="34%"><table width="88%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                        <tr>
                          <td><a href="../fotos/sala_porta.jpg" rel="lightbox[fotos]" title="Living"><img src="../fotos/sala_porta_2.jpg" width="200" height="120" border="0" /></a></td>
                        </tr>
                      </table></td>
                      <td width="32%" align="right"><table width="92%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                        <tr>
                          <td><a href="../fotos/arcoflores.jpg" rel="lightbox[fotos]" title="Arco de Flores"><img src="../fotos/arco_mini.jpg" width="200" height="120" border="0" /></a></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table></td>
...
<map name="Map" id="Map"><area shape="rect" coords="60,329,173,350" href="pacotes.php#pacotes" alt="Tarif&aacute;rio Balc&atilde;o" /><area shape="rect" coords="49,167,175,188" href="index.php" alt="P&aacute;gina Inicial" />
