            ...
            <td><table width="200" border="0" cellspacing="4" cellpadding="4">
                <tr>
				  ...
				  $temPacote = 2;
					if($temPacote == 2)
			{
			 echo "<td><a href='natal.php#pacotes'><img src='../eng/capa_natal.jpg' alt='Christmas' width='238' height='136' border='0' /></a></td>";
			 }else
			 {
			 echo "<td><a href='tarifariopromocional.php#link'><img src='../imagens/layout/eng/tarifario.jpg' alt='Special Rates' width='238' height='136' border='0' /></a></td>";}
			?>
            <td><a href='reveillon.php#pacotes'><img src='../eng/capa_reveillon.jpg' alt='Reveillon' width='238' height='136' border='0' /></a></td>
            
            
                 <!-- <td><a href="hotel.php#hotel"><img src="../imagens/layout/eng/ohotel--eng.jpg" alt="Hotel Pousada Esmeralda" width="238" height="136" border="0" /></a></td>-->

                	
                  <td><a href="comochegar.php#comochegar"><img src="../imagens/layout/eng/como_chegar_eng.jpg" alt="How to Arrive" width="238" height="136" border="0" /></a></td>
                </tr>
              </table></td>
          </tr>
        </table>
