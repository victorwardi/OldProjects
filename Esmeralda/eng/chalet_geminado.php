      ...
      <table width="100%" border="0" cellpadding="2" cellspacing="6">
        <tr bgcolor="#E5D8B5">
          <td height="36"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
            <tr>
              <td><a name="link" id="link4">Twin Chalet with Fireplace</a></td>
            </tr>
          </table></td>
        </tr>
        <tr bgcolor="#E5D8B5">
          <td align="left" valign="top"><br />
            <span onmouseover="_tipon(this)" onmouseout="_tipoff()">Chalet with: ante-room with fireplace, TV with DVD system, intercom, refrigerator and parking.</span><br />
            <br />
            <table width="92%" border="0" align="center" cellpadding="4" cellspacing="2">
              <tr>
                <td width="45%" align="center" bgcolor="#D7D2B5"><table width="94%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                  <tr>
                    <td><a href="fotos/2011/Chalet Geminado/01 -  geminado com lareira.JPG" rel="lightbox[fotos]" title="Chalet Geminado com Lareira"><img src="fotos/2011/Chalet Geminado/mini/01.jpg" alt="" width="270" height="160" border="0" /></a></td>
                  </tr>
                </table></td>
                <td width="10%">&nbsp;</td>
                <td width="45%" align="center" valign="middle" bgcolor="#D7D2B5"><table width="88%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                  <tr>
                    <td><a href="fotos/2011/Chalet Geminado/02---geminado-com-lareira.JPG" rel="lightbox[fotos]" title="Chalet Geminado com Lareira"><img src="fotos/2011/Chalet Geminado/mini/02.jpg" alt="" width="270" height="160" border="0" /></a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="center" bgcolor="#D7D2B5"><table width="90%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                  <tr>
                    <td><a href="fotos/2011/Chalet Geminado/03----geminado-com-lareira.JPG" rel="lightbox[fotos]" title="Chalet Geminado com Lareira"><img src="fotos/2011/Chalet Geminado/mini/03.jpg" alt="" width="270" height="160" border="0" /></a></td>
                  </tr>
                </table></td>
                <td>&nbsp;</td>
                <td align="center" valign="middle" bgcolor="#D7D2B5"><table width="73%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                  <tr>
                    <td><a href="fotos/2011/Chalet Geminado/04 -  geminado com lareira.JPG" rel="lightbox[fotos]" title="Chalet Geminado com Lareira"><img src="fotos/2011/Chalet Geminado/mini/04.jpg" alt="" width="270" height="160" border="0" /></a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
        ...
        <tr>
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td width="100%" height="36"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td>Twin Chalet without Fireplace</td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td align="left" valign="top"><br />
                <span onmouseover="_tipon(this)" onmouseout="_tipoff()">Chalet with: TV with DVD system, intercom, refrigerator and parking.</span><br />
                <br />
                <table width="92%" border="0" align="center" cellpadding="4" cellspacing="2">
                  <tr>
                    <td width="45%" align="center" bgcolor="#D7D2B5"><table width="94%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="fotos/2011/Chalet Geminado/001 - geminado sem lareira.jpg" rel="lightbox[fotos]" title="Chalet Geminado sem Lareira"><img src="fotos/2011/Chalet Geminado/mini/geminado2_mini.jpg" width="270" height="160" border="0" /></a></td>
                        </tr>
                      </table></td>
                    <td width="10%">&nbsp;</td>
                    <td width="45%" align="center" valign="middle" bgcolor="#D7D2B5"><table width="88%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="fotos/2011/Chalet Geminado/0001 - geminado sem lareira.jpg" rel="lightbox[fotos]" title="Chalet Geminado sem Lareira"><img src="fotos/2011/Chalet Geminado/mini/geminados_mini.jpg" width="270" height="160" border="0" /></a></td>
                        </tr>
                      </table></td>
                  </tr>
                <tr>
