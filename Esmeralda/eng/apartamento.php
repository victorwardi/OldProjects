          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            ...
            <tr>
              <td align="left" valign="top"><br />
               Apartment: TV with DVD system, refrigerator, intercom, double bed, balcony and parking.<br />
                <br />
                <br />
                <br />
                <table width="92%" border="0" align="center" cellpadding="4" cellspacing="2">
                  <tr>
                    <td width="45%" align="center" bgcolor="#D7D2B5"><table width="94%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="../fotos/2011/Apartamento STD/01.JPG" rel="lightbox[fotos]" title="Apartment STD"><img src="../fotos/2011/Apartamento STD/mini/01.jpg" alt="" width="270" height="160" border="0" /></a></td>
                        </tr>
                      </table></td>
                    <td width="10%">&nbsp;</td>
                    <td width="45%" align="center" valign="middle" bgcolor="#D7D2B5"><table width="88%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="../fotos/2011/Apartamento STD/02.JPG" rel="lightbox[fotos]" title="Apartment STD"><img src="../fotos/2011/Apartamento STD/mini/02.jpg" alt="" width="270" height="160" border="0" /></a></td>
                        </tr>
                      </table></td>
                    </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" bgcolor="#D7D2B5"><table width="90%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="../fotos/2011/Apartamento STD/03.JPG" rel="lightbox[fotos]" title="Apartment STD"><img src="../fotos/2011/Apartamento STD/mini/03.jpg" alt="" width="270" height="160" border="0" /></a></td>
                        </tr>
                      </table></td>
                    <td>&nbsp;</td>
                    <td align="center" valign="middle" bgcolor="#D7D2B5"><table width="73%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="../fotos/2011/Apartamento STD/04.JPG" rel="lightbox[fotos]" title="Apartment STD"><img src="../fotos/2011/Apartamento STD/mini/04.jpg" alt="" width="270" height="160" border="0" /></a></td>
                        </tr>
                      </table></td>
                    </tr>
                  <tr>
