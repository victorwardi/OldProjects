        ...
        <tr>
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="link" id="link">Rates</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td width="59%" align="left" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0" class="subTitulo">
                ...
                <tr>
                  <td bgcolor="#BCB483"><strong> MASTER CHALET</strong></td>
                  <td width="21%" bgcolor="#CCC6A2">R$                     402,00 </td>
                  </tr>
                <tr>
                  <td bgcolor="#BCB483"><strong>SUPERIOR CHALET</strong></td>
                  <td bgcolor="#CCC6A2">R$                     344,00 </td>
                  </tr>
                <tr>
                  <td width="79%" bgcolor="#BCB483"><strong>TWIN CHALET WITH FIREPLACE</strong></td>
                  <td bgcolor="#CCC6A2">R$                                   326,00</td>
                  </tr>
                <tr>
                  <td width="79%" bgcolor="#BCB483"><strong>TWIN CHALET WITHOUT FIREPLACE</strong></td>
                  <td bgcolor="#CCC6A2">R$                                   314,00</td>
                  </tr>
                <tr>
                  <td width="79%" bgcolor="#BCB483"><strong>APARTMENT</strong></td>
                  <td bgcolor="#CCC6A2">R$                                   290,00</td>
                  </tr>
                <tr>
                  <td width="79%" bgcolor="#BCB483"><strong><span onmouseover="_tipon(this)" onmouseout="_tipoff()"><strong>3rd PERSON (IN ANY ACCOMMODATION)</strong></span></strong></td>
                  <td bgcolor="#CCC6A2">R$                                   128,00&nbsp;&nbsp;</td>
                  </tr>
                <tr>
                  <td width="79%" bgcolor="#BCB483"><strong><strong>ACCOMMODATION</strong> SGL APT STD</strong></td>
                  <td bgcolor="#CCC6A2">R$                                   280,00</td>
                  </tr>
              </table>
                <br />
                ...
                <table width="100%" cellpadding="4" cellspacing="2">
                  <tr>
                    <td bgcolor="#bcb483"><span onmouseover="_tipon(this)" onmouseout="_tipoff()"><strong>0 to 2 years</strong></span></td>
                    <td align="left" bgcolor="#CCC6A2">Free</td>
                  </tr>
                  <tr>
                    <td bgcolor="#bcb483"><span onmouseover="_tipon(this)" onmouseout="_tipoff()"><strong>3 to 6 years</strong></span></td>
                    <td width="21%" align="left" bgcolor="#CCC6A2">R$                     80,00 </td>
                    </tr>
                  <tr>
                    <td width="79%" bgcolor="#bcb483"><span onmouseover="_tipon(this)" onmouseout="_tipoff()"><strong>7 to 9 years</strong></span></td>
                    <td width="21%" align="left" bgcolor="#CCC6A2">R$                                 112,00</td>
                    </tr>
                </table>
                <p>&nbsp;</p></td>
          <td width="41%" align="center" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0" class="subTitulo">
            <tr>
              <td>Informations</td>
            </tr>
          </table>
          <table border="0" cellpadding="8" cellspacing="0" width="100%">
            <tbody>
              ...
              <tr>
                <td valign="middle" align="left"><span onmouseover="_tipon(this)" onmouseout="_tipoff()"><strong>Couples with full board</strong></span></td>
              </tr>
              <tr>
                <td valign="middle" align="left"><span onmouseover="_tipon(this)" onmouseout="_tipoff()"><strong>Period:</strong> January,February and July (except holidays).</span></td>
              </tr>
              <tr>
                <td valign="middle" align="left" height="33"><span onmouseover="_tipon(this)" onmouseout="_tipoff()"><strong>10% discount for</strong> cash payment.</span> <br />
                  <span onmouseover="_tipon(this)" onmouseout="_tipoff()"> (2 or more daily).</span></td>
              </tr>
              <tr>
                <td valign="middle" align="left"><span onmouseover="_tipon(this)" onmouseout="_tipoff()"> We do not accept checks.</span></td>
              </tr>
              <tr>
                <td valign="middle" align="left"><span onmouseover="_tipon(this)" onmouseout="_tipoff()"><strong>ACCEPT CREDIT CARDS</strong></span></td>
              </tr>
              </tbody>
          </table>          
          <p><br />
            <span onmouseover="_tipon(this)" onmouseout="_tipoff()">Payment method<br />
            </span>
            <script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','300','height','70','src','flash/formadepagamaentotarifario','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','flash/formadepagamaentotarifario' ); //end AC code
            </script>
            <noscript>
              <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="300" height="70">
                <param name="movie" value="flash/formadepagamaentotarifario.swf" />
                <param name="quality" value="high" />
                <embed src="flash/formadepagamaentotarifario.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="300" height="70"></embed>
              </object>
              </noscript>
          </p>
          </td>
