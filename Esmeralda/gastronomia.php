  ...
  <tr>
	...
	<!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellpadding="2" cellspacing="6">
        <tr>
          <td height="766"><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="link" id="link">Gastronomia</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td width="69%" height="558" align="left" valign="top"><p>Card&aacute;pio variado todos os dias com pratos quentes, saladas, frios e doces.<br />
                Para hospedagens em datas especiais - finais de semana, feriados, f&eacute;rias, alta temporada - um card&aacute;pio especial: feijoadas, assados, massas com vinho, peixes, sobremesas deliciosas e sem contar o caf&eacute; da manh&atilde; acompanhado de variedade de p&atilde;es, bolos, frutas e muito mais.</p>
                <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                  <tr>
                    <td>Nossos pacotes incluem tr&ecirc;s refei&ccedil;&otilde;es di&aacute;rias</td>
                  </tr>
                </table>
                <ul>
                  <li>Caf&eacute;-da-manh&atilde; </li>
                  <li>Almo&ccedil;o </li>
                  <li>Jantar</li>
                </ul>                
                <p><strong> Caf&eacute;-da-manh&atilde;:</strong> </p>
                <ul>
                  <li>Bolos, p&atilde;es, p&atilde;o de queijo e biscoitos caseiros. </li>
                  <li>Leite, caf&eacute;, ch&aacute;s e achocolatados. </li>
                  <li>Frios e queijos. </li>
                  <li>Sucos naturais. </li>
                  <li>Frutas da &eacute;poca. </li>
                  <li>Gel&eacute;ias, manteiga e requeij&atilde;o. </li>
                  <li>Cereais matinais.</li>
                </ul>
                <p><strong>Almo&ccedil;o e Jantar:</strong></p>
                <ul>
                  <li>Card&aacute;pio caprichado com uma sele&ccedil;&atilde;o de diversos pratos.</li>
                  <li>Os melhores doces.</li>
                  </ul>
                <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                  <tr>
                ...
                <table cellspacing="4" cellpadding="0">
                  <tr>
                    <td width="71%" align="left" valign="top">Trutas ao molho de alcaparras,                                                                        am&ecirc;ndoas, maracuj&aacute; ou&nbsp; champignon.&nbsp; </td>
                  </tr>
                  <tr>
                    <td width="71%" align="left" valign="top">Fondues de queijo e chocolate &agrave; beira da lareira.</td>
                  </tr>
                </table>
                <p></p>                <p>&nbsp;</p></td>
              <td width="31%" align="left" valign="top"><table width="51%" border="0" cellspacing="6" cellpadding="0">
                  <tr>
                    <td width="33%"><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="fotos/restaurante_fachada.jpg" rel="lightbox[fotos]" title="Restaurante - entrada"><img src="fotos/restaurante_fachada_mini.jpg" width="200" height="120" border="0" /></a></td>
                      </tr>
                    </table></td>
                    </tr>
                  <tr>
                    <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                        <tr>
                          <td><a href="fotos/restaurante_interior.jpg" rel="lightbox[fotos]" title="Interior do restaurante"><img src="fotos/restaurante_interior_mini.jpg" alt="" width="200" height="120" border="0" /></a></td>
                        </tr>
                    </table></td>
                    </tr>
                  <tr>
                    <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                        <tr>
                          <td><a href="fotos/jantar.jpg" rel="lightbox[fotos]" title="Jantar"><img src="fotos/jantar_mini.jpg" alt="" width="200" height="120" border="0" /></a></td>
                        </tr>
                      </table></td>
                    </tr>
                  <tr>
                    <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="fotos/restaurante_fachada2.jpg" rel="lightbox[fotos]" title="Restaurante - fachada"><img src="fotos/restaurante_fachada2_mini.jpg" alt="" width="200" height="120" border="0" /></a></td>
                      </tr>
                    </table></td>
                    </tr>
            ...
            <tr>
              <td height="144" colspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="6" cellpadding="0">
                <tr>
                  <td width="34%" align="center"><table width="33%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="fotos/almocotropical.jpg" rel="lightbox[fotos]" title="Almoço Tropical"><img src="fotos/almocotropical_mini.jpg" alt="" width="200" height="120" border="0" /></a></td>
                    </tr>
                  </table></td>
                  <td width="35%" align="center"><table width="33%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="fotos/restauranteNoturno.jpg" rel="lightbox[fotos]" title="Restaurante - Noturno"><img src="fotos/jantarNoturno.jpg" alt="" width="200" height="120" border="0" /></a></td>
                    </tr>
                  </table></td>
                  <td width="31%" align="right" valign="top"><table width="87%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="fotos/queijos.jpg" rel="lightbox[fotos]" title="Queijos e vinhos"><img src="fotos/queijosVinhos.jpg" alt="" width="200" height="120" border="0" /></a></td>
                    </tr>
                  </table></td>
                </tr>
              </table></td>
