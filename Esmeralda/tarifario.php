        ...
        <tr>
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="link" id="link">Tarifas e Promo&ccedil;&otilde;es</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td width="59%" align="left" valign="top" class="txt2"><p class="txt2">Prezado cliente,</p>
                <p class="txt2">Para melhor atend&ecirc;-lo e tirarmos todas as suas d&uacute;vidas, 
                  favor entrar em contato com nossa central de reservas pelo telefone: <br />
                  (24) 3352 - 1643 ou pelo email: info@pousadaesmeralda.com.br. <br />
                  <br />
                  Se preferir acesse nosso formul&aacute;rio de contato <a href="faleconosco.php#link" class="txt14px">clicando aqui</a>.</p></td>
          ...
          <table border="0" cellpadding="8" cellspacing="0" width="100%">
            <tbody>
              ...
              <tr>
                <td height="33" align="left" valign="middle"> <strong>10% de desconto</strong> para pagamento &agrave; vista.<br /></td>
              </tr>
              <tr>
