...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-1480426-5']);
...
<table width="700" border="0" align="center" cellpadding="4" cellspacing="0">
  <tr>
    <td width="627" align="right">&nbsp;</td>
    <td width="57" align="right"><table width="63" border="0" cellspacing="0" cellpadding="4">
      <tr>
  ...
  <tr>
	...
	<div id="divArredondado">
        ...
        <table width="100%" border="0" cellspacing="6" cellpadding="2">
          <tr>
            <td><table width="200" border="0" cellspacing="4" cellpadding="4">
                <tr>
				 
	
          <!--       <td>
                      <a href="tarifario.php#pacotes" >
                  		<img src="pacotes/tarifarioPromocional.jpg" alt="" width="238" height="136" border="0" />
                    </a>
                  </td>
                             	
                         
                   <td>
                  	<a href="pacotes/index_xv_de_novembro.php#pacotes">
                  		<img src="pacotes/capa_15_novembro.jpg" alt="Pacote" width="238" height="136" border="0" />
                    </a>
                   </td>
                  
                    <td>
                  	<a href="pacotes/reveillon.php#pacotes">
                  		<img src="pacotes/capa_reveillon.jpg" alt="Pacote" width="238" height="136" border="0" />
                    </a>
                   </td>
                    
                   <td>
                  	<a href="pacotes/natal.php#pacotes">
                  		<img src="pacotes/capa_natal.jpg" alt="Natal" width="238" height="136" border="0" />
                    </a>
                   </td>-->
 				  ...
 				  <td>
                    	<a href="hotel.php#hotel">
                        	<img src="imagens/hotel.jpg" alt="Hotel Pousada Esmeralda" width="238" height="136" border="0" />
                        </a>
                  </td> 
                	
                  <td>
                  	<a href="comochegar.php#comochegar">
                    	<img src="imagens/como_chegar.png" alt="Como Chegar" width="238" height="136" border="0" />
                    </a>
                  </td> 
                  
                  
 				  <td>
                    	<a href="pacotes/index.php#pacotes">
                  		<img src="pacotes/capa_reveillon.jpg" alt="Reveillon" width="238" height="136" border="0" />
                    </a>
                  </td> 
...
<map name="Map" id="Map"><area shape="rect" coords="60,335,173,356" href="../pacotes/index.php#pacotes" alt="Tarif&aacute;rio Balc&atilde;o" /><area shape="rect" coords="49,167,175,188" href="../index.php" alt="P&aacute;gina Inicial" />
...
<area shape="rect" coords="60,366,172,388" href="../tarifario.php#link" alt="Tarif&aacute;rio" />
<area shape="rect" coords="38,399,196,421" href="../reservas.php#link" alt="Reservas" />
<area shape="rect" coords="39,427,191,452" href="../luademel.php#link" alt="Lua-de-Mel" />
<area shape="rect" coords="40,459,189,481" href="../faleconosco.php#link" alt="Fale Conosco" />
<area shape="rect" coords="50,486,187,506" href="../comochegar.php#link" alt="Como Chegar" />
