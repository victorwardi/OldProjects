          ...
          <td height="466"><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="pacotes" id="pacotes">Pacote  XV de Novembro</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td align="center" valign="top" bgcolor="#E5D8B5"><table width="33%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                <tr>
                  <td><img src="15_novembro.jpg" alt="" width="650" height="450" border="0" /></td>
                </tr>
              </table></td>
              </tr>
            <tr>
                  ...
                  <tbody>
                    <tr>
                      <td align="left" valign="middle"><p><strong class="txt14px">Per&iacute;odo<br />
                        </strong><strong>&raquo; </strong>11/11/2011 a 15/11/2011 (sexta-feira a ter&ccedil;a-feira).<br />
                        <strong class="txt14px"> <br />
                          Eventos Gastron&ocirc;micos</strong> <br />
                          <strong>&raquo; </strong>Festival de trutas.<br />
                          <strong>&raquo; </strong>Feijoada &agrave; brasileira.
</p>
