  ...
  <tr>
	...
	<!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellpadding="2" cellspacing="6">
        <tr>
          <td height="466" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                <tr>
                  <td><a name="pacotes" id="pacotes">Pacotes</a></td>
                  </tr>
                </table></td>
            </tr>
            <tr>
              <td width="95%" align="left" valign="top"><table border="0" cellpadding="8" cellspacing="0" width="100%">
                <tbody>
                  <tr>
                    <td align="left" valign="middle"><p><strong>Em breve novos pacotes e promo&ccedil;&otilde;es.</strong></p>
                      <p>&nbsp;</p>
                      <p>&nbsp;</p>
                      <p>&nbsp;</p>
