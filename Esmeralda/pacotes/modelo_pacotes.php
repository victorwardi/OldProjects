  ...
  <tr>
	...
	<!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellpadding="2" cellspacing="6">
        <tr>
          <td height="466"><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="pacotes" id="pacotes">Feriado de 9 de Julho</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td colspan="2" align="center" valign="top" bgcolor="#E5D8B5"><table width="33%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                <tr>
                  <td><img src="2010.jpg" alt="" width="650" height="450" border="0" /></td>
                </tr>
              </table></td>
              </tr>
            <tr>
              <td width="5%" align="center" valign="top" bgcolor="#E5D8B5">&nbsp;</td>
              <td width="95%" align="left" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0" class="subTitulo">
                <tr>
              ...
              <table border="0" cellpadding="8" cellspacing="0" width="100%">
                <tbody>
                  <tr>
                    <td align="left" valign="middle"><p><strong class="txt14px">Per&iacute;odo<br />
                      </strong><strong>&raquo; </strong>09/07/2010 a 11/07/2010 (Sexta-feira &agrave; Domingo).<br />
                      <strong class="txt14px">
<br />
Eventos Gastron&ocirc;micos</strong>
<br />
<strong>&raquo;</strong> Festival de trutas.. <br />
                        
                      </p>
                      <p><strong class="txt14px">Eventos Ecol&oacute;gicos</strong><br />
                        <strong>&raquo;</strong> Caminhada Ecol&oacute;gica &agrave;s Prateleiras e 
                        Pico das Agulhas Negras com
                        guia especializado (opcional).<br />
                        <strong>&raquo;</strong> Cavalgada pelas Trilhas e Cachoeiras
                        da regi&atilde;o com Manga-Larga (opcional).</p>
                      <p>*M&iacute;nimo de 3 di&aacute;rias.                      </p>
                      <table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
                        <tr>
                          <td height="36"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                            <tr>
                              <td>Tarif&aacute;rio (di&aacute;ria)</td>
                            </tr>
                          </table></td>
                        </tr>
                        <tr>
                          <td width="59%" align="left" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0" class="subTitulo">
                            <tr>
                              <td>Acomoda&ccedil;&otilde;es </td>
                              </tr>
                            </table>
                            <table width="100%" cellpadding="4" cellspacing="2">
                              <tr>
                                <td bgcolor="#BCB483"><strong>CHAL&Eacute; MASTER</strong></td>
                                <td width="21%" bgcolor="#CCC6A2">R$                     382,00 </td>
                                </tr>
                              <tr>
                                <td bgcolor="#BCB483"><strong>CHAL&Eacute; SUPERIOR</strong></td>
                                <td bgcolor="#CCC6A2">R$                     328,00 </td>
                                </tr>
                              <tr>
                                <td width="79%" bgcolor="#BCB483"><strong>CHAL&Eacute; GEMINADO C/ LAREIRA</strong></td>
                                <td bgcolor="#CCC6A2">R$                                   310,00</td>
                                </tr>
                              <tr>
                                <td width="79%" bgcolor="#BCB483"><strong>CHAL&Eacute; GEMINADO S/ LAREIRA</strong></td>
                                <td bgcolor="#CCC6A2">R$                                   298,00</td>
                                </tr>
                              <tr>
                                <td width="79%" bgcolor="#BCB483"><strong>APARTAMENTO</strong></td>
                                <td bgcolor="#CCC6A2">R$                                   277,00</td>
                                </tr>
                              <tr>
                                <td width="79%" bgcolor="#BCB483"><strong>3&ordf; PESSOA (EM QQ. ACOMODA&Ccedil;&Atilde;O) </strong></td>
                                <td bgcolor="#CCC6A2">R$                                   122,00&nbsp;&nbsp;</td>
                                </tr>
                              <tr>
                                <td width="79%" bgcolor="#BCB483"><strong>SOLTEIRO (SGL) (EM QQ. ACOMODA&Ccedil;&Atilde;O)</strong></td>
                                <td bgcolor="#CCC6A2">R$                                   240,00</td>
                                </tr>
                              </table>
                            <br />
                            <table width="100%" border="0" cellpadding="4" cellspacing="0" class="subTitulo">
                              <tr>
                                <td>Tarif&aacute;rio CHD</td>
                                </tr>
                              </table>
                            <table width="100%" cellpadding="4" cellspacing="2">
                              <tr>
                                <td bgcolor="#BCB483"><strong>0 a 2 anos</strong></td>
                                <td align="left" bgcolor="#CCC6A2">Free</td>
                                </tr>
                              <tr>
                                <td bgcolor="#BCB483"><strong>3 a 6 anos</strong></td>
                                <td width="21%" align="left" bgcolor="#CCC6A2">R$                     76,00 </td>
                                </tr>
                              <tr>
                                <td width="79%" bgcolor="#BCB483"><strong>7 a 9 anos</strong></td>
                                <td width="21%" align="left" bgcolor="#CCC6A2">R$                                 106,00</td>
                                </tr>
                            </table></td>
                          </tr>
                      </table>
                      <p>&nbsp;</p>
                      <p><span class="txt14px"><strong>Reservas</strong></span><strong><br />
                        </strong>Informa&ccedil;&otilde;es atrav&eacute;s de nossa <a href="../reservas.php" class="txt"><strong>Central de Reservas</strong></a>.<br />
                          (24) 3352 1643<br />
                          info@pousadaesmeralda.com.br<strong><br />
                          </strong></p>                      </td>
                  </tr>
                  <tr>
                    <td align="left" valign="middle"><div align="center">
                      <script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','300','height','70','src','../flash/formadepagamaentopacotes','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','../flash/formadepagamaentopacotes' ); //end AC code
                    </script>
                      <noscript>
                        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="300" height="70">
                            <param name="wmode" value="transparent"/>
                          <param name="movie" value="../flash/formadepagamaentopacotes.swf" />
                          <param name="quality" value="high" />
                          <embed src="../flash/formadepagamaentopacotes.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="300" height="70"></embed>
                        </object>
                        </noscript>
                    </div></td>
                  </tr>
                  ...
                  <tr>
                    <td width="100%" align="left" valign="middle"><div align="center">N&atilde;o aceitamos cheques.</div></td>
                  </tr>
                  <tr>
                    <td align="left" valign="middle"><div align="center"><strong>ACEITAMOS CART&Otilde;ES DE CR&Eacute;DITO</strong></div></td>
                  </tr>
                </tbody>
              </table>              </td>
            </tr>
...
<map name="Map" id="Map"><area shape="rect" coords="60,334,173,355" href="index.php#pacotes" alt="Tarif&aacute;rio Balc&atilde;o" /><area shape="rect" coords="49,167,175,188" href="../index.php" alt="P&aacute;gina Inicial" />
