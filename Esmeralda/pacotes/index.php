          ...
          <td height="466"><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="pacotes" id="pacotes">Pacotes e Feriados</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td align="center" valign="top" bgcolor="#E5D8B5">
              
             <table width="100%" border="0" cellspacing="4" cellpadding="4">
                <tr>
                <!--<td>
						<a href="index_xv_de_novembro.php#pacotes"><img src="capa_15_novembro.jpg" alt="" width="238" height="136" border="0" /></a>
				</td>                  
                <td>      
						<a href="natal.php#pacotes"><img src="capa_natal.jpg" alt="Natal" width="238" height="136" border="0" /></a>						
                </td>   -->                        
                <td width="44%" align="center">
						<a href="reveillon.php#pacotes"><img src="capa_reveillon_esgotado.jpg" alt="" width="238" height="136" border="0" /></a>
				</td>
                <td width="56%" align="center"><a href="carnaval.php#pacotes"><img src="capa_carnaval.jpg" alt="" width="238" height="136" border="0" /></a></td>
                    </tr>
              </table>
            ...
            <tr>
              <td width="95%" align="left" valign="top"><table border="0" cellpadding="8" cellspacing="0" width="100%">
                <tbody>
                    <tr>
                      <td align="left" valign="middle"><p><strong>R</strong><span class="txt14px"><strong>eservas</strong></span><strong><br />
