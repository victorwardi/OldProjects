          ...
          <td height="466"><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="pacotes" id="pacotes">Pacote  de Ano Novo 2013/2014</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td align="center" valign="top" bgcolor="#E5D8B5"><table width="33%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                <tr>
                  <td><img src="anonovo.jpg" alt="" border="0" /></td>
                </tr>
              </table></td>
              </tr>
            <tr>
                  ...
                  <tbody>
                    <tr>
                      <td align="left" valign="middle"><p><strong class="txt14px">Per&iacute;odos<br />
                        </strong><strong>&raquo; </strong>27/12/2013 a 01/01/2014 (sexta-feira a quarta-feira)<br />
                        <strong class="txt14px"> <br />
                            Eventos Gastron&ocirc;micos</strong> <br />
                            <strong>&raquo; </strong>Ceia de Reveillon com m&uacute;sica ao vivo.<br />
