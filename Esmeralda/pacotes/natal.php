          ...
          <td height="466"><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="pacotes" id="pacotes">Pacote</a> de Natal 2013</td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td colspan="2" align="center" valign="top" bgcolor="#E5D8B5"><table width="33%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                <tr>
                  <td><img src="natal.jpg" alt="" width="650" border="0" /></td>
                </tr>
              </table></td>
              </tr>
            <tr>
              ...
              <table border="0" cellpadding="8" cellspacing="0" width="100%">
                <tbody>
                  <tr>
                    <td align="left" valign="middle"><p><strong class="txt14px">Per&iacute;odos<br />
                      </strong><strong>&raquo; </strong>20/12 a 25/12 (Sexta-feira a Quarta-feira) ou<strong> </strong>21/12 a 25/12 (S&aacute;bado a Quarta-feira)<br />
                    </p>
<p><strong class="txt14px">Ceia Especial de Natal</strong><br />
  <strong>&raquo;</strong> Nozes, castanhas, avel&atilde;s, t&acirc;maras, passas, frutas cristalizadas, 
  frutas natalinas,  <br />
  Peru, tender, lombinho, bacalhau, vinho,
  sobremesas natalinas e a tradicional rabanada.<br />
