      ...
      <table width="100%" border="0" cellpadding="2" cellspacing="6">
        <tr>
          <td><table width="100%" border="0" cellpadding="0" cellspacing="3" bgcolor="#E5D8B5">
            ...
            <tr>
              <td width="50%" align="left" valign="top" class="txt14px"> <p>Confira mais detalhes sobre nossas acomoda&ccedil;&otilde;es:</p>
                <p class="txt14px">- <a href="chalet_master.php#link" class="txt14px"> Chalet Master</a><br />
                  <br />
                  - <a href="chalet_superior.php#link" class="txt14px">Chalet Superior</a><br />
                  <br />
                  - <a href="chalet_geminado.php#link" class="txt14px">Chalet Geminado</a><br />
                  <br />
                  - <a href="apartamento.php#link" class="txt14px">Apartamento</a></p></td>
