...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','499','height','258','src','../flash/intro','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','wmode','transparent','movie','../flash/intro' ); //end AC code
  ...
  <tr>
	...
	<!-- InstanceBeginEditable name="conteudo" -->
            ...
            <td><table width="200" border="0" cellspacing="4" cellpadding="4">
                <tr>
				  ...
				  $temPacote = 2;
					if($temPacote == 1)
			{
			 echo "<td><a href='#'><img src='imagens/pacote_corpus_christi.png' alt='Pacotes' width='238' height='136' border='0' /></a></td>";
			 }else
			 {
			 echo "<td><a href='tarifariopromocional.php'><img src='imagens/tarifario_promo.png' alt='Tarifario Promocional' width='238' height='136' border='0' /></a></td>";}
			?>
                  <td><a href="hotel.php"><img src="imagens/hotel.png" alt="Hotel Pousada Esmeralda" width="238" height="136" border="0" /></a></td>
                  <td><a href="comochegar.php"><img src="imagens/como_chegar.png" alt="Como Chegar" width="238" height="136" border="0" /></a></td>
                </tr>
              </table></td>
          </tr>
        </table>
        <div id="alertBG"></div>
<div id="alertBOX"></div>
    <script>alertBOX('imagens/propagandas/7.jpg','650');</script>
