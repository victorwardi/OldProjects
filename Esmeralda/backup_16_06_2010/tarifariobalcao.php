        ...
        <tr>
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="link" id="link">Tarif&aacute;rio Balc&atilde;o</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
          ...
          <table border="0" cellpadding="8" cellspacing="0" width="100%">
            <tbody>
              ...
              <tr>
                <td align="left" valign="middle"><strong>Casal com pens&atilde;o completa</strong></td>
              </tr>
              <tr>
                <td align="left" valign="middle"><strong>Per&iacute;odo: </strong>Janeiro, Feveiro e Julho (Exceto Feriados).</td>
              </tr>
              <tr>
                <td height="33" align="left" valign="middle"> <strong>10% de desconto</strong> para pagamento &agrave; vista.<br /> 
                  (2 di&aacute;rias ou mais). </td>
              </tr>
              <tr>
