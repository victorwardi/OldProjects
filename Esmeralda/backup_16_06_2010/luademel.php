          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="link" id="link">Pacote Lua-de-mel</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td width="69%" align="left" valign="top"><p class="txt">Passe sua lua-de-mel no <strong>Hotel Pousada Esmeralda</strong>, com certeza uma data t&atilde;o importante merece um local inesquec&iacute;vel. Desfrute de <strong>total privacidade</strong> e <strong>conforto</strong> em um de nossos maravilhosos chalets.</p>
                <p class="txt"><em>M&iacute;nimo de 5 (cinco) dias.</em></p>
                <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                  <tr>
                    <td><strong> Os noivos ter&atilde;o direito:</strong></td>
                  </tr>
                </table>
                <ul class="txt14px">
                  <li class="txt"> Caf&eacute; da manh&atilde;<br />
                  </li>
                  <li class="txt"> Almo&ccedil;o<br />
                  </li>
                  <li class="txt"> Jantar &agrave; luz de vela</li>
                  </ul>                
                <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                  <tr>
                    <td><strong> Cortesias</strong></td>
                  </tr>
                </table>
                <ul class="txt">
                  <li>                    Passeio Ecol&oacute;gico ao Parque Nacional com Guias Especializados com dura&ccedil;&atilde;o de 3:30 hs. </li>
                  <li class="txt">
                    Drink de boas-vindas.</li>
                  <li class="txt"> Primeiro Caf&eacute;-da-manh&atilde; no chalet. </li>
                  <li>
                    Vinho ou Champagne.</li>
                </ul>
                <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                  <tr>
                    <td><strong> Tipos de Acomoda&ccedil;&atilde;o</strong></td>
                  </tr>
                </table>
                
                  <p class="txt">                    <strong>Chalet Lua-de-mel Superior:</strong> Lareira, frigobar, cama Queen-Size, interfone,  cofre, mini-cozinha, TV com Parab&oacute;lica, SKY, Sistema de DVD, estacionamento na porta e total privacidade. </p>
                  <p class="txt"><strong>Chalet   Master(Lua-de-mel) </strong>: Lareira, frigobar, cama King-Size, interfone,  cofre, mini-cozinha, TV com Parab&oacute;lica, SKY, Ar condicionado, DVD, CD Player, duas varandas, vista ao lago, rio encachoeirado ao fundo, estacionamento na porta e total privacidade.<br />
                      <br />
                  </p>
                  <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                  <tr>
                    <td><strong>Temos tamb&eacute;m</strong></td>
                  </tr>
                </table>
                  <p class="txt">Sauna &agrave; lenha, piscina aquecida, cachoeira, internet, sala com SKY e DVD, jogos, cavalos no haras, lago para pesca e uma extensa &aacute;rea verde de 200m&sup2;.<br />
                      <br />
                      Daremos as coordenadas dos passeios pelas trilhas, cachoeiras, mirantes, museu e os demais            pontos tur&iacute;sticos do Parque Nacional do Itatiaia. </p>
                  <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                    <tr>
                      <td>Forma de Pagamento</td>
                    </tr>
                  </table>
                  <p align="justify" class="txt">50% de sinal + 3   vezes sem juros no cart&atilde;o. </p>
                  <p align="justify" class="txt">Fa&ccedil;a sua reverva pelo telefone: <strong>(24) 3352-1643</strong></p>
                  <p></p>                <p>&nbsp;</p></td>
              <td width="31%" align="center" valign="top"><table width="96%" border="0" cellspacing="6" cellpadding="0">
                  <tr>
                    <td width="33%"><table width="91%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                        <tr>
                          <td><img src="fotos/casal.jpg" alt="" width="180" height="245" border="0" /></td>
                        </tr>
                    </table></td>
                    </tr>
                  <tr>
                    <td><table width="91%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                        <tr>
                          <td><a href="fotos/veu.jpg" rel="lightbox[fotos]" title=""><img src="fotos/cachoeiral.jpg" alt="" width="180" height="256" border="0" /></a></td>
                        </tr>
                    </table></td>
                    </tr>
                  <tr>
                    <td><table width="91%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                      <tr>
                        <td><a href="fotos/superior_g.jpg" rel="lightbox[fotos]" title=""><img src="fotos/quarto.jpg" alt="" width="180" height="200" border="0" /></a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
