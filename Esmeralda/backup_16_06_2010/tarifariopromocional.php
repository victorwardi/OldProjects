          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="link" id="link">Tarif&aacute;rio Promocional</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td width="59%" align="left" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0" class="subTitulo">
                ...
                <tr>
                  ...
                  <td width="21%" bgcolor="#CCC6A2">R$                     346,00 </td>
                </tr>
                <tr>
                ...
                <table width="100%" cellpadding="4" cellspacing="2">
                  ...
                  <tr>
                    ...
                    <td width="21%" align="left" bgcolor="#CCC6A2">R$                     70,00 </td>
                  </tr>
                  <tr>
                    <td width="79%" bgcolor="#BCB483"><strong>7 a 9 anos</strong></td>
                    <td width="21%" align="left" bgcolor="#CCC6A2">R$                                 98,00</td>
                  </tr>
                </table></td>
          ...
          <table border="0" cellpadding="8" cellspacing="0" width="100%">
            <tbody>
              ...
              <tr>
                ...
                <strong>Casal com pens&atilde;o completa</strong></td>
              </tr>
              <tr>
                <td align="left" valign="middle"><p><strong>Per&iacute;odo:</strong> Mar&ccedil;o a 15 de Junho, Agosto a 15 de Dezembro (Exceto Janeiro, Fevereiro,   Julho e Feriados).</p>
                  </td>
              </tr>
              <tr>
                <td height="33" align="left" valign="middle"> <strong>10% de desconto</strong> para pagamento &agrave; vista.<br /> 
                  (2 di&aacute;rias ou mais). <br /></td>
              </tr>
              <tr>
                <td width="100%" align="left" valign="middle">N&atilde;o aceitamos cheques.</td>
              </tr>
              <tr>
                <td align="left" valign="middle"><strong>ACEITAMOS CART&Otilde;ES DE CR&Eacute;DITO</strong></td>
              </tr>
            </tbody>
          </table>          
          <p><br />
