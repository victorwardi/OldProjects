            ...
            <td height="712"><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
                <tr>
                  <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                      <tr>
                        <td><a name="link" id="link">O Hotel</a></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                  <td width="69%" height="561" align="left" valign="top"><p>o <strong>Hotel Pousada Esmeralda</strong>, localizado no Parque  Nacional do Itatiaia, em uma regi&atilde;o previlegiada, entre as montanhas,  oferece aos seus h&oacute;spedes muito conforto e tranquilidade, com ambientes  charmosos e aconchegantes. Integra com perfei&ccedil;&atilde;o em um s&oacute; lugar:  conforto, natureza e lazer.</p>
                    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                      <tr>
                        <td>Atrativos</td>
                      </tr>
                    </table>
                    <strong>Pens&atilde;o completa</strong> (Caf&eacute;-da-manh&atilde;, almo&ccedil;o e jantar).
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                      <tr>
                        <td><strong>Passeios</strong></td>
                      </tr>
                    </table>
                    Possuimos conv&ecirc;nio com haras e guias especializados para oferecer aos nossos clientes o melhor da regi&atilde;o.
                    <ul>
                      <li>Caminhada Ecol&oacute;gica &agrave;s Prateleiras e 
                        Pico das Agulhas Negras com
                        guia especializado.</li>
                      <li> Cavalgada pelas Trilhas e Cachoeiras
                        da regi&atilde;o com Manga-Larga.</li>
                    </ul>
                    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="subTitulo">
                      <tr>
                        <td><strong>Novidade</strong></td>
                      </tr>
                    </table>
                    <table width="100" border="0" cellspacing="6" cellpadding="0">
                    <tr>
                      <td><img src="imagens/internet.jpg" alt="Computador com acesso &agrave; internet"/></td>
                    </tr>
                  </table></td>
                  <td width="31%" align="left" valign="top"><table width="51%" border="0" cellspacing="6" cellpadding="0">
                      ...
                      <tr>
                        <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                            <tr>
                              <td><a href="fotos/recepcao.jpg" rel="lightbox[fotos]" title="Recepçao - Sala de Vídeos - Jogos - Internet"><img src="fotos/recepcao_p.jpg" alt="" width="200" height="120" border="0" /></a></td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
                        <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                            <tr>
                              <td><a href="fotos/lago_montanha.jpg" rel="lightbox[fotos]" title="Lago - Montanha "><img src="fotos/lago_montanha_mini.jpg" width="200" height="120" border="0" /></a></td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
