          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#E5D8B5">
            <tr>
              <td height="36" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="6" class="titulo">
                  <tr>
                    <td><a name="link" id="link">Passeios</a></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              <td width="52%" rowspan="2" align="center" valign="top" bgcolor="#E5D8B5"><table width="100" border="0" cellspacing="6" cellpadding="0">
                <tr>
                  <td width="26%"><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="fotos/agulhasNegras.jpg" rel="lightbox[fotos]" title="Pico das Agulhas Negras"><img src="fotos/mini_agulhasNegras.jpg" alt="Agulhas Negras" width="90" height="60" border="0" /></a></td>
                    </tr>
                  </table></td>
                  <td width="25%"><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="fotos/rapel.jpg" rel="lightbox[fotos]" title="Rapel"><img src="fotos/min_rapel.jpg"  width="90" height="60" border="0" /></a></td>
                    </tr>
                  </table></td>
                  <td width="49%"><table width="98%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="fotos/visconde_de_maua.jpg" rel="lightbox[fotos]" title="Visconde de Mau&aacute;"><img src="fotos/mini_visconde_de_maua.jpg" width="90" height="60" border="0" /></a></td>
                    </tr>
                  </table></td>
                  </tr>
                <tr>
                  <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="fotos/cachoeira2.jpg" rel="lightbox[fotos]" title="Cachoeira"><img src="fotos/cachoeira2_mini.jpg" width="90" height="68" border="0" /></a></td>
                    </tr>
                  </table></td>
                  <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="fotos/cavalos.jpg" rel="lightbox[fotos]" title="Passeios a Cavalo"><img src="fotos/cavalos_mini.jpg" width="90" height="68" border="0" /></a></td>
                    </tr>
                  </table></td>
                  <td><table width="96%" border="1" cellpadding="0" cellspacing="4" bordercolor="#999999" bgcolor="#FFFFFF">
                    <tr>
                      <td><a href="fotos/veu.jpg" rel="lightbox[fotos]" title="Véu de Noiva"><img src="fotos/veu_mini.jpg"  width="90" height="68" border="0" /></a></td>
                    </tr>
                  </table></td>
                  </tr>

              </table></td>
              <td width="48%" align="left" valign="top"><table width="94%" cellpadding="0" cellspacing="6">
                <tr>
                  <td width="71%" align="left" valign="top" class="txt14px"><div align="left">&raquo; Pico das Agulhas Negras  (RAPPEL).</div></td>
                </tr>
                <tr>
                  <td width="71%" align="left" valign="top" class="txt14px"><div align="left">&raquo; Parte baixa do Parque Nacional.</div></td>
                  </tr>
                <tr>
                  <td width="71%" align="left" valign="top" class="txt14px"><div align="left">&raquo; Visconde de Mau&aacute;.</div></td>
                  </tr>
                <tr>
                  <td width="71%" align="left" valign="top" class="txt14px"><div align="left">&raquo; Morro do Coto.</div></td>
                  </tr>
                <tr>
                  <td width="71%" align="left" valign="top" class="txt14px"><div align="left">&raquo; Cachoeira do Rio   Airuoca.</div></td>
                  </tr>
                <tr>
                  <td align="left" valign="top" class="txt14px"><div align="left">&raquo; Cavalgada com Manga-larga.</div></td>
                </tr>
                <tr>
                  <td width="71%" align="left" valign="top" class="txt14px"><div align="left">&raquo; &Uacute;ltimo Adeus    (RAPPEL).</div></td>
                  </tr>
                <tr>
                  <td width="71%" align="left" valign="top" class="txt14px"><div align="left">&raquo; Pescaria de Trutas   (SERRINHA).</div></td>
                  </tr>
                <tr>
                  <td width="71%" align="left" valign="top" class="txt14px"><div align="left">&raquo; Pescaria na represa de   FURNAS com barco e guia.</div></td>
                  </tr>
                <tr>
                  <td width="71%" align="left" valign="top" class="txt14px"><div align="left">&raquo; City Tour Penedo.</div></td>
                  </tr>
              </table>                
<p><strong><br />
                        </strong></p>                </td>
