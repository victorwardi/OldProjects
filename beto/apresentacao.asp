					...
					<td width="530" height="348" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <th height="337" colspan="2" align="center" valign="top" scope="col"><table width="95%"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <th scope="col"><div align="left"><img src="imagens/retalhos/apresentacao.jpg" width="200" height="40"></div></th>
                            <th scope="col"><span class="style2 style38 style39"><a href="default.asp" class="laranja">Voltar &agrave; P&aacute;gina Inicial</a></span></th>
                          </tr>
                          <tr>
                            <td height="337" colspan="2" background="imagens/retalhos/fundo_apresenta.jpg"><div align="justify"><span class="style3"><strong>Erisberto Abrantes</strong> tem 20 anos, &eacute; potiguar, radicado no Esp&iacute;rito Santo. Na praia de Itapo&atilde; ele iniciou aulas na Escolinha Pomp&eacute;ia em <strong>1999</strong>, e desde ent&atilde;o foi levado pelos seus pais para as competi&ccedil;&otilde;es, sendo: Campe&atilde;o Iniciante em <strong>2000</strong>, 4&ordm; colocado na categoria Amador <strong>2001</strong>, <strong>Campe&atilde;o</strong> do Circuito Capixaba Amador em 2002. Em <strong>2003</strong> mostrando seu talento e conquistando t&iacute;tulos como o do Festival de Ver&atilde;o, Tri Campeonato do Circuito Capixaba e<strong> Vice Campe&atilde;o</strong> Brasileiro, em <strong>2004</strong> ele surpreende a todos e vence o Circuito Carioca, conquista o <strong>Tetra Campeonato</strong> Capixaba ainda o Vice-Campeonato Brasileiro pela segunda vez consecutiva. Em <strong>2005</strong> ele se revela para o mundo participando do Circuito Latino Americano e Mundial, onde lidera ambos os circuitos, e continua a participar de circuitos locais e regionais, <strong>liderando</strong> o circuito Macaense, 6&deg; colocado no brasileiro, <strong>Campe&atilde;o</strong> do Festival de Ver&atilde;o, <strong>L&iacute;der</strong> do Capixaba Amador. Mesmo ele sendo um atleta amador esta em 46&deg; no <strong>circuito mundial </strong>profissional. </span> </div>                              <p class="style3">Sempre empenhado em conseguir bons resultados, ele &eacute; tido como <strong>revela&ccedil;&atilde;o</strong> mundial, reconhecido pelo seu estilo radical, simpatia e coragem. </p>
                              <p class="style3">O ano de <strong>2006</strong> promete ser de <strong>grandes conquistas</strong> para este atleta, que representa a <strong>nova gera&ccedil;&atilde;o</strong> do esporte. </p>
                            <p></p>
                            <p></p>
                            <p></p>
                            <p></p></td>
