...
<%
Dim Rs_arquivo
Dim Rs_arquivo_numRows

Set Rs_arquivo = Server.CreateObject("ADODB.Recordset")
Rs_arquivo.ActiveConnection = MM_con_bb_STRING
Rs_arquivo.Source = "SELECT * FROM noticia ORDER BY CodNoticia DESC"
Rs_arquivo.CursorType = 0
Rs_arquivo.CursorLocation = 2
Rs_arquivo.LockType = 1
Rs_arquivo.Open()

Rs_arquivo_numRows = 0
%>
<%
...
Repeat2__numRows = -1
Repeat2__index = 0
Rs_arquivo_numRows = Rs_arquivo_numRows + Repeat2__numRows
%>
					...
					<td width="530" height="348" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <th height="337" colspan="2" align="center" valign="top" scope="col"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <th width="62%" scope="col"><div align="left"><img src="imagens/retalhos/arq_news.jpg" width="200" height="40"></div></th>
                            <th width="38%" scope="col"><span class="style2 style38 style39"><a href="default.asp" class="laranja">Voltar &agrave; P&aacute;gina Inicial</a></span></th>
                          </tr>
                          <tr>
                            <td colspan="2" align="center">
                              <% 
While ((Repeat2__numRows <> 0) AND (NOT Rs_arquivo.EOF)) 
%>
                              <table width="100%" height="21"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
                                <tr>
                                  <th colspan="2" scope="col"><span class="style11">-</span></th>
                                </tr>
                                <tr>
                                  <th width="7%" scope="col"><img src="imagens/retalhos/seta.jpg" width="17" height="17"></th>
                                  <th width="93%" align="left" valign="middle" class="style3" scope="col"><a href="ver_noticia.asp?CodNot=<%=(Rs_arquivo.Fields.Item("CodNoticia").Value)%>" class="style14"><%=(Rs_arquivo.Fields.Item("data").Value)%> <strong>-</strong> <%=(Rs_arquivo.Fields.Item("titulo").Value)%></a></th>
                                </tr>
                              </table>
                              <% 
