...
destino= pasta & "fotos\midia\" & nomecompletoimg
destino2= pasta & "fotos\midia\"& "foto_" & nomefoto
nomefoto= Session("count") & ".jpg"

	File.SaveAs pasta & "fotos\midia\original\" & File.OriginalFileName
...
<table width="464" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="899" height="25" bgcolor="#FF9900"><div align="center"><span class="tur"><span class="style1">:: Adicionar Foto &Agrave; Midia :: </span></span></div></td>
  </tr>
  <tr>
    <td><form action="adicionar_foto_midia.asp" method="post" enctype="multipart/form-data" target="_self" id=form>
        <div align="center">
          <center>
            <table width="459" border="0" align="center" cellpadding="5" cellspacing="0" class="tbl">
              ...
              <tr>
                ...
                <td><table width="215" border="0" cellpadding="0" cellspacing="0" class="tbl">
                    ...
                    <tr>
                      <td height="36" valign="top"><img src="../fotos/midia/<%=Session("nomedb")%>" alt="" border="0"></td>
                    </tr>
                </table></td>
              </tr>
			   <%  End If %>
