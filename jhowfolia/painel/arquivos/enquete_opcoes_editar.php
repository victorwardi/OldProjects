                  ...
                  <table cellpadding="2" cellspacing="0" class="borda_roxa" id="painel">
                    <thead>
                      <tr class="KT_row_order">
                        <th width="38" align="center" bgcolor="#3333FF"> <input type="checkbox" name="KT_selAll" id="KT_selAll"/>
                        </th>
                        <th width="166" align="center" bgcolor="#3333FF" class="KT_sorter KT_col_optionText <?php echo $tso_listpoller_option2->getSortIcon('poller_option.optionText'); ?>" id="optionText"><a href="<?php echo $tso_listpoller_option2->getSortLink('poller_option.optionText'); ?>">T&iacute;tulo</a></th>
                        <th width="168" align="center" bgcolor="#3333FF" class="KT_sorter KT_col_pollerOrder <?php echo $tso_listpoller_option2->getSortIcon('poller_option.pollerOrder'); ?>" id="pollerOrder"> <a href="<?php echo $tso_listpoller_option2->getSortLink('poller_option.pollerOrder'); ?>">Ordem na equente </a> </th>
                        <th width="57" align="center" bgcolor="#3333FF" class="KT_sorter KT_col_defaultChecked <?php echo $tso_listpoller_option2->getSortIcon('poller_option.defaultChecked'); ?>" id="defaultChecked"> <a href="<?php echo $tso_listpoller_option2->getSortLink('poller_option.defaultChecked'); ?>">Marcado</a> </th>
                        <th width="89" align="center" bgcolor="#3333FF">&nbsp;</th>
                      </tr>
                      <?php 
