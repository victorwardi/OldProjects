      ...
      <embed src="destaque.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="540" height="240"></embed>
        ...
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><table width="652" border="0" cellpadding="0" cellspacing="4">
                <tr>
                  <td width="644"><table width="100%" border="0" cellpadding="4" cellspacing="0">
                    <tr>
                    ...
                    <tr>
                      <th height="25" align="center" valign="top" scope="col"><?php do { ?>
                          <table width="98%" border="0" cellpadding="4" cellspacing="0" class="borda_pontilhada_noticias">
                            <tr>
                              <th width="15%" height="41" align="center" valign="middle" scope="col"><a href="exibir_noticia.php?id=<?php echo $row_arquivo['id']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("", "uploads/fotos/", "{arquivo.imagem}", 80, 50, false); ?>" width="80" height="50" hspace="5" border="0" align="center" /></a></th>
                              <th width="85%" align="left" valign="middle" class="fonte_not" scope="col"><span class="fonte_titulo_not"><?php echo $row_arquivo['coluna']; ?> - <?php echo $row_arquivo['data']; ?></span><a href="exibir_noticia.php?id=<?php echo $row_arquivo['id']; ?>" class="fonte_not"><br />
                                    <?php echo $row_arquivo['titulo']; ?></a></th>
                            </tr>
                          </table>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td align="center" valign="middle"> <br />
                            Voc&ecirc; est&aacute; vendo da not&iacute;cia <span class="fonte_titulo_not"><?php echo ($startRow_arquivo + 1) ?></span> &agrave; not&iacute;cia <span class="fonte_titulo_not"><?php echo min($startRow_arquivo + $maxRows_arquivo, $totalRows_arquivo) ?></span> em um total de <span class="fonte_titulo_not"><?php echo $totalRows_arquivo ?></span> not&iacute;cias.<br />
                            <br />
