  ...
  <tr>
    ...
    <td width="608" align="center" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <th align="left" valign="middle" bgcolor="#EA8C06" class="Titulo_Branco" scope="col"> Not&iacute;cia </th>
        </tr>
        <tr>
                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#EA8C06" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        <th bgcolor="#EA8C06"> <input type="checkbox" name="KT_selAll" id="KT_selAll"/>                        </th>
                        <th bgcolor="#EA8C06" class="KT_sorter KT_col_imagem <?php echo $tso_listnoticias8->getSortIcon('noticias.imagem'); ?>" id="imagem"> <a href="<?php echo $tso_listnoticias8->getSortLink('noticias.imagem'); ?>">Imagem</a> </th>
                        <th bgcolor="#EA8C06" class="KT_sorter KT_col_titulo <?php echo $tso_listnoticias8->getSortIcon('noticias.titulo'); ?>" id="titulo"> <a href="<?php echo $tso_listnoticias8->getSortLink('noticias.titulo'); ?>">Titulo</a> </th>
                        <th bgcolor="#EA8C06" class="KT_sorter KT_col_data <?php echo $tso_listnoticias8->getSortIcon('noticias.data'); ?>" id="data"> <a href="<?php echo $tso_listnoticias8->getSortLink('noticias.data'); ?>">Data</a> </th>
                        <th bgcolor="#EA8C06">&nbsp;</th>
                      </tr>
                      <?php 
