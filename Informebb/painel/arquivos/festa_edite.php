                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#EA8C06" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_imagem <?php echo $tso_listfestas9->getSortIcon('festas.imagem'); ?>" id="imagem"> <a href="<?php echo $tso_listfestas9->getSortLink('festas.imagem'); ?>">Imagem</a> </th>
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_nome <?php echo $tso_listfestas9->getSortIcon('festas.nome'); ?>" id="nome"> <a href="<?php echo $tso_listfestas9->getSortLink('festas.nome'); ?>">Nome</a> </th>
