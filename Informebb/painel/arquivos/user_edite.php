...
// Filter
$tfi_listuser2 = new TFI_TableFilter($conn_saquabb, "tfi_listuser2");
$tfi_listuser2->addColumn("user.nome", "STRING_TYPE", "nome", "%");
$tfi_listuser2->addColumn("user.senha", "STRING_TYPE", "senha", "%");
$tfi_listuser2->addColumn("user.level", "NUMERIC_TYPE", "level", "=");
$tfi_listuser2->Execute();

// Sorter
$tso_listuser2 = new TSO_TableSorter("rsuser1", "tso_listuser2");
$tso_listuser2->addColumn("user.nome");
$tso_listuser2->addColumn("user.senha");
$tso_listuser2->addColumn("user.level");
$tso_listuser2->setDefault("user.nome DESC");
$tso_listuser2->Execute();

// Navigation
$nav_listuser2 = new NAV_Regular("nav_listuser2", "rsuser1", "../../", $_SERVER['PHP_SELF'], 10);

//NeXTenesio3 Special List Recordset
$maxRows_rsuser1 = $_SESSION['max_rows_nav_listuser2'];
$pageNum_rsuser1 = 0;
...
if (isset($_SESSION['filter_tfi_listuser2'])) {
  $NXTFilter_rsuser1 = $_SESSION['filter_tfi_listuser2'];
}
$NXTSort_rsuser1 = "user.nome DESC";
if (isset($_SESSION['sorter_tso_listuser2'])) {
  $NXTSort_rsuser1 = $_SESSION['sorter_tso_listuser2'];
}
  ...
  <tr>
    ...
    <td width="608" align="center" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <th align="left" valign="middle" bgcolor="#EA8C06" class="Titulo_Branco" scope="col">Usu&aacute;rio</th>
        </tr>
        <tr>
          <th align="left" valign="top" scope="row"><div class="KT_tng" id="listuser2"><div class="KT_tnglist"><form action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" method="post" id="form1"><div class="KT_options">
            <?php 
  // Show IF Conditional region2
  if (@$_SESSION['has_filter_tfi_listuser2'] == 1) {
?>
                              <a href="<?php echo $tfi_listuser2->getResetFilterLink(); ?>"><?php echo NXT_getResource("Reset filter"); ?></a>
                              <?php 
  // else Conditional region2
  } else { ?>
                              <a href="<?php echo $tfi_listuser2->getShowFilterLink(); ?>"><?php echo NXT_getResource("Show filter"); ?></a>
                              <?php } 
                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#EA8C06" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        <th align="center" bgcolor="#EA8C06"> <input type="checkbox" name="KT_selAll" id="KT_selAll"/>
                        </th>
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_nome <?php echo $tso_listuser2->getSortIcon('user.nome'); ?>" id="nome"> <a href="<?php echo $tso_listuser2->getSortLink('user.nome'); ?>">Nome</a> </th>
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_senha <?php echo $tso_listuser2->getSortIcon('user.senha'); ?>" id="senha"> <a href="<?php echo $tso_listuser2->getSortLink('user.senha'); ?>">Senha</a> </th>
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_level <?php echo $tso_listuser2->getSortIcon('user.level'); ?>" id="level"> <a href="<?php echo $tso_listuser2->getSortLink('user.level'); ?>">Level</a> </th>
...
?>
                        <tr class="KT_row_filter">
                          <td>&nbsp;</td>
                          <td><input type="text" name="tfi_listuser2_nome" id="tfi_listuser2_nome" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listuser2_nome']); ?>" size="20" maxlength="30" /></td>
                          <td><input type="text" name="tfi_listuser2_senha" id="tfi_listuser2_senha" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listuser2_senha']); ?>" size="20" maxlength="30" /></td>
                          <td><input type="text" name="tfi_listuser2_level" id="tfi_listuser2_level" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listuser2_level']); ?>" size="20" maxlength="100" /></td>
                          <td><input type="submit" name="tfi_listuser2" value="<?php echo NXT_getResource("Filter"); ?>" /></td>
                        </tr>
                        <?php } 
