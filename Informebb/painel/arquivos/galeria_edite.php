...
// Filter
$tfi_listgaleria1 = new TFI_TableFilter($conn_saquabb, "tfi_listgaleria1");
$tfi_listgaleria1->addColumn("galeria.id", "NUMERIC_TYPE", "id", "=");
$tfi_listgaleria1->addColumn("galeria.nome", "STRING_TYPE", "nome", "%");
$tfi_listgaleria1->addColumn("galeria.imagem", "STRING_TYPE", "imagem", "%");
...
$rsgaleria1 = mysql_query($query_limit_rsgaleria1, $saquabb) or die(mysql_error());
  ...
  <tr>
    ...
    <td width="608" align="center" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <th align="left" valign="middle" bgcolor="#EA8C06" class="Titulo_Branco" scope="col">Galeria</th>
        </tr>
        <tr>
          <th align="left" valign="top" scope="row"><div class="KT_tng" id="listgaleria1"><div class="KT_tnglist"><form action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" method="post" id="form1"><div class="KT_options">
                              <?php 
                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#EA8C06" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_nome <?php echo $tso_listgaleria1->getSortIcon('galeria.nome'); ?>" id="nome"> <a href="<?php echo $tso_listgaleria1->getSortLink('galeria.nome'); ?>">Nome</a> </th>
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_imagem <?php echo $tso_listgaleria1->getSortIcon('galeria.imagem'); ?>" id="imagem"> <a href="<?php echo $tso_listgaleria1->getSortLink('galeria.imagem'); ?>">Imagem</a> </th>
                        ...
                        <?php do { ?>
                          <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                            <td><input type="checkbox" name="kt_pk_galeria" class="id_checkbox" value="<?php echo $row_rsgaleria1['id']; ?>" />
                                <input type="hidden" name="id" class="id_field" value="<?php echo $row_rsgaleria1['id']; ?>" />
                            </td>
                            <td><div class="KT_col_nome"><?php echo KT_FormatForList($row_rsgaleria1['nome'], 20); ?></div></td>
                            <td align="center"><img src="<?php echo tNG_showDynamicThumbnail("../../", "../../uploads/fotos/", "{rsgaleria1.imagem}", 100, 0, true); ?>" /></td>
