                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#EA8C06" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_flyer <?php echo $tso_listvem_ai5->getSortIcon('vem_ai.flyer'); ?>" id="flyer"> <a href="<?php echo $tso_listvem_ai5->getSortLink('vem_ai.flyer'); ?>">Flyer</a> </th>
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_nome <?php echo $tso_listvem_ai5->getSortIcon('vem_ai.nome'); ?>" id="nome"> <a href="<?php echo $tso_listvem_ai5->getSortLink('vem_ai.nome'); ?>">Nome</a> </th>
