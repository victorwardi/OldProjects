  ...
  <tr>
    ...
    <td width="608" align="center" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <th align="left" valign="middle" bgcolor="#EA8C06" class="Titulo_Branco" scope="col">Coment&aacute;rio not&iacute;cia </th>
        </tr>
        <tr>
                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#EA8C06" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_nome <?php echo $tso_listcomentarios_not8->getSortIcon('comentarios_not.nome'); ?>" id="nome"> <a href="<?php echo $tso_listcomentarios_not8->getSortLink('comentarios_not.nome'); ?>">Nome</a> </th>
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_id <?php echo $tso_listcomentarios_not8->getSortIcon('comentarios_not.id'); ?>" id="id"> <a href="<?php echo $tso_listcomentarios_not8->getSortLink('comentarios_not.id'); ?>">Id</a> </th>
                        <th align="center" bgcolor="#EA8C06" class="KT_sorter KT_col_aprovado <?php echo $tso_listcomentarios_not8->getSortIcon('comentarios_not.aprovado'); ?>" id="aprovado"> <a href="<?php echo $tso_listcomentarios_not8->getSortLink('comentarios_not.aprovado'); ?>">Aprovado</a> </th>
