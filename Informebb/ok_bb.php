            ...
            <tr>
              ...
              <th width="82%" align="left" valign="top" scope="col"><!-- InstanceBeginEditable name="conteudo" -->
                <table width="100%" border="0" cellspacing="4" cellpadding="0">
                  ...
                  <tr>
                    <td><p>Parab&eacute;ns, seu cadastro foi efetuado com sucesso!<br />
                      Em breve, analisaremos e publicaremos.<br />
                      <br />
                      Continue navegando pelo site!</p>
                      <p>&nbsp;</p>
                      <p>Atenciosamente,<br />
                        <br />
                          <br />
                          <span class="fonte_titulo_not">Equipe inFORmeBB</span></p></td>
                  </tr>
                </table>
