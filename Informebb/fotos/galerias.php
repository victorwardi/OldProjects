...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="4" align="center" valign="bottom" background="imagens/fundo_titulo.jpg"><table width="513" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <th width="399" height="25" align="left" valign="middle" scope="col">&nbsp;<span class="titulo">Galerias de Fotos </span></th>
      </tr>
    </table></td>
    <td><img src="imagens/conteudo/spacer.gif" width="1" height="36" border="0" alt="" /></td>
  </tr>
...
?>
                <td><table width="162" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <th align="center" valign="middle" scope="col">&nbsp;<a href="galeria.php?id=<?php echo $row_galerias['id']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("../", "../fotos/capa/", "{galerias.imagem}", 165, 0, true); ?>" border="0" class="borda_galeria" /></a></th>
                      </tr>
                      <tr>
                        <th align="center" valign="middle" scope="row">&nbsp;<span class="texto_galeria"><?php echo $row_galerias['nome']; ?></span></th>
                      </tr>
                        </table></td>
                <?php
    $row_galerias = mysql_fetch_assoc($galerias);
