...
$query_galerias = "SELECT * FROM galeria WHERE nome <> 'gabriel' AND   nome <> 'ovni' ORDER BY id DESC";
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','540','height','240','src','destaque','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','wmode','Transparent','movie','destaque' ); //end AC code
      ...
      <embed src="destaque.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="540" height="240"></embed>
        ...
        <tr>
          ...
          <table width="650" border="0" cellpadding="0" cellspacing="8" bgcolor="#FFFFFF">
            <tr>
              <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="linha_laranja_4px">
                <tr>
                  <th align="left" valign="middle" scope="col"><img src="imagens/recorte/titulos/galerias.jpg" alt="Galerias de Fotos" width="300" height="40" border="0" /></th>
                </tr>
              </table></td>
            </tr>
            <tr>
...
?>
                  <td height="135" align="center" valign="top"><table width="100" height="133" border="0" cellpadding="0" cellspacing="2">
                      <tr>
                        <td height="97" align="center" class="tiutlo_not"><a href="galeria.php?galeria=<?php echo $row_galerias['nome']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("", "uploads/fotos/", "{galerias.imagem}", 120, 90, false); ?>" border="0" class="borda_foto_noticia" /></a></td>
                      </tr>
                      <tr>
                        <td height="30" align="center" valign="top" class="fonte_not"><a href="galeria.php?galeria=<?php echo $row_galerias['nome']; ?>"><?php echo $row_galerias['nome']; ?></a></td>
                      </tr>
                  </table></td>
                  <?php
    $row_galerias = mysql_fetch_assoc($galerias);
    ...
    if (isset($row_galerias) && is_array($row_galerias) && $nested_galerias++ % 5==0) {
      echo "</tr><tr>";
    }
