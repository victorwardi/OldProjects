...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','540','height','240','src','destaque','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','wmode','Transparent','movie','destaque' ); //end AC code
      ...
      <embed src="destaque.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="540" height="240"></embed>
        ...
        <tr>
          ...
          <table width="660" border="0" cellpadding="2" cellspacing="8">
            <tr>
              <td width="60%" height="17" align="left" class="Titulo_Branco"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="linha_laranja_4px">
                <tr>
                  <th align="left" valign="middle" scope="col"><img src="imagens/recorte/titulos/noticias.jpg" alt="noticias" width="300" height="40" border="0" /></th>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td align="center" valign="middle" class="perfil_nome"><table width="100" border="0" cellpadding="0" cellspacing="8" bgcolor="#FFFFFF">
                  <tr>
                    <th align="center" valign="middle" scope="col"><img src="<?php echo tNG_showDynamicImage("", "uploads/fotos/", "{noticias.imagem}");?>" class="borda_foto_noticia" /></th>
                  </tr>
                </table></td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="36" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="4" bgcolor="#FFFFFF">
                  <tr>
                    <td height="20" align="left"><span class="tiutlo_not">Autor:</span> <span class="fonte_not"><?php echo $row_noticias['fonte']; ?></span></td>
                    <td align="left"><span class="tiutlo_not">Data:</span> <span class="fonte_not"><?php echo $row_noticias['data']; ?></span> </td>
                  </tr>
                  <tr>
                          ...
                          <tr>
                            <td width="54"><?php do { ?>
                                <table align="center" width="200" border="0" cellpadding="4" cellspacing="0" class="borda_tabela">
                                  <tr>
                                    <td width="41" align="center" valign="top" bgcolor="#EE9106"><a href="<?php echo tNG_showDynamicImage("", "uploads/fotos/", "{foto_not.arquivo}");?>" rel="lightbox" title="<?php echo $row_foto_not['descricao']; ?> &lt;br /&gt;
...
?>
                    <div align="justify" class="fonte_not"><?php echo $row_noticias['materia']; ?></div></td>
                  </tr>
                </table>                </td>
            </tr>
            <tr>
              <td height="17" align="left" valign="top" bgcolor="#EE9106"><span class="Titulo_Branco">Coment&aacute;rios</span></td>
            </tr>
            <tr>
              <td height="36" align="left" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                
                <tr>
                  <td align="left" valign="top"><p><span class="fonte_not">O inFORmeBB.com n&atilde;o publicar&aacute; coment&aacute;rios ofensivos, desrespeitosos  e que venham h&aacute; prejudicar ou insultar quem quer que seja! <br />
...
?>
                          <?php if ($totalRows_comentarios > 0) { // Show if recordset not empty ?>
                            <table width="100%" border="0" cellpadding="4" cellspacing="0">
                              <tr>
                                <td align="left" bgcolor="#EE9106" class="mais_festa"><strong><?php echo $row_comentarios['nome']; ?> - <?php echo $row_comentarios['mail']; ?> - <?php echo $row_comentarios['cidade']; ?></strong></td>
                              </tr>
                              <tr>
...
?>
                ...
                <tr>
                  <td align="center" valign="middle"><table width="126" height="22" border="0" cellpadding="0" cellspacing="2" bgcolor="#EE9106" class="borda_tabela">
                      <tr>
                        <td width="122" align="center" valign="middle" bgcolor="#EE9106"><a href="javascript:abrir_janela('comentar.php?id=<?php echo $row_noticias['id']; ?>','Saquabb','','420','400','true')" class="mais_festa">Comentar</a></td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
