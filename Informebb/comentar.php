...
<body>
<div align="center">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linha_laranja_4px">
    <tr>
        ...
        <?php do { ?>
          ...
          <table align="center" cellpadding="2" cellspacing="0" class="KT_tngtable">
            ...
            <tr>
              ...
              <td align="left" valign="top" class="fonte_colunas"><textarea name="comentario_<?php echo $cnt1; ?>" cols="40" rows="5" class="box" id="comentario_<?php echo $cnt1; ?>"><?php echo KT_escapeAttribute($row_rscomentarios_not['comentario']); ?></textarea>
