...
if ( isset( $_POST["submit"] ) ) 
{
	...
	$remetente = "contato@informebb.com";
	$cabecalho = "From: \"INFORMEBB\" <contato@informebb.com>\n";
	$cabecalho = "Reply-To: \"" . $_POST["Nome"] . "\" <".$_POST["Email"].">\n"; 
	$cabecalho .= "X-Mailer: INFORMEBB \n"; 
	$destinatario = $remetente;
	$assunto = "Mensagem do Contato do Site INFORMEBB";
      ...
      <embed src="destaque.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="540" height="240"></embed>
        ...
        <tr>
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="8">
            <tr>
              <td bgcolor="#FFFFFF" class="Titulo_Branco"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="linha_laranja_4px">
                <tr>
                  <th align="left" valign="middle" scope="col"><img src="imagens/recorte/titulos/fale.jpg" alt="Fale Conosco" width="300" height="40" border="0" /></th>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td>Para entrar em contato com o Site utilize o formul&aacute;rio abaixo, ou se preferir:<ul>
                <li>                E-mail: contato@informebb.com<br />
                <br />
              </li>
                <li>                  MSN: informebb@hotmail.com </li>
              </ul></td>
            </tr>
            <tr>
              <td><table width="98%" border="0" align="center" cellpadding="0" cellspacing="2" >
                <tr>
                  <td align="center"><table width="100%" border="0" cellpadding="6" cellspacing="2" bordercolor="#FFFFFF" class="fundo_tabela2">
                      <tr>
                        <th height="25" align="left" valign="top" class="fonte_titulo_not" scope="col">* preencha todos os campos corretamente. </th>
                      </tr>
                      <tr>
