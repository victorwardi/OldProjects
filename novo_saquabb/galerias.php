    ...
    <td height="120" colspan="2" align="center" valign="top"><a href="carnaporto/index.php"></a><img src="imagens/banner.jpg" width="775" height="120" /></td>
      ...
      <tr>
        ...
        <td width="627" align="left" valign="top"><!-- InstanceBeginEditable name="conteudo" -->
          <table width="617" border="0" cellpadding="0" cellspacing="8" bgcolor="#E6F9FD">
            <tr>
              <td><table width="100%" border="0" cellpadding="4" cellspacing="0">
                  <tr>
                    <td align="left" valign="middle" bgcolor="#017C9E" class="Titulo_Branco">Galerias de Fotos </td>
                  </tr>
              </table></td>
            </tr>
            <tr>
...
?>
                  <td><table width="100" height="92" border="0" cellpadding="0" cellspacing="2">
                      <tr>
                        <td height="69" align="center" class="tiutlo_not"><a href="galeria.php?galeria=<?php echo $row_galerias['nome']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("", "uploads/fotos/", "{galerias.imagem}", 120, 90, false); ?>" border="0" class="borda_gatinhas" /></a></td>
                      </tr>
                      <tr>
