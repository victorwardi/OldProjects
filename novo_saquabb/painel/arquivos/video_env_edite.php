  ...
  <tr>
    ...
    <td width="608" align="center" valign="top" bgcolor="#E6F9FD"><!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <th align="left" valign="middle" bgcolor="#017C9E" class="Titulo_Branco" scope="col">V&iacute;deos Enviados </th>
        </tr>
        <tr>
                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#017C9E" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_nome <?php echo $tso_listpromo_video1->getSortIcon('promo_video.nome'); ?>" id="nome"> <a href="<?php echo $tso_listpromo_video1->getSortLink('promo_video.nome'); ?>">Nome</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_email <?php echo $tso_listpromo_video1->getSortIcon('promo_video.email'); ?>" id="email"> <a href="<?php echo $tso_listpromo_video1->getSortLink('promo_video.email'); ?>">Email</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_link <?php echo $tso_listpromo_video1->getSortIcon('promo_video.link'); ?>" id="link"> <a href="<?php echo $tso_listpromo_video1->getSortLink('promo_video.link'); ?>">Link</a> </th>
