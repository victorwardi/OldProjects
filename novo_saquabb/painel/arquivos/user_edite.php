  ...
  <tr>
    ...
    <td width="608" align="center" valign="top" bgcolor="#E6F9FD"><!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <th align="left" valign="middle" bgcolor="#017C9E" class="Titulo_Branco" scope="col">Usu&aacute;rio</th>
        </tr>
        <tr>
                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#017C9E" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_nome <?php echo $tso_listuser2->getSortIcon('user.nome'); ?>" id="nome"> <a href="<?php echo $tso_listuser2->getSortLink('user.nome'); ?>">Nome</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_senha <?php echo $tso_listuser2->getSortIcon('user.senha'); ?>" id="senha"> <a href="<?php echo $tso_listuser2->getSortLink('user.senha'); ?>">Senha</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_level <?php echo $tso_listuser2->getSortIcon('user.level'); ?>" id="level"> <a href="<?php echo $tso_listuser2->getSortLink('user.level'); ?>">Level</a> </th>
