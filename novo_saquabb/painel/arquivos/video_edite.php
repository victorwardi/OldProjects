  ...
  <tr>
    ...
    <td width="608" align="center" valign="top" bgcolor="#E6F9FD"><!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <th align="left" valign="middle" bgcolor="#017C9E" class="Titulo_Branco" scope="col">Video</th>
        </tr>
        <tr>
                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#017C9E" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_capa <?php echo $tso_listvideos2->getSortIcon('videos.capa'); ?>" id="capa"> <a href="<?php echo $tso_listvideos2->getSortLink('videos.capa'); ?>">Capa</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_titulo <?php echo $tso_listvideos2->getSortIcon('videos.titulo'); ?>" id="titulo"> <a href="<?php echo $tso_listvideos2->getSortLink('videos.titulo'); ?>">Titulo</a> </th>
