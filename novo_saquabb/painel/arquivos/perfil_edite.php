                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#017C9E" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_foto <?php echo $tso_listperfil6->getSortIcon('perfil.foto'); ?>" id="foto"> <a href="<?php echo $tso_listperfil6->getSortLink('perfil.foto'); ?>">Foto</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_nome <?php echo $tso_listperfil6->getSortIcon('perfil.nome'); ?>" id="nome"> <a href="<?php echo $tso_listperfil6->getSortLink('perfil.nome'); ?>">Nome</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_aprovado <?php echo $tso_listperfil6->getSortIcon('perfil.aprovado'); ?>" id="aprovado"> <a href="<?php echo $tso_listperfil6->getSortLink('perfil.aprovado'); ?>">Aprovado</a> </th>
