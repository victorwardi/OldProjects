                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#017C9E" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_arquivo <?php echo $tso_listfotos2->getSortIcon('fotos.arquivo'); ?>" id="arquivo"> <a href="<?php echo $tso_listfotos2->getSortLink('fotos.arquivo'); ?>">Arquivo</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_descricao <?php echo $tso_listfotos2->getSortIcon('fotos.descricao'); ?>" id="descricao"> <a href="<?php echo $tso_listfotos2->getSortLink('fotos.descricao'); ?>">Descricao</a> </th>
