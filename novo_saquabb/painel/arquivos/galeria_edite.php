                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#017C9E" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_nome <?php echo $tso_listgaleria1->getSortIcon('galeria.nome'); ?>" id="nome"> <a href="<?php echo $tso_listgaleria1->getSortLink('galeria.nome'); ?>">Nome</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_imagem <?php echo $tso_listgaleria1->getSortIcon('galeria.imagem'); ?>" id="imagem"> <a href="<?php echo $tso_listgaleria1->getSortLink('galeria.imagem'); ?>">Imagem</a> </th>
