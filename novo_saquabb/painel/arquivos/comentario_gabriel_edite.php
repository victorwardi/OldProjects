  ...
  <tr>
    ...
    <td width="608" align="center" valign="top" bgcolor="#E6F9FD"><!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <th align="left" valign="middle" bgcolor="#017C9E" class="Titulo_Branco" scope="col">Coment&aacute;rio Gabriel </th>
        </tr>
        <tr>
                  ...
                  <table border="1" cellpadding="2" cellspacing="0" bordercolor="#017C9E" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_nome <?php echo $tso_listcomentarios_gf2->getSortIcon('comentarios_gf.nome'); ?>" id="nome"> <a href="<?php echo $tso_listcomentarios_gf2->getSortLink('comentarios_gf.nome'); ?>">Nome</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_id <?php echo $tso_listcomentarios_gf2->getSortIcon('comentarios_gf.id'); ?>" id="id"> <a href="<?php echo $tso_listcomentarios_gf2->getSortLink('comentarios_gf.id'); ?>">Id</a> </th>
                        <th align="center" bgcolor="#017C9E" class="KT_sorter KT_col_aprovado <?php echo $tso_listcomentarios_gf2->getSortIcon('comentarios_gf.aprovado'); ?>" id="aprovado"> <a href="<?php echo $tso_listcomentarios_gf2->getSortLink('comentarios_gf.aprovado'); ?>">Aprovado</a> </th>
