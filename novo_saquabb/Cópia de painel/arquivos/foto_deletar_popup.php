...
$query_deletar = sprintf("SELECT * FROM fotos WHERE id_foto = %s ORDER BY id ASC", $colname_deletar);
...
$del_fotos = new tNG_delete($conn_saquabb);
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td width="306" align="center" valign="middle" bgcolor="#FFCC00" class="fonte">Tem certeza que deseja deletar esta foto? </td>
  </tr>
  <tr>
    <td height="123" align="center" valign="bottom" bgcolor="#FFFFCC"><table width="20" border="1" cellpadding="0" cellspacing="2" bordercolor="#000000" bgcolor="#FFFFFF">
      <tr>
  ...
  <tr>
    <td height="20" align="center" valign="middle" bgcolor="#FFFFCC"><form id="form1" name="form1" method="post" action="">
