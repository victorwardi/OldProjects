...
$query_exibir = sprintf("SELECT * FROM trabalhos WHERE id = %s ORDER BY id DESC", $colname_exibir);
...
<body><table width="700" border="0" align="center" cellpadding="0" cellspacing="4" bgcolor="#FFFFFF">
  <tr>
    <th align="center" valign="top" scope="col"><table border="0" cellpadding="0" cellspacing="0" width="733">
      ...
      <tr>
        <td colspan="4"><img src="../Copy of victor/images/conteudo/conteudo_r3_c1.jpg" alt="" name="conteudo_r3_c1" width="733" height="48" border="0" usemap="#conteudo_r3_c1Map2" id="conteudo_r3_c1" /></td>
      ...
      <tr>
        ...
        <td><img name="conteudo_r7_c2" src="../Copy of victor/imagens/titulos/cartazes.jpg" width="207" height="44" border="0" id="conteudo_r7_c2" alt="" /></td>
      ...
      <tr>
        <td colspan="2" rowspan="5" align="right" valign="top"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="4">
            <tr>
              <th height="27" align="left" valign="middle" scope="col">&nbsp;<span class="titulo_exibir"><?php echo $row_exibir['titulo']; ?></span></th>
              </tr>
            <tr>
              <th height="14" align="left" valign="top" class="desc" scope="col"><?php echo $row_exibir['descricao']; ?></th>
              </tr>
            <tr>
              <th align="center" scope="col">&nbsp;<img src="<?php echo tNG_showDynamicImage("../", "../victor/imagens/capas/", "{exibir.imagem}");?>" class="borda_img" /></th>
              </tr>
          </table>
          <table width="162" height="26" border="0" align="center" cellpadding="0" cellspacing="0" class="borda_img">
            <tr>
              <th height="24" align="center" bgcolor="#FFD800" scope="col"><a href="../Copy of victor/cartazes.php"><strong>+ Cartazes e Flyers </strong></a></th>
            </tr>
          </table>          <p class="categoria"><a href="../Copy of victor/webdesign.php"></a></p></td>
...
<map name="conteudo_r3_c1Map" id="conteudo_r3_c1Map">
  ...
  <area shape="poly" coords="106,44,62,50,93,34,157,22,144,47" href="../Copy of victor/cartazes.php" alt="Cartazes e Flyers" />
</map>
...
<map name="conteudo_r3_c1Map2" id="conteudo_r3_c1Map2">
<area shape="poly" coords="93,32,203,7,207,26,98,45" href="#" />
</map></body>
</html>
<?php
