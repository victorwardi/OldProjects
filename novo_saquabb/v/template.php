<?php setlocale(LC_TIME, 'pt_BR', 'portuguese', 'bra', 'brazil');?>
...
<script type="text/javascript" src="../js/functionAddEvent.js"></script>
	...
	label { display:block; }
	input.text,textarea { width:300px;font:12px/12px 'courier new',courier,monospace;color:#333;padding:3px;margin:1px 0;border:1px solid #000; }
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="4" bgcolor="#FFFFFF">
  <tr>
    <th align="center" valign="top" scope="col"><table border="0" cellpadding="0" cellspacing="0" width="733">
      ...
      <tr>
        <td colspan="4"><img name="conteudo_r1_c1" src="../Copy of victor/images/conteudo/conteudo_r1_c1.jpg" width="733" height="47" border="0" id="conteudo_r1_c1" alt="" /></td>
      ...
      <tr>
        ...
        <td><img name="conteudo_r7_c2" src="../Copy of victor/imagens/titulos/contato.jpg" width="207" height="44" border="0" id="conteudo_r7_c2" alt="" /></td>
      ...
      <tr>
        <td colspan="2" rowspan="5" align="left" valign="top" class="categoria"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="4">
            <tr>
              <th height="14" align="left" valign="top" scope="col"><p><span class="categoria">email/MSN: </span><span class="titulo">victor@saquabb.com.br</span><span class="categoria"><br />
                <br />
                </span></p>
                </th>
              </tr>
            <tr>
              <th height="49" align="left" valign="top" class="titulo" scope="col"><p><span class="categoria">Telefone: </span>22 9256-3090</p>
                <p class="titulo">se preferir  entre em contato  preenchendo o Fomul&aacute;rio Abaixo:</p></th>
              </tr>
            <tr>
              <th align="left" valign="top" scope="col"><p id="loadBar" style="display:none;">
		<strong>Aguarde enquanto a mensagem é enviada!</strong><br />

		<img src="../Copy of victor/imagens/loading.gif" alt="Loading" title="Sending Email" />
	</p>
	<p id="emailSuccess" style="display:none;">
		<strong style="color:green;">Success! Your Email has been sent.</strong>
	</p>
	<div id="contactFormArea">
		<form action="../Copy of victor/scripts/contact.php" method="post" id="cForm">
			<fieldset>
				<label for="posName" class="categoria">Nome:</label>
				...
				<label for="posRegard"></label>
				<label for="posText" class="categoria">Mensagem:</label>
				<textarea cols="50" rows="3" name="posText" id="posText"></textarea>
				<label for="selfCC">
					<input type="checkbox" name="selfCC" id="selfCC" value="send" /> 
					<span class="categoria">Enviar um cópia para  você mesmo. </span><br />
				</label>
				<label>
...
<map name="conteudo_r3_c1Map" id="conteudo_r3_c1Map">
  ...
  <area shape="poly" coords="106,44,66,44,66,37,197,15,199,25" href="../Copy of victor/cartazes.php" alt="Cartazes e Flyers" />
</map>
<map name="conteudo_r4_c1Map" id="conteudo_r4_c1Map">
  <area shape="poly" coords="85,50,208,27,217,40,93,61" href="../Copy of victor/servicos.php" alt="Servi&ccedil;os Digitais" />
</map>
<map name="conteudo_r6_c1Map" id="conteudo_r6_c1Map">
  <area shape="poly" coords="68,32,148,22,150,34,81,41" href="../Copy of victor/fotografia.php" alt="Fotografia" />
</map>
