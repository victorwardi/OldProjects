...
$query_artigos = "SELECT * FROM ovni ORDER BY id DESC";
      ...
      <tr>
        ...
        <td width="627" align="left" valign="top"><!-- InstanceBeginEditable name="conteudo" -->
          <table width="100%" border="0" cellpadding="4" cellspacing="8" bgcolor="#E6F9FD">
            <tr>
              <th bgcolor="#017C9E" class="Titulo_Branco" scope="col">Administrativo da Coluna - OVNI </th>
            </tr>
            <tr>
              <th align="left" valign="top" scope="row"><p class="fonte_titulo_not">Walter, Seja bem vindo! </p>
