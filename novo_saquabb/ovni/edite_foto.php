...
$query_rsfotos1 = sprintf("SELECT fotos.id_foto, fotos.arquivo, fotos.descricao FROM fotos WHERE galeria = 'ovni'  ORDER BY %s", $NXTFilter_rsfotos1, $NXTSort_rsfotos1);
