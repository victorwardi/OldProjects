...
if (isset($_GET['galeria'])) {
  $colname_fotogr = (get_magic_quotes_gpc()) ? $_GET['galeria'] : addslashes($_GET['galeria']);
}
mysql_select_db($database_saquabb, $saquabb);
$query_fotogr = sprintf("SELECT * FROM fotos WHERE galeria = '%s' ORDER BY id_foto DESC", $colname_fotogr);
...
<div align="center" id="meio2"><img src="<?php echo tNG_showDynamicImage("../", "../uploads/fotos/", "{fotogr.arquivo}");?>" class="borda_foto" /><br />
  ...
  Fot&oacute;grafo: <?php echo $row_fotogr['fotografo']; ?>
</div>
</body>
</html>
<?php
