...
<head>
	...
	<script type="text/javascript" src="contato/js/functionAddEvent.js"></script>
	<script type="text/javascript" src="contato/js/contact.js"></script>
	<script type="text/javascript" src="contato/js/xmlHttp.js"></script>
...
<body>
	...
	<p id="loadBar" style="display:none;">
		...
		<img src="contato/img/loading.gif" alt="Loading" title="Sending Email" />
	</p>
	<p id="emailSuccess" style="display:none;">
		<strong style="color:green;">Success! Your Email has been sent.</strong>
	</p>
	<div id="contactFormArea">
		<form action="contato/scripts/contact.php" method="post" id="cForm">
			<fieldset>
