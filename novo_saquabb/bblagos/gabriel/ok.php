      ...
      <tr>
        ...
        <td width="627" align="left" valign="top"><!-- InstanceBeginEditable name="conteudo" -->
          <table width="100%" border="0" cellpadding="4" cellspacing="8" bgcolor="#E6F9FD">
            <tr>
              <th scope="col"><div align="left"><span class="perfil_nome">Transa&ccedil;&atilde;o feita com sucesso!</span><br />
                <br />
                Escolha outra op&ccedil;&atilde;o! <br />
                <br />                
                <ul class="fonte_titulo_not">
                  <li><a href="add.php" class="fonte_titulo_not">Inserir </a><br />
                    <br />
                  </li>
                  <li><a href="edit.php" class="fonte_titulo_not">Deletar </a><br />
                    <br />
                  </li>
                  <li><a href="edit.php" class="fonte_titulo_not">Atualizar</a><br />
                    <br />
                  </li>
                  <li><a href="add_foto.php" class="fonte_titulo_not">Adicionar Foto</a><br />
                    <br />
                  </li>
                  <li><a href="edite_foto.php" class="fonte_titulo_not">Excluir Foto </a><br />
                    <br /> 
                    <br />
                    <br />
                  </li>
                  <li><a href="gabriel.php" class="fonte_titulo_not">Sair</a></li>
                </ul>
              </div>
                <ul>
                </ul></th>
