...
$query_coluna = "SELECT * FROM gabriel ORDER BY id DESC";
...
mysql_select_db($database_saquabb, $saquabb);
$query_fotos = "SELECT * FROM fotos WHERE galeria = 'gabriel' ORDER BY id_foto DESC";
          ...
          <table width="100%" border="0" cellpadding="4" cellspacing="8" bgcolor="#E6F9FD">
            <tr>
              <th bgcolor="#FFFFFF" scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <th align="center" valign="top" scope="col"><img src="../imagens/coluna_gabriel.jpg" alt="gabriel _ Qu&eacute; se eu?" width="602" height="200" /></th>
                </tr>
              </table></th>
            </tr>
