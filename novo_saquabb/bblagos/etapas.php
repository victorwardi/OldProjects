                  ...
                  <td><table width="568" border="0" cellpadding="0" cellspacing="0" class="borda_tabela">
                      ...
                      <tr>
                        <td align="left" valign="top"><table width="100%" border="0" cellpadding="0" class="bb_lagos_fundo_esquerdo">
                            <tr>
                              <td align="center" valign="top"><table width="83%" border="0" cellspacing="2" cellpadding="0">
                                    <tr>
                                      <td height="25" align="left" valign="middle"><img src="imagens/etapas.jpg" alt="Etapas 2006" width="200" height="40" /></td>
                                    </tr>
                                    <tr>
                                      <td height="25" align="left" valign="middle" class="tiutlo_not">1&ordf; - Barra de S&atilde;o Jo&atilde;o </td>
                                    </tr>
                                    <tr>
                                      <td height="25" align="left" valign="middle" class="tiutlo_not">2&ordf; - Arraial do Cabo </td>
                                    </tr>
                                    <tr>
                                      <td height="25" align="left" valign="middle" class="tiutlo_not">3&ordf; - Praia Seca </td>
                                    </tr>
                                    <tr>
                                      <td height="25" align="left" valign="middle" class="tiutlo_not">4 &ordf; - Cabo Frio </td>
                                    </tr>
                                    <tr>
                                      <td height="25" align="left" valign="middle" class="tiutlo_not">5&ordf; - Saquarema </td>
                                    </tr>
                                  </table>
                                  <p>&nbsp;</p>
                                <p>&nbsp;</p>
