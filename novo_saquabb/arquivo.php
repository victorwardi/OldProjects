              ...
              <td><table width="617" border="0" cellpadding="0" cellspacing="8" bgcolor="#E6F9FD">
                <tr>
                  <td><table width="100%" border="0" cellpadding="4" cellspacing="0">
                    <tr>
                      <td align="left" valign="middle" bgcolor="#017C9E" class="Titulo_Branco">Arquivo de Not&iacute;cias </td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
                    ...
                    <tr>
                      <th height="25" align="center" valign="top" scope="col"><?php do { ?>
                          <table width="98%" border="0" cellpadding="4" cellspacing="0" class="borda_pontilhada_noticias">
                            <tr>
                              <th width="15%" height="41" align="center" valign="middle" scope="col"><a href="noticia/<?php echo $row_arquivo['id']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("", "uploads/fotos/", "{arquivo.imagem}", 80, 50, false); ?>" width="80" height="50" hspace="5" border="0" align="center" /></a></th>
                              <th width="85%" align="left" valign="middle" class="fonte_not" scope="col"><span class="fonte_titulo_not"><?php echo $row_arquivo['coluna']; ?> - <?php echo $row_arquivo['data']; ?></span><a href="noticia/<?php echo $row_arquivo['id']; ?>" class="fonte_not"><br />
