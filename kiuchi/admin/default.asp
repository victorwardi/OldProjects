...
If MM_valUsername <> "" Then
  ...
  MM_rsUser.ActiveConnection = MM_conex2_STRING
...
<img src="../images/spacer.gif" width="1" height="5"><table width="464" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000099">
  <tr>
    <td width="791" height="182" bgcolor="#66CCCC"><form action="<%=MM_LoginAction%>" method="POST" name="login" id="login">
      <table width="400" height="300" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center" valign="middle"><span class="menulk">Administrativo Kiuchi
          </span>            <table width="263" border="0" align="center" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
