  ...
  <form ACTION="<%=MM_editAction%>" METHOD="POST" name="Formulario" id="Formulario">
        ...
        <table  border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#999999" class="tdnot">
          <tr align="center" bgcolor="#FF9900">
            <td width="406" height="20" bgcolor="#66CCFF" class="destaquepreto"><p align="center" class="style1">EVENTO - Modificar/Remover</p></td>
          </tr>
          <tr align="center">
            <td height="20" class="destaquepreto">
              <div align="center"><br>
              </div>
              <table width="340" border="0" align="center" cellpadding="0" cellspacing="0" class="tdnot">
                <% 
...
%>
                <tr>
                  ...
                  <td width="271" align="left" valign="middle"><div align="left"><a href="modificar_festa2.asp?Cod=<%=(RsAlbuns.Fields.Item("Cod").Value)%>"><%=(RsAlbuns.Fields.Item("nome").Value)%></a></div></td>
                </tr>
                <% 
