...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "terreno"
  MM_editColumn = "CodNoticia"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "listar_terreno.asp"
...
RsAltera.ActiveConnection = MM_conex2_STRING
RsAltera.Source = "SELECT * FROM terreno ORDER BY data ASC"
...
%>
      <tr>
        <td width="36" height="18" align="center" valign="middle"><input name="MM_recordId" type="radio" value="<%=(RsAltera.Fields.Item("CodNoticia").Value)%>"></td>
          <td width="703"><a href="alt_terreno.asp?CodNot=<%=(RsAltera.Fields.Item("CodNoticia").Value)%>" class="nometur"> <%=(RsAltera.Fields.Item("data").Value)%> - <%=(RsAltera.Fields.Item("resumo").Value)%></a></td>
      </tr>
      <% 
