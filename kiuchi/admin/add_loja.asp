...
destino= pasta & "fotos\loja\" & nomecompletoimg
...
<table width="463" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999">
  <tr>
    <td width="459" height="25" align="center" bgcolor="#66CC99"><div align="center"><span class="tur"><span class="style2">:: Adicionar Loja :: </span></span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
      <form action="add_loja.asp" method="post" enctype="multipart/form-data" target="_self" id=form>
        <div align="center">
          <center>
...
(</font></span><font face="Verdana" size="2">Lj</font><span class="desc"><font face="Verdana" size="2">-xxx) </font></span></div></td>
                <td><span class="desc">
...
%>
              ...
              <tr>
                ...
                <td><table width="215" border="0" cellpadding="0" cellspacing="0" class="tbl">
                    ...
                    <tr>
                      <td height="36" colspan="2" valign="top"><img src="../fotos/loja/<%=Session("nomedb")%>" alt="" border="0"></td>
                      <td width="144">&nbsp;</td>
