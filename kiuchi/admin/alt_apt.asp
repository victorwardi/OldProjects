...
Rscasa.Source = "SELECT * FROM apt WHERE codnoticia = " + Replace(Rscasa__MMColParam, "'", "''") + " ORDER BY codnoticia DESC"
Rscasa.CursorType = 0
...
<table width="463" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  ...
  <tr>
    ...
    (</font></span><font size="2" face="Verdana">Apt<span class="desc">-xxx)</span></font></td>
                  <td><span class="desc">
