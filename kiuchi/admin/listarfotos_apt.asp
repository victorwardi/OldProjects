...
RsFotos.Source = "SELECT *  FROM apt_foto  ORDER BY CodNoticia DESC"
...
%>
      <tr>
        <td width="85" height="18" align="center" valign="middle">
          ...
          <td width="89"><img src="../fotos/apt/<%=(RsFotos.Fields.Item("arquivo").Value)%>" alt="" width="79" height="59" vspace="5" border="0"></td>
          <td width="457"><a href="altfoto_apt.asp?CodFoto=<%=(RsFotos.Fields.Item("CodFoto").Value)%>" class="nometur"> &nbsp;<%=(RsFotos.Fields.Item("descricao").Value)%></a></td>
      </tr>
      <% 
