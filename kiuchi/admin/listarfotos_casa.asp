...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "casa_foto"
  MM_editColumn = "CodFoto"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "listarfotos_casa.asp"
...
RsFotos.Source = "SELECT *  FROM casa_foto  ORDER BY CodNoticia DESC"
...
<table width="464" border="0" align="left" cellpadding="0" cellspacing="0" bordercolor="#000099">
  <tr>
    <td width="772" height="25"><div align="left"><span class="tur style1">:: Alterar Fotos </span></div></td>
  </tr>
  <tr>
    <td align="center">
...
%>
      <tr>
        <td width="85" height="18" align="center" valign="middle">
          ...
          <td width="89"><img src="../fotos/casa/<%=(RsFotos.Fields.Item("arquivo").Value)%>" alt="" width="79" height="59" vspace="5" border="0"></td>
          <td width="457"><a href="altfoto_casa.asp?CodFoto=<%=(RsFotos.Fields.Item("CodFoto").Value)%>" class="nometur"> &nbsp;<%=(RsFotos.Fields.Item("descricao").Value)%></a></td>
      </tr>
      <% 
