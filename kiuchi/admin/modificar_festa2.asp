...
%>
<%
Dim RsAlbuns__MMColParam
RsAlbuns__MMColParam = "1"
If (Request.QueryString("cod") <> "") Then 
  RsAlbuns__MMColParam = Request.QueryString("cod")
End If
%>
<%
Dim RsAlbuns
...
RsAlbuns.ActiveConnection = MM_conex2_STRING
RsAlbuns.Source = "SELECT * FROM Albuns WHERE cod = " + Replace(RsAlbuns__MMColParam, "'", "''") + " ORDER BY cod DESC"
...
<body>
 <form ACTION="<%=MM_editAction%>" METHOD="POST" name="Formulario" id="Formulario">
        <br>
        <table  border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#999999" class="tdnot">
          <tr align="center" bgcolor="#66CCFF">
            <td width="406" height="20" colspan="2" class="destaquepreto"><div align="center"><span class="style1"> :: Modificar EVENTO :: </span></div></td>
          </tr>
          <tr>
            <td>Foto de Capa: </td>
            <td><img src="/itaguaionline/eventos/fotos/<%=(RsAlbuns.Fields.Item("thumb").Value)%>"></td>
          </tr>
          <tr>
            <td><span class="style4">None e Local do Evento:</span></td>
