...
RsFoto.Source = "SELECT *  FROM terreno_foto  WHERE CodFoto = " + Replace(RsFoto__MMColParam, "'", "''") + ""
RsFoto.CursorType = 0
...
RsNoticias.Source = "SELECT CodNoticia, data  FROM terreno ORDER BY CodNoticia DESC"
          ...
          <div align="center">
            <center>
              <table width="459" border="0" cellpadding="5" cellspacing="0" bordercolor="#FFFFFF">
                <tr>
                  <td valign="top">&nbsp;</td>
                  <td><img src="../fotos/terreno/<%=(RsFoto.Fields.Item("arquivo").Value)%>" alt=""></td>
                </tr>
                <tr>
