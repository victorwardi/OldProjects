...
If (Upload.Form("Upload")<>"") Then
	...
	File.SaveAs pasta & "fotos\spc\original\" & File.OriginalFileName

nomefoto= Session("count") & ".jpg"
caminho = pasta&"fotos\spc\"
destino= caminho & "spc_" & nomefoto
...
Rs_foto.ActiveConnection = MM_conex2_STRING
Rs_foto.Source = "SELECT * FROM spc ORDER BY codnoticia DESC"
...
<table width="464" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="795" height="24" bgcolor="#66CC99"><div align="center" class="menulk">::Adicionar Foto - Oferta:: </div></td>
  </tr>
  <tr>
    <td><FORM ACTION="adfoto_spc.asp" METHOD="POST" enctype="multipart/form-data" target="_self">
      <br>
...
%>
              <option value="<%=(Rs_foto.Fields.Item("CodNoticia").Value)%>" selected><%=(Rs_foto.Fields.Item("resumo").Value)%></option>
              <% 
...
%>
		...
		<tr>
          ...
          <td><table width="403" border="0" cellpadding="0" cellspacing="0" class="tbl">
              ...
              <tr>
                <td height="36" valign="top"><img src="/fotos/spc/<% =Session("nomefoto")%>" alt="" width="100" height="75" border="0"></td>
                </tr>
