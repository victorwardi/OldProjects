...
destino= pasta & "fotos\sitio\" & nomecompletoimg

	File.SaveAs pasta & "fotos\sitio\original\" & File.OriginalFileName
...
<table width="463" border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#999999">
  <tr>
    <td width="459" height="25" align="center" bgcolor="#66CC99"><div align="center"><span class="tur"><span class="style2">:: Adicionar S&iacute;tio e Fazenda:: </span></span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
      <form action="add_sitio.asp" method="post" enctype="multipart/form-data" target="_self" id=form>
        <div align="center">
          <center>
...
(</font></span><font face="Verdana" size="2">SF<span class="desc">-xxx)</span></font></div></td>
                <td><span class="desc">
                  <input name="data" type="text" id="data5" value="<%=data%>" size="13">
                </span></td>
              </tr>
              <tr>
                <td width="81" valign="top"><div align="center">Categoria:                    <span class="mar">Venda/Aluguel</span></div></td>
                <td width="358"><input name="titulo" type="text" id="titulo5" value="<%=titulo%>" size="50">                </td>
              </tr>
              <tr>
...
%>
              ...
              <tr>
                ...
                <td><table width="215" border="0" cellpadding="0" cellspacing="0" class="tbl">
                    ...
                    <tr>
                      <td height="36" colspan="2" valign="top"><img src="../fotos/sitio/<%=Session("nomedb")%>" alt="" border="0"></td>
