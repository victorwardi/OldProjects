...
Rscasa.Source = "SELECT * FROM sala WHERE codnoticia = " + Replace(Rscasa__MMColParam, "'", "''") + " ORDER BY codnoticia DESC"
Rscasa.CursorType = 0
...
<table width="463" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="459" height="25" bgcolor="#66CCCC"><div align="center"><span class="tur style1">:: Alterar Sala :: </span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
    ...
    (</font></span><font size="2" face="Verdana">SL<span class="desc">-xxx)</span></font></td>
                  <td><span class="desc">
