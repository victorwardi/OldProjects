...
caminho = pasta&"fotos\sala\"
destino= caminho & "sala_" & nomefoto
...
Rs_foto.Source = "SELECT * FROM sala ORDER BY codnoticia DESC"
...
<table width="464" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="795" height="24" bgcolor="#66CC99"><div align="center" class="style23">
      <div align="center">:: Adicionar Foto - Sala:: </div>
    </div></td>
  </tr>
  <tr>
    <td><FORM ACTION="adfoto_sala.asp" METHOD="POST" enctype="multipart/form-data" target="_self">
      <br>
...
%>
		...
		<tr>
          ...
          <td><table width="403" border="0" cellpadding="0" cellspacing="0" class="tbl">
              ...
              <tr>
                <td height="36" valign="top"><img src="/fotos/sala/<% =Session("nomefoto")%>" alt="" width="100" height="75" border="0"></td>
                </tr>
