...
Rscasa.Source = "SELECT * FROM casa WHERE codnoticia = " + Replace(Rscasa__MMColParam, "'", "''") + " ORDER BY codnoticia DESC"
Rscasa.CursorType = 0
...
<table width="463" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="459" height="25" bgcolor="#66CCCC"><div align="center"><span class="tur style1">:: Alterar Casa :: </span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
    ...
    (</font></span><font face="Verdana" size="2">c</font><span class="desc"><font face="Verdana" size="2">-xxx)</font></span></td>
                  <td><span class="desc">
