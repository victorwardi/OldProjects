...
imovel.Source = "SELECT * FROM sala ORDER BY codnoticia DESC"
imovel.CursorType = 0
              ...
              <th height="694" colspan="2" align="center" valign="top" scope="col"><table width="716" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <th width="526" align="left" valign="top" scope="col"><table width="518" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                        <tr>
                          <th width="537" height="103" valign="top" bgcolor="#FFFFFF" scope="col"><!-- InstanceBeginEditable name="banner" --><img src="imagens/banner_sala.jpg" width="518" height="100"><!-- InstanceEndEditable --></th>
                        </tr>
                      </table>
...
%>
                                  <td width="152"><table width="152" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                        <th width="152" height="87" align="center" valign="top" scope="col"><div align="center"><span class="style2"><img src="fotos/sala/<%=(imovel.Fields.Item("foto").Value)%>" width="100" height="75" border="1" align="middle" class="brdnoticia" bordercolor="#000000"></span></div></th>
                                      </tr>
                                      <tr>
                                        <td height="44"><table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                              <td class="style15"><div align="center"><a href="javascript:MM_openBrWindow('ver_sala.asp?CodNot=<%=(imovel.Fields.Item("CodNoticia").Value)%>','kiuchiimobiliaria','scrollbars=1','518','500','true')" class="style15">Mais detalhes e fotos</a> </div></td>
                                            </tr>
                                                                                      </table></td>
                                      </tr>
                                                                    </table></td>
