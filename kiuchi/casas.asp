              ...
              <th height="694" colspan="2" align="center" valign="top" scope="col"><table width="716" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <th width="526" align="left" valign="top" scope="col"><table width="518" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                        <tr>
                          <th width="537" height="103" valign="top" bgcolor="#FFFFFF" scope="col"><img src="imagens/banner_casas.jpg" width="518" height="100"></th>
                        </tr>
                      </table>
                                  ...
                                  <td width="152"><table width="152" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td height="44"><table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                              <td align="center" valign="top"><div align="left" class="style17">
                                            ...
                                            <tr>
                                              <td align="center" valign="top" class="style15"><div align="center"><a href="javascript:MM_openBrWindow('ver_casa.asp?CodNot=<%=(imovel.Fields.Item("CodNoticia").Value)%>','kiuchiimobiliaria','scrollbars=1','518','500','true')" class="style15">Mais detalhes e fotos</a> </div></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                                              </table></td>
