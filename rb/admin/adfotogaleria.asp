...
'quando for publicar na internet deixe o caminho assim: pasta = "C:\inetpub\wwwroot\rb\" '
...
rs.open "fotos_galerias", conn, 2, 2
rs.addnew
...
<table width="464" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="795" height="25" bgcolor="#66CC99"><div align="center"><span class="tur"><span class="style1">:: Adicionar Foto no Evento:: </span></span></div></td>
  </tr>
  <tr>
...
%>
                ...
                <tr>
                  ...
                  <td><table width="403" border="0" cellpadding="0" cellspacing="0" class="tbl">
                      ...
                      <tr>
                        <td height="36" colspan="2" valign="top"><img src="../fotos/galeria/192x144_<% =Session("nomefoto")%>" alt="" border="0"></td>
                        <td width="144">&nbsp;</td>
