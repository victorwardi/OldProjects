...
<table width="463" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999">
  <tr>
    <td width="459" height="25" align="center" bgcolor="#66CC99"><div align="center"><span class="tur"><span class="style2">:: Adicionar Noticia:: </span></span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
      <form action="add_noticia.asp" method="post" enctype="multipart/form-data" target="_self" id=form>
        <div align="center">
          <center>
            <table width="459" border="0" cellpadding="5" cellspacing="0" class="tbl">
              ...
              <tr>
                <td width="58" valign="top"><div align="center">Categoria:                  <span class="style3">Esporte, novidades,cinema...</span></div></td>
...
%>
              ...
              <tr>
                ...
                <td><table width="215" border="0" cellpadding="0" cellspacing="0" class="tbl">
                    ...
                    <tr>
                      <td height="36" colspan="2" valign="top"><img src="../fotos/noticia/<%=Session("nomedb")%>" alt="" border="0"></td>
                      <td width="144">&nbsp;</td>
