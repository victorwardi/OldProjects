...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "listar_agenda.asp"
...
RsAltera.Source = "SELECT * FROM agenda ORDER BY data ASC"
...
%>
      <tr>
        <td width="36" height="18" align="center" valign="middle"><input name="MM_recordId" type="radio" value="<%=(RsAltera.Fields.Item("CodNoticia").Value)%>"></td>
          <td width="703"><a href="alt_agenda.asp?CodNot=<%=(RsAltera.Fields.Item("CodNoticia").Value)%>" class="nometur"> <%=(RsAltera.Fields.Item("data").Value)%> - <%=(RsAltera.Fields.Item("resumo").Value)%></a></td>
      </tr>
      <% 
