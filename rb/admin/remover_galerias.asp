...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "listar_galerias.asp"
...
RsAltera.Source = "SELECT * FROM Galerias ORDER BY Cod ASC"
      ...
      <tr>
        <td width="36" height="45" align="center" valign="middle"><input name="MM_recordId" type="radio" value="<%=(RsAltera.Fields.Item("Cod").Value)%>"></td>
          <td width="703" align="left" valign="middle">             <table width="371" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th width="110" align="center" valign="middle" scope="col"><img src="../fotos/galeria/<%=(RsAltera.Fields.Item("Foto").Value)%>" alt="" border="1" class="brdnoticia"></th>
                <th width="261" align="left" valign="middle" class="menulk tbl tbl" scope="col"><%=(RsAltera.Fields.Item("titulo").Value)%></th>
              </tr>
            </table>
            <p>&nbsp;</p></td>
      </tr>
