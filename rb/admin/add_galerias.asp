...
<table width="464" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="899" height="25" bgcolor="#66CC99"><div align="center"><span class="tur"><span class="style1">:: Adicionar Galeria :: </span></span></div></td>
  </tr>
  <tr>
    <td><form action="add_galerias.asp" method="post" enctype="multipart/form-data" target="_self" id=form>
        <div align="center">
          <center>
            <table width="459" border="0" align="center" cellpadding="5" cellspacing="0" class="tbl">
              <tr>
                <td valign="top">T&iacute;tulo:</td>
                <td><input name="titulo" type="text" id="titulo5" value="<%=titulo%>" size="50"></td>
              </tr>
              <tr>
