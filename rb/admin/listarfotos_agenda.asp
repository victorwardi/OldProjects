...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "foto_agenda"
  MM_editColumn = "CodFoto"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "listarfotos_agenda.asp"
...
RsFotos.Source = "SELECT * FROM foto_agenda ORDER BY CodFoto DESC"
...
<table width="638" height="239" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="638" height="25" align="center" bordercolor="#E0DFE3" bgcolor="#66CC99"><div align="center"><span class="tur style1">:: Remover Fotos da Agenda ::            <span class="style7"> </span><br>
    </span></div></td>
  </tr>
  <tr>
    <td align="center">
...
%>
      <tr>
        <td width="85" height="18" align="center" valign="middle">
          ...
          <td width="89"><img src="../fotos/agenda/th_<%=(RsFotos.Fields.Item("arquivo").Value)%>" alt="" width="79" height="59" vspace="5" border="0"></td>
          <td width="457"><a href="altfoto_agenda.asp?CodFoto=<%=(RsFotos.Fields.Item("CodFoto").Value)%>" class="nometur"> &nbsp;</a><%=(RsFotos.Fields.Item("descricao").Value)%></td>
      </tr>
      <% 
