...
If (Upload.Form("Upload")<>"") Then
	...
	File.SaveAs pasta & "fotos\fotos\original\" & File.OriginalFileName

nomefoto= Session("count") & ".jpg"
caminho = pasta&"fotos\fotos\"
...
Rs_foto.Source = "SELECT * FROM noticia ORDER BY codnoticia DESC"
...
<table width="513" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="509" height="24" bgcolor="#66CC99"><div align="center"><span class="brdnoticia tbl tbl style24">:: Adicionar Foto &Agrave; Not&iacute;cia ::</span></div></td>
  </tr>
  <tr>
    <td><FORM ACTION="adfoto_noticia.asp" METHOD="POST" enctype="multipart/form-data" target="_self">
      <br>
        ...
        <tr>
          ...
          <td height="46" colspan="3">
            <select name="CodNoticia" id="select3">
              <option selected>Escolha uma noticia</option>
              <% 
While ((Repeat1__numRows <> 0) AND (NOT Rs_foto.EOF)) 
%>
              <option value="<%=(Rs_foto.Fields.Item("CodNoticia").Value)%>"><%=(Rs_foto.Fields.Item("titulo").Value)%> - <%=(Rs_foto.Fields.Item("data").Value)%></option>
              <% 
...
%>
		...
		<tr>
          ...
          <td><table width="403" border="0" cellpadding="0" cellspacing="0" class="tbl">
              ...
              <tr>
                <td height="36" valign="top"><img src="../fotos/fotos/foto_<% =Session("nomefoto")%>" alt="" width="100" height="75" border="0"></td>
                </tr>
