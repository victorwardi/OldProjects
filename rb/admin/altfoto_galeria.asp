...
RsGalerias.ActiveConnection = MM_con_kiuchi_STRING
...
RsNoticias.ActiveConnection = MM_con_kiuchi_STRING
RsNoticias.Source = "SELECT CodNoticia, titulo FROM noticia ORDER BY CodNoticia DESC"
...
<table width="461" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="772" height="25" bgcolor="#66CC99"><div align="center"><span class="tur">Alterar Foto Galeria </span></div></td>
  </tr>
  <tr>
    <td><form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1" target="_self" id=form><div align="center"><center>
        <table width="459" border="0" cellpadding="5" cellspacing="0" bordercolor="#FFFFFF" class="tbl">
                <tr>
                  <td valign="top">&nbsp;</td>
                  <td><img src="../fotos/galeria/192x144_<%=(RsFoto.Fields.Item("arquivo").Value)%>" alt=""></td>
                </tr>
                <tr>
