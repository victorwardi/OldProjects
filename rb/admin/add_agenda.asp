...
destino= pasta & "fotos\agenda\" & nomecompletoimg

	File.SaveAs pasta & "fotos\agenda\original\" & File.OriginalFileName
...
<table width="463" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999">
  <tr>
    <td width="459" height="25" align="center" bgcolor="#66CC99"><div align="center"><span class="tur"><span class="style2">:: Adicionar evento a Agenda:: </span></span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
      <form action="add_agenda.asp" method="post" enctype="multipart/form-data" target="_self" id=form>
        <div align="center">
          <center>
            <table width="459" border="0" cellpadding="5" cellspacing="0" class="tbl">
              <tr>
                <td width="58" valign="top"><div align="center"><font size="2" face="Verdana">Data:</font></div></td>
                <td width="381"><span class="desc">
...
%>
              ...
              <tr>
                <td valign="top"><div align="center">Titulo:</div></td>
                <td><input name="resumo" type="text" id="textarea10" style="border-style: solid; border-width: 2" value="<%=resumo%>" size="45"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><table width="215" border="0" cellpadding="0" cellspacing="0" class="tbl">
                    ...
                    <tr>
                      <td height="36" colspan="2" valign="top"><img src="../fotos/agenda/<%=Session("nomedb")%>" alt="" border="0"></td>
                      <td width="144">&nbsp;</td>
