...
$ins_noticias = new tNG_multipleInsert($conn_ConBD);
...
$ins_noticias->registerTrigger("END", "Trigger_Default_Redirect", 99, "novidade_edite.php");
...
$upd_noticias = new tNG_multipleUpdate($conn_ConBD);
...
$upd_noticias->registerTrigger("END", "Trigger_Default_Redirect", 99, "novidade_edite.php");
...
$del_noticias = new tNG_multipleDelete($conn_ConBD);
$tNGs->addTransaction($del_noticias);
// Register triggers
$del_noticias->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Delete1");
$del_noticias->registerTrigger("END", "Trigger_Default_Redirect", 99, "novidade_edite.php");
...
?>
                    <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                      <tr>
                        ...
                        <td><input type="text" name="titulo_<?php echo $cnt1; ?>" id="titulo_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsnoticias['titulo']); ?>" size="32" maxlength="255" />
                      ...
                      <tr>
                        ...
                        <td><textarea name="materia_<?php echo $cnt1; ?>" id="materia_<?php echo $cnt1; ?>" cols="50" rows="5"><?php echo KT_escapeAttribute($row_rsnoticias['materia']); ?></textarea>
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="fonte_<?php echo $cnt1; ?>" id="fonte_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsnoticias['fonte']); ?>" size="32" maxlength="100" />
