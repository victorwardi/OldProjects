...
if (isset($_GET['fabrica'])) {
  $colname_RsFabrica = $_GET['fabrica'];
}
  ...
  <tr>
    <td colspan="3" align="center"><!-- InstanceBeginEditable name="conteudo" -->
      ...
      <table width="500" border="0" align="center" cellpadding="4" cellspacing="1" id="tabela">
        <tr>
          <td colspan="2" align="center" valign="middle" bgcolor="#336699" class="titulo_tabela">Dados da F&aacute;brica</td>
        </tr>
        <tr>
          <td width="112" bgcolor="#cfdaeb"><label for="nome_1">Nome</label></td>
          <td width="367" align="center" valign="top"><?php echo $row_RsFabrica['nome']; ?></td>
        </tr>
        <tr>
          <td bgcolor="#cfdaeb">Raz&atilde;o Social</td>
          <td align="center" valign="top"><?php echo $row_RsFabrica['razaoSocial']; ?></td>
        </tr>
        <tr>
          <td bgcolor="#cfdaeb">CNPJ</td>
          <td align="center" valign="top"><?php echo $row_RsFabrica['cnpj']; ?></td>
        </tr>
        <tr>
          <td bgcolor="#cfdaeb">Inscri&ccedil;&atilde;o Estadual</td>
          <td align="center" valign="top"><?php echo $row_RsFabrica['inscricaoEstadual']; ?></td>
        </tr>
        <tr>
          <td bgcolor="#cfdaeb"><label for="tel1_1">Telefone 1</label></td>
          <td align="center" valign="top"><?php echo $row_RsFabrica['tel1']; ?></td>
        </tr>
        <tr>
          <td bgcolor="#cfdaeb"><label for="tel2_1">Telefone 2</label></td>
        ...
        <tr>
          <td bgcolor="#cfdaeb"><label for="site_1">Site</label></td>
          <td align="center" valign="top"><?php echo $row_RsFabrica['site']; ?></td>
        </tr>
        <tr>
          <td bgcolor="#cfdaeb">Respons&aacute;vel</td>
        ...
        <tr>
          ...
          <td align="center" valign="top"><a href="javascript:MM_openBrWindow('imprimir.php?fabricaID=<?php echo $row_RsFabrica['fabricaID']; ?>','','scrollbars=yes,width=560,height=400')"><img src="../img/imprimir.jpg" alt="" width="20" height="20" border="0"  /></a></td>
        </tr>
        <tr>
          <td bgcolor="#cfdaeb">Editar</td>
          <td align="center" valign="top"><a href="inserir.php?fabricaID=<?php echo $row_RsFabrica['fabricaID']; ?>"><img src="../img/editar.jpg" alt="Editar" width="20" height="20" border="0" /></a></td>
        </tr>
      </table>
