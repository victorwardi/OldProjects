...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  ...
  <tr>
    <td colspan="3" align="center"><!-- InstanceBeginEditable name="conteudo" -->
      <form id="form1" name="form1" method="post" action="imprimirSelecionados.php">
      <table width="500" border="0" align="center" cellpadding="4" cellspacing="1" id="tabelaSemLinha">
        <tr>
          <td align="left" valign="middle" bgcolor="#336699" class="titulo_tabela">Resultado da Buscar por</td>
        </tr>
        <tr>
          <td align="left" valign="middle"><table width="100%" border="0" cellpadding="4" cellspacing="0" id="tabela">
            <tr>
              <td bgcolor="#CFDAEB" class="texto_item">&nbsp;</td>
              ...
              <td bgcolor="#CFDAEB" class="texto_item">A&ccedil;&otilde;es</td>
            </tr>
              <?php $contador = "1"; do {
            ...
            <br />
            <input name="button" type="submit" class="butao" id="button" value="Imprimir Selecionados" /></td>
        </tr>
      </table>
      <p>
        <label></label>
