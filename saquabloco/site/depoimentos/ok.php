    ...
    <td height="163" colspan="2" align="center" valign="top" background="../img/png/fundo_tabela.png"><!-- InstanceBeginEditable name="conteudo" -->
      <div id="texto">
        <div class="novidades_titulo">
          <p align="center">&nbsp; </p>
          <p align="center"><span class="novidades_titulo">Seu depoimento foi enviado com sucesso!</span></p>
          <p align="center"><br />
            <span class="integrante_resposta">Antes de ser publicado ele ser&aacute; analisado!</span></p>
          <p align="center" class="integrante_resposta">          Obrigado! </p>
          <p align="center" class="integrante_resposta"><br />
  Atenciosamente,</p>
          <p align="center"><span class="integrante_resposta">SaquaBloco</span><br />
          </p>
          <p class="novidade_texto"></p>
          <p class="titulos_novidades"><a href="../index.php">Voltar para a p&aacute;gina inicial</a></p>
        </div>
      </div>
