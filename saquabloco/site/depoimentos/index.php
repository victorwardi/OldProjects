  ...
  <tr>
    <td height="163" colspan="2" align="center" valign="top" background="../img/png/fundo_tabela.png"><!-- InstanceBeginEditable name="conteudo" -->
      <div id="texto" >
        <?php do { ?>
        <div>
          <div class="titulos_novidades"><?php echo $row_RsDepoimentos['nome']; ?> - <?php echo $row_RsDepoimentos['cidade']; ?>
          </div>
          <p class="novidade_texto_espaco"><?php echo $row_RsDepoimentos['depoimento']; ?></p></div>
        <?php } while ($row_RsDepoimentos = mysql_fetch_assoc($RsDepoimentos)); ?>
        <br />
<br />

      <div class="titulos_novidades"><a href="escrever.php">Escrever depoimento</a></div>
      </div>
