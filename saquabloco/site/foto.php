      ...
      <p class="novidade_texto">Confira as melhores fotos tiradas durante os ensaios e os carnavais!</p>
        ...
        <div class="novidades_titulo">
          <table width="95%" border="0" cellpadding="0" cellspacing="6" class="linha_trecajada">
            <tr>
              <td width="15%" align="left" valign="middle"><a href="fotos/album.php?id=<?php echo $row_RsGalerias['id'];?>"><img src="<?php echo $objDynamicThumb1->Execute(); ?>" width="60" height="40" border="0" class="borda_foto" /></a></td>
              <td width="85%" align="left" valign="middle" class="novidades_titulo"><a href="fotos/album.php?id=<?php echo $row_RsGalerias['id'];?>"><?php echo $row_RsGalerias['titulo']; ?> - <?php echo $row_RsGalerias['data']; ?></a></td>
            </tr>
          </table>
          </div>
