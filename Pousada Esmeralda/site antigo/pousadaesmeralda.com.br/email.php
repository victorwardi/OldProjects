...
<body>
<table width="400" border="0" align="center" cellpadding="0" cellspacing="0" background="mail/images/mail_03.jpg">
  <tr>
    <td><img src="mail/images/mail_01.jpg" alt="Central de Reservas - Pousada Esmeralda" width="488" height="168" border="0" /></td>
  </tr>
  <tr>
    <td><table width="400" border="0" align="center" cellpadding="0" cellspacing="2">
      ...
      <tr   >
        <td class="text">Data de Chegada: </td>
      </tr>
      <tr   >
        <td class="text">Data de Saída:</td>
      </tr>
      <tr   >
        <td class="text">Tipo de Acomodação: </td>
      </tr>
      <tr   >
        <td class="text">Quantidade de Adultos: </td>
      </tr>
      <tr   >
        <td class="text">Quantidade de Crianças:</td>
      </tr>
      <tr   >
        <td class="text">Informações Adicionais:</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
  ...
  <tr>
    <td><img src="mail/images/mail_05.jpg" alt="" width="488" height="88" /></td>
  </tr>
</table>
</body>
</html>
