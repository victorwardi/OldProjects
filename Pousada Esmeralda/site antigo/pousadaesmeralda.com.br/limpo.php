...
<table width="100%" border="0" cellpadding="0" cellspacing="4">
  ...
  <tr>
    <td  class="fundo_tabela2" align="left" valign="top"><div id="conteudo_interno" class="left">
      ...
      <div>
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>?id=<?php echo $row_RsProdutos['id'];?>" method="post" onsubmit="MM_validateForm('Nome','','R','Cidade','','R','Email','','RisEmail','Telefone','','R');return document.MM_returnValue">
