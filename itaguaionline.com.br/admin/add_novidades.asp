...
pasta = "C:\inetpub\wwwroot\itaguaionline.com.br\"
...
<table width="464" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999">
  <tr>
    <td width="795" height="25" bgcolor="#66CCFF"><div align="center"><span class="tur"><span class="style2">:: Adicionar Novidade:: </span></span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
      <form action="add_novidades.asp" method="post" enctype="multipart/form-data" target="_self" id=form>
        <div align="center">
          <center>
            <table width="459" border="0" cellpadding="5" cellspacing="0" class="tbl">
              <tr>
                <td width="58" valign="top"><div align="center">Categoria:</div></td>
   ...
   call showActivex("materia", 350, 300, false, KT_display, "../ktml2/", "../ktml2/includes/styles/KT_styles.css", "../../../ktml2/images/uploads/", "../../../ktml2/files/uploads/", "English (UK)", -1, "english", "yes", "no")
%>
</p>
                </td>
              </tr>
            ...
            (dd/mm/aaaa) </span></td>
              ...
              <tr>
                <td valign="top"><div align="center"><font face="Verdana" size="2">E-mail do Autor:</font></div></td>
                <td><input name="autmail" type="text" id="autmail5" value="<%=autmail%>" size="20"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><table width="215" border="0" cellpadding="0" cellspacing="0" class="tbl">
                    ...
                    <tr>
                      <td height="36" colspan="2" valign="top"><img src="../fotos/<%=Session("nomedb")%>" alt="" border="0"></td>
                      <td width="144">&nbsp;</td>
