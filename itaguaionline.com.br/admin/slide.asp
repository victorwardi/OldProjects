...
numero = 1
	...
	File.SaveAs pasta & "fotos\slide\" & File.OriginalFileName
			...
			If Jpeg.OriginalWidth = 327 AND Jpeg.OriginalHeight = 160 then
				File.SaveAs destino
			End If
			
			If Jpeg.OriginalWidth > 327 then
				Jpeg.Width = 327
				Jpeg.Height = 160
				Jpeg.Save destino
			End If
...
<form action="slide.asp" method="post" enctype="multipart/form-data" name="Formulario" id="Formulario">
        ...
        <div align="center">Tamanho das fotos a serem inseridas tem quer ser de<span class="style1"> 327X160</span> , favor redimension&aacute;-las antes<br>
        </div>
</form>
</body>
</html>
