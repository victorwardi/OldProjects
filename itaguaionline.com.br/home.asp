  ...
  <tr>
    <th width="817" scope="col"><table width="772" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr align="left" valign="baseline">
        <td height="39" colspan="4"><img src="Nova%20pasta/home_default_r2_c1.jpg" width="779" height="39"></td>
        </tr>
      <tr>
            ...
            <th scope="col"><table width="200" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top" background="imagens_retalhos/fale_conosco_fundo.jpg"><table width="190" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <a href="javascript:MM_openBrWindow('mural/shout.asp','Comentar','400','300','true')"><img src="imagens_retalhos/comentar.jpg" width="100" height="20" border="0"></a></td>
              </tr>
              <tr>
...
<script>runSlideShow()</script>				</th>
              ...
              <tr>
                <th height="52" align="center" valign="middle" bgcolor="#999999" scope="col"><table width="300" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><div align="center"><a href="javascript:MM_openBrWindow('eventos/galerias_de_fotos/?Cod=<%=(Rs_eventos.Fields.Item("cod").Value)%>','Saquabb','','650','450','true')"><img src="images/ver_fotos.jpg" width="80" height="18" border="0"></a></div></td>
                    </tr>
                  </table>                  </th>
              </tr>
            </table></th>
...
%>
                  <table width="311" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <th width="200" align="center" valign="middle" class="style3 style4" scope="col"><%=(Rs_novidades.Fields.Item("resumo").Value)%></th>
                    </tr>
                    <tr>
...
%></td>
          ...
          <tr>
            <td colspan="2" align="center" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><span class="style9"><img src="IMAGENS%20TESTE/prop.jpg" width="174" height="351"></span></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
      ...
      <tr align="center" valign="middle" bgcolor="#FFFFFF" background="imagens_retalhos/fundo_final.jpg">
        <td height="73" colspan="4"><table width="367" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th width="367" class="style4 style10" scope="col"><span class="style9">PRINCIPAL | QUEM SOMOS | EVENTOS | CONTATO | PUBLICIDADE </span></th>
          </tr>
        </table></td>
      </tr>
