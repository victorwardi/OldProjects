...
<table width="760" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <td colspan="2"><table width="734" cellspacing="0" cellpadding="0">
      <tr>
        <td width="74" rowspan="2" align="left" valign="top"><a href="index.html"><img src="img/logo_01.jpg" width="56" height="93" border="0" /></a></td>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','590','height','138','src','flash/banner_novidades','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','flash/banner_novidades' ); //end AC code
      ...
      <tr>
        <td colspan="3" align="left" valign="top" bgcolor="#f5f5f5"><!-- TemplateBeginEditable name="CONTEUDO" -->
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','142','height','153','src','flash/banner_vert_01','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','flash/banner_vert_01' ); //end AC code
      ...
      <tr>
        <td><table width="142" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td align="left" valign="top" class="txt_08">O que voc&ecirc; est&aacute; achando do site do Itagua&iacute; Shopping Center? </td>
              <td>&nbsp;</td>
            </tr>
            <tr valign="top">
              ...
              <td><form id="form1" name="form1" method="post" action="">
                  <table width="118" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="91" align="left" class="txt_08">Bom</td>
                    </tr>
                    <tr>
                      <td align="left"><label>
                        <input name="radiobutton" type="radio" value="radiobutton" />
                      </label></td>
                      <td align="left" class="txt_08">Regular</td>
                    </tr>
                    <tr>
                      <td align="left"><label>
                        <input name="radiobutton" type="radio" value="radiobutton" />
                      </label></td>
                      <td align="left" class="txt_08">Ruim</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td height="38" align="left" valign="bottom"><label>
                        <input type="image" name="imageField" src="img/botao_votar_01.gif" />
                      </label></td>
                    </tr>
                  </table>
              </form></td>
