...
if (isset($_POST['login'])) {
  ...
  $MM_redirectLoginSuccess = "entrada.php";
  $MM_redirectLoginFailed = "?erro=true";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_ConBD, $ConBD);
  
  $LoginRS__query=sprintf("SELECT login, senha FROM lojas WHERE login='%s' AND senha='%s'",
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="240" height="21">
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','660','height','75','src','../flash/top_menu','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../flash/top_menu' ); //end AC code
  ...
  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="660" height="75">
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','590','height','138','src','../flash/banner_novidades','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../flash/banner_novidades' ); //end AC code
      ...
      <tr>
        <td colspan="3" align="left" valign="top" bgcolor="#f5f5f5"><!-- InstanceBeginEditable name="CONTEUDO" -->
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="left" valign="top"><table width="590" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25">&nbsp;</td>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td align="left" class="txt_04">ACESSO RESTRITO </td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td height="25" class="txt_02"><p>&Aacute;rea reservada para os donos de loja do Itagua&iacute; Shopping Center. <br />
                  </p>
                    <p>Para acessar seus dados, preencha o formul&aacute;rio abaixo com seu login e senha. </p>
                    <p>&nbsp;</p></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td align="left" valign="top"><table width="553" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="391" rowspan="2" align="left" valign="top" class="txt_02">
						<?php if (isset ($_GET['erro']) ){?>
<p class="txt_09">Senha ou login inv&aacute;lidos </p>
...
<form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
      <td width="12%" align="left" class="txt_06">Login:</td>
      <td width="88%" align="left"><input name="login" type="text" class="txt_02" id="login" /></td>
    </tr>
    <tr>
      <td align="left" class="txt_06">Senha</td>
      <td align="left"><input name="senha" type="password" class="txt_02" id="senha" /></td>
    </tr>
    <tr>
      <td align="left">&nbsp;</td>
      <td align="left"><input name="Submit" type="submit" class="fundo_campo_04" value="entrar" /></td>
    </tr>
  </table>
  <p>
    <label></label>
  ...
  <p>
    <label></label>
                        ...
                        <td width="132" rowspan="2" valign="top">&nbsp;</td>
                        <td width="10">&nbsp;</td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
