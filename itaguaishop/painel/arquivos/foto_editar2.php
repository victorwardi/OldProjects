...
// Filter
$tfi_listfotos2 = new TFI_TableFilter($conn_ConBD, "tfi_listfotos2");
$tfi_listfotos2->addColumn("fotos.id", "STRING_TYPE", "id", "%");
$tfi_listfotos2->addColumn("fotos.arquivo", "STRING_TYPE", "arquivo", "%");
...
$query_rsfotos1 = sprintf("SELECT fotos.id, fotos.arquivo, fotos.id_foto, fotos.descricao FROM fotos WHERE %s ORDER BY %s", $NXTFilter_rsfotos1, $NXTSort_rsfotos1);
...
mysql_select_db($database_ConBD, $ConBD);
$query_rs_cat = "SELECT * FROM novidades ORDER BY categoria DESC";
$rs_cat = mysql_query($query_rs_cat, $ConBD) or die(mysql_error());
                  ...
                  <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th id="id" class="KT_sorter KT_col_id <?php echo $tso_listfotos2->getSortIcon('fotos.id'); ?>"> <a href="<?php echo $tso_listfotos2->getSortLink('fotos.id'); ?>">Id</a> </th>
...
?>
                        <tr class="KT_row_filter">
                          <td>&nbsp;</td>
                          <td><input type="text" name="tfi_listfotos2_id" id="tfi_listfotos2_id" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listfotos2_id']); ?>" size="20" maxlength="100" /></td>
                          <td><input type="text" name="tfi_listfotos2_arquivo" id="tfi_listfotos2_arquivo" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listfotos2_arquivo']); ?>" size="20" maxlength="60" /></td>
                      ...
                      <?php if ($totalRows_rsfotos1 > 0) { // Show if recordset not empty ?>
                        <?php do { ?>
                          <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                            ...
                            <td><?php echo $row_rs_cat['titulo']; ?></td>
                            <td><div class="KT_col_arquivo"><?php echo KT_FormatForList($row_rsfotos1['arquivo'], 20); ?></div></td>
                            <td><div class="KT_col_descricao"><?php echo KT_FormatForList($row_rsfotos1['descricao'], 20); ?></div></td>
                            <td><a class="KT_edit_link" href="foto_inserir.php?id_foto=<?php echo $row_rsfotos1['id_foto']; ?>&amp;KT_back=1"><?php echo NXT_getResource("edit_one"); ?></a> <a class="KT_delete_link" href="#delete"><?php echo NXT_getResource("delete_one"); ?></a> </td>
                          </tr>
