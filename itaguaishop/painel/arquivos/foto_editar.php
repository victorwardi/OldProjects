...
$query_rsfotos1 = sprintf("SELECT fotos.id_foto, fotos.descricao, fotos.arquivo FROM fotos WHERE %s ORDER BY %s", $NXTFilter_rsfotos1, $NXTSort_rsfotos1);
                  ...
                  <table cellpadding="2" cellspacing="0" class="borda_roxa" id="painel">
                    <thead>
                      <tr class="KT_row_order">
                        <th bgcolor="#EDE4EF"> <input type="checkbox" name="KT_selAll" id="KT_selAll"/>                        </th>
                        <th align="center" bgcolor="#EDE4EF" class="KT_sorter KT_col_descricao <?php echo $tso_listfotos1->getSortIcon('fotos.descricao'); ?>" id="descricao"> <a href="<?php echo $tso_listfotos1->getSortLink('fotos.descricao'); ?>">Descricao</a> </th>
                        <th align="center" bgcolor="#EDE4EF" class="KT_sorter KT_col_arquivo <?php echo $tso_listfotos1->getSortIcon('fotos.arquivo'); ?>" id="arquivo"> <a href="<?php echo $tso_listfotos1->getSortLink('fotos.arquivo'); ?>">Arquivo</a> </th>
...
?>
                        <tr class="KT_row_filter">
                          ...
                          <td><input type="text" name="tfi_listfotos1_arquivo" id="tfi_listfotos1_arquivo" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listfotos1_arquivo']); ?>" size="20" maxlength="60" /></td>
                      ...
                      <?php if ($totalRows_rsfotos1 > 0) { // Show if recordset not empty ?>
                        <?php do { ?>
                          <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                            ...
                            <td><div class="txt_06"><?php echo KT_FormatForList($row_rsfotos1['descricao'], 20); ?></div></td>
