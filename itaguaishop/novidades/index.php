...
$query_RsNovidades = "SELECT * FROM novidades WHERE categoria = 'Na Web' OR categoria = 'Serviços' OR categoria = 'Itaguaí Shopping Center' ORDER BY id DESC";
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','590','height','138','src','../flash/banner_novidades','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../flash/banner_novidades' ); //end AC code
      ...
      <tr>
        <td colspan="3" bgcolor="#f5f5f5"><table width="590" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="left"><img src="../img/titulo_novidades.gif" width="260" height="20" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
              ...
              <tr>
                <td width="391" rowspan="2" valign="top"><?php do { ?>
                  <table width="385" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="40" align="left" valign="middle" class="linhaembaixo01"><a href="../novidades/ver.php?id=<?php echo $row_RsNovidades['id']; ?>"><?php echo $row_RsNovidades['titulo']; ?> - <?php echo $row_RsNovidades['categoria']; ?> - <?php echo $row_RsNovidades['data']; ?></a></td>
                    </tr>
                  </table>
