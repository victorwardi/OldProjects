...
if (isset($_GET['categoria'])) {
  $colname_RsNovidades = (get_magic_quotes_gpc()) ? $_GET['categoria'] : addslashes($_GET['categoria']);
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsNovidades = sprintf("SELECT * FROM novidades WHERE categoria = '%s' ORDER BY id DESC", $colname_RsNovidades);
...
mysql_select_db($database_ConBD, $ConBD);
$query_categoria = sprintf("SELECT * FROM categoria_novidade WHERE categoria = '%s'", $colname_categoria);
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','590','height','138','src','../flash/banner_novidades','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../flash/banner_novidades' ); //end AC code
          ...
          <param name="movie" value="../flash/banner_novidades.swf" />
          <param name="quality" value="high" />
          <embed src="../flash/banner_novidades.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="590" height="138"></embed>
        </object></noscript></td>
      ...
      <tr>
        <td colspan="3" bgcolor="#f5f5f5"><table width="590" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="middle"><img src="<?php echo tNG_showDynamicImage("../", "../Uploads/fotos/", "{categoria.titulo_img}");?>" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
              ...
              <tr>
                <td width="391" rowspan="2" valign="top"><?php do { ?>
                    <table width="385" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="40" align="left" valign="middle" class="linhaembaixo01"><a href="ver.php?id=<?php echo $row_RsNovidades['id']; ?>"><?php echo $row_RsNovidades['titulo']; ?> - <?php echo $row_RsNovidades['data']; ?></a></td>
                      </tr>
                    </table>
                ...
                <td width="132" rowspan="2" valign="top"><table width="132" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="contorno_01"><img src="../img/img_horarios_01.jpg" width="132" height="132" /></td>
                    </tr>
                    <tr>
                      <td height="20">&nbsp;</td>
                    </tr>
            ...
            <td><table width="553" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><table width="541" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="99" class="contorno_01"><img src="../img/DSCF2379pp.jpg" width="99" height="74" onclick="MM_openBrWindow('../popup/2379.html','','width=480,height=360')" /></td>
                    <td width="11">&nbsp;</td>
                    <td width="99" class="contorno_01"><img src="../img/DSCF2381pp.jpg" width="99" height="74" onclick="MM_openBrWindow('../popup/2381h.html','','width=360,height=480')" /></td>
                    <td width="11">&nbsp;</td>
                    <td width="99" class="contorno_01"><img src="../img/DSCF2383pp.jpg" width="99" height="74" onclick="MM_openBrWindow('../popup/2383h.html','','width=360,height=480')" /></td>
                    <td width="11">&nbsp;</td>
                    <td width="99" class="contorno_01"><img src="../img/DSCF2391pp.jpg" width="99" height="74" onclick="MM_openBrWindow('../popup/2391.html','','width=480,height=360')" /></td>
                    <td width="11">&nbsp;</td>
                    <td width="99" class="contorno_01"><img src="../img/DSCF2392pp.jpg" width="99" height="74" onclick="MM_openBrWindow('../popup/2392h.html','','width=360,height=480')" /></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
