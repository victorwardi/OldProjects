...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','590','height','138','src','../flash/banner_novidades','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','wmode','Transparent','movie','../flash/banner_novidades' ); //end AC code
          ...
          <tr>
            ...
            <td height="40" valign="bottom"><table width="183" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="165" align="left"><a href="index.php">Exibir todas as novidades </a></td>
              </tr>
            </table></td>
            <td>&nbsp;</td>
          </tr>
