...
$query_RsNovidades = "SELECT * FROM novidades WHERE categoria = 'Eventos' OR categoria = 'Qual é a Boa?' OR categoria = 'Fim de Semana' ORDER BY id DESC";
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','590','height','138','src','../flash/banner_entretenimento','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../flash/banner_entretenimento' ); //end AC code
      ...
      <tr>
        <td colspan="3" bgcolor="#f5f5f5"><table width="590" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="left"><img src="../img/titulo_entretenimento_eventos.gif" width="225" height="16" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td><table width="553" cellspacing="0" cellpadding="0">
              <tr>
                <td width="391" rowspan="2" valign="top"><?php do { ?>
                    <table width="385" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="40" align="left" valign="middle" class="linhaembaixo01"><a href="../eventos/ver.php?id=<?php echo $row_RsNovidades['id']; ?>"><?php echo $row_RsNovidades['titulo']; ?> - <?php echo $row_RsNovidades['categoria']; ?> - <?php echo $row_RsNovidades['data']; ?></a></td>
                      </tr>
                    </table>
                ...
                <td width="132" rowspan="2" valign="top"><table width="132" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="25"><div align="center"><span class="txt_03">M&ecirc;s de Outubro</span></div></td>
                  </tr>
                  <tr>
                    <td class="contorno_01"><table width="132" cellspacing="0" cellpadding="0">
                        <tr class="txt_03">
                          <td width="19" height="19" align="center" valign="middle" class="linhaembaixo04">D</td>
                          <td width="19" height="19" align="center" valign="middle" class="linhaembaixo04">S</td>
                          <td width="18" height="19" align="center" valign="middle" class="linhaembaixo04">T</td>
                          <td width="18" height="19" align="center" valign="middle" class="linhaembaixo04">Q</td>
                          <td width="18" height="19" align="center" valign="middle" class="linhaembaixo04">Q</td>
                          <td width="19" height="19" align="center" valign="middle" class="linhaembaixo04">S</td>
                          <td width="19" height="19" align="center" valign="middle" class="linhaembaixo04">S</td>
                        </tr>
                        <tr>
                          <td height="19" align="center" valign="middle" class="txt_02">&nbsp;</td>
                          <td height="19" align="center" valign="middle" class="txt_02">1</td>
                          <td height="19" align="center" valign="middle" class="txt_02">2</td>
                          <td height="19" align="center" valign="middle" class="txt_02">3</td>
                          <td height="19" align="center" valign="middle" class="txt_02">4</td>
                          <td height="19" align="center" valign="middle" class="segundo"><a href="../musicaaovivo/index.html">5</a></td>
                          <td height="19" align="center" valign="middle" class="txt_02">6</td>
                        </tr>
                        <tr>
                          <td height="19" align="center" valign="middle" class="txt_02">7</td>
                          <td height="19" align="center" valign="middle" class="txt_02">8</td>
                          <td height="19" align="center" valign="middle" class="segundo"><a href="../diadascriancas2007/index.html">9</a></td>
                          <td height="19" align="center" valign="middle" class="segundo"><a href="../diadascriancas2007/index.html">10</a></td>
                          <td height="19" align="center" valign="middle" class="segundo"><a href="../diadascriancas2007/index.html">11</a></td>
                          <td height="19" align="center" valign="middle" class="txt_02">12</td>
                          <td height="19" align="center" valign="middle" class="segundo"><a href="../musicaaovivo/index.html">13</a></td>
                        </tr>
                        <tr>
                          <td height="19" align="center" valign="middle" class="txt_02">14</td>
                          <td height="19" align="center" valign="middle" class="txt_02">15</td>
                          <td height="19" align="center" valign="middle" class="txt_02">16</td>
                          <td height="19" align="center" valign="middle" class="txt_02">17</td>
                          <td height="19" align="center" valign="middle" class="txt_02">18</td>
                          <td height="19" align="center" valign="middle" class="segundo"><a href="../musicaaovivo/index.html">19</a></td>
                          <td height="19" align="center" valign="middle" class="txt_02">20</td>
                        </tr>
                        <tr>
                          <td height="19" align="center" valign="middle" class="txt_02">21</td>
                          <td height="19" align="center" valign="middle" class="txt_02">22</td>
                          <td height="19" align="center" valign="middle" class="txt_02">23</td>
                          <td height="19" align="center" valign="middle" class="txt_02">24</td>
                          <td height="19" align="center" valign="middle" class="txt_02">25</td>
                          <td height="19" align="center" valign="middle" class="segundo"><a href="../musicaaovivo/index.html">26</a></td>
                          <td height="19" align="center" valign="middle" class="txt_02">27</td>
                        </tr>
                        <tr>
                          <td height="19" align="center" valign="middle" class="txt_02">28</td>
                          <td height="19" align="center" valign="middle" class="txt_02">29</td>
                          <td height="19" align="center" valign="middle" class="txt_02">30</td>
                          <td height="19" align="center" valign="middle" class="txt_02">31</td>
                          <td height="19" align="center" valign="middle" class="txt_02">&nbsp;</td>
                          <td height="19" align="center" valign="middle" class="txt_02">&nbsp;</td>
                          <td height="19" align="center" valign="middle" class="txt_02">&nbsp;</td>
                        </tr>
          ...
          <tr>
            ...
            <td><table width="553" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><table width="281" cellspacing="0" cellpadding="0">
                  <tr>
              ...
              <tr>
                <td><table width="541" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="99" class="contorno_01"><img src="../img/DSCF2256pp.jpg" width="99" height="74" onclick="MM_openBrWindow('../popup/2256.html','','width=480,height=360')" /></td>
                    <td width="11">&nbsp;</td>
                    <td width="99" class="contorno_01"><img src="../img/DSCF2274pp.jpg" width="99" height="74" onclick="MM_openBrWindow('../popup/2274.html','','width=480,height=360')" /></td>
                    <td width="11">&nbsp;</td>
                    <td width="99" class="contorno_01"><img src="../img/DSCF2268pp.jpg" width="99" height="74" onclick="MM_openBrWindow('../popup/2268.html','','width=480,height=360')" /></td>
                    <td width="11">&nbsp;</td>
                    <td width="99" class="contorno_01"><img src="../img/DSCF2357pp.jpg" width="99" height="74" onclick="MM_openBrWindow('../popup/2357.html','','width=480,height=360')" /></td>
                    <td width="11">&nbsp;</td>
                    <td width="99" class="contorno_01"><img src="../img/DSCF2388pp.jpg" width="99" height="74" onclick="MM_openBrWindow('../popup/2388h.html','','width=360,height=480')" /></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
