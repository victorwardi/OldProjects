...
if (isset($_GET['busca'])) {
  $colname_RSresultado = (get_magic_quotes_gpc()) ? $_GET['busca'] : addslashes($_GET['busca']);
}
mysql_select_db($database_ConBD, $ConBD);
$query_RSresultado = sprintf("SELECT * FROM lojas WHERE nome LIKE '%%%s%%'", $colname_RSresultado);
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','590','height','138','src','../flash/banner_lojas','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../flash/banner_lojas' ); //end AC code
      ...
      <tr>
        <td colspan="3" bgcolor="#f5f5f5"><table width="590" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="left" class="txt_04"><img src="../img/titulo_lojas_buscar.gif" width="172" height="16" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td><table width="551" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="19" align="left" valign="top"><span class="txt_07"></span></td>
                </tr>
                <tr>
                  <td align="left" valign="top" class="txt_06"><?php if ($totalRows_RSresultado > 0) { // Show if recordset not empty ?>
                        ...
                        <tr class="txt_02">
                          <td height="25" colspan="4" align="left" valign="top" class="txt_09"><?php do { ?>
                              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linhaembaixo03">
                                ...
                                <tr>
                                  <td height="40" align="left" valign="middle" ><div class="terceiro"><a href="../lojas/lj.php?id=<?php echo $row_RSresultado['id']; ?>"><?php echo $row_RSresultado['nome']; ?></a><br />
                                          <span class="txt_01"><?php echo $row_RSresultado['categoria']; ?></span></div></td>
                                  <td align="center" ><?php echo $row_RSresultado['telefone']; ?></td>
                                  <td align="center" ><?php echo $row_RSresultado['andar']; ?></td>
                                  <td align="center" ><?php echo $row_RSresultado['numero']; ?></td>
                                </tr>
                              </table>
                            <?php } while ($row_RSresultado = mysql_fetch_assoc($RSresultado)); ?></td>
                        </tr>
                      </table>
                    <?php } // Show if recordset not empty ?>
                      <?php if ($totalRows_RSresultado == 0) { // Show if recordset empty ?>
                    Desculpe! Sua busca por <span class="txt_03">&quot;<?php echo $_GET['busca']; ?>&quot;</span> n&atilde;o gerou resultados!
