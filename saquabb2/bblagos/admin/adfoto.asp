...
<%
'UPLOAD
pasta = "C:\wwwroot\saquabb.com.br\bblagos\"
...
If (Upload.Form("Upload")<>"") Then
	...
	File.SaveAs pasta & "fotos\upload\" & "foto_" & nomefoto

nomefoto= Session("count") & ".jpg"
caminho = pasta&"fotos\"
destino= caminho & "500x250_" & nomefoto
...
<table width="464" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="790" height="25"><span class="tur style2"><span class="tur  style4"><span class="tur  style6"><span class="tur  style8"><span class="tur  style10"><span class="tur style4 style14 style3"><span class="tur style4 style14 style6"><span class="tur style14 style6  style4"><span class="style2">:::</span>:: Adicionar Foto &Agrave; Not&iacute;cia Secund&aacute;ria ::</span></span></span></span></span></span></span></span></td>
  </tr>
  <tr>
      ...
      <table width="358" height="338" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#FFFFFF" class="tbl">
        ...
        <tr>
          ...
          <td height="46" colspan="3">
            <select name="CodNoticia" class="style1" id="select3">
...
%>
		...
		<tr>
          ...
          <td><table width="403" border="0" cellpadding="0" cellspacing="0" class="tbl">
              ...
              <tr>
                <td height="36" valign="top"><img src="../fotos/upload/foto_<% =Session("nomefoto")%>" alt="" border="0"></td>
                </tr>
