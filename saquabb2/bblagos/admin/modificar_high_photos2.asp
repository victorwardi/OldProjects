...
RsAlbuns.Source = "SELECT * FROM high_quality_photos WHERE cod = " + Replace(RsAlbuns__MMColParam, "'", "''") + " ORDER BY cod DESC"
...
RsTiposEvento.ActiveConnection = MM_conexao_STRING
...
<body>
 <form ACTION="<%=MM_editAction%>" METHOD="POST" name="Formulario" id="Formulario">
        <br>
        <table  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFFFF" class="tdnot">
          <tr align="center" bgcolor="#0099FF">
            <td width="406" height="30" colspan="2" class="destaquepreto"><div align="center"><span class="style1"> Modificar Galeria de Foto </span></div></td>
          </tr>
          <tr>
            <td>Foto de Capa: </td>
            <td><img src="/high_quality_photos/fotos/<%=(RsAlbuns.Fields.Item("thumb").Value)%>"></td>
          </tr>
          <tr>
            <td>T&iacute;tulo:</td>
