...
Rs_atletas.Source = "SELECT * FROM Galerias ORDER BY Cod DESC"
              ...
              <td colspan="3"><!-- InstanceBeginEditable name="titulo" -->
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <th width="48%" align="center" valign="top" scope="col"><img src="imagens/topo/topos/galerias.jpg" width="288" height="61"></th>
...
%>
                    <td width="140"><table width="143" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td height="108" align="center" valign="middle"><a href="javascript:MM_openBrWindow('galeria_fotos/galeria.asp?Cod=<%=(Rs_atletas.Fields.Item("Cod").Value)%>','Galeria','','750','500','true')"><img src="fotos/galeria/<%=(Rs_atletas.Fields.Item("Foto").Value)%>" border="0" class="brd"></a></td>
                          </tr>
                          <tr>
                            <td align="center" valign="middle" class="style60 style61"><a href="javascript:MM_openBrWindow('galeria_fotos/galeria.asp?Cod=<%=(Rs_atletas.Fields.Item("Cod").Value)%>','Galeria','','750','500','true')"><%=(Rs_atletas.Fields.Item("Titulo").Value)%></a></td>
                          </tr>
                        </table></td>
                    <%
    'Horizontal Looper version 3
