...
%>
  <tr>
    <td><a href="foto.asp?CodFoto=<%=(RsGaleria.Fields.Item("CodFoto").Value)%>" target="foto"><img src="gerath.asp?arquivo=../fotos/<%=(RsGaleria.Fields.Item("arquivo").Value)%>" border="0"></a></td>
  </tr>
  <tr>
    <td height="3" ></td>
  </tr>
