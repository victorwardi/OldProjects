...
RsVerNot.ActiveConnection = MM_con_kiuchi_STRING
...
<div align="center">
  <table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <th scope="col"><table width="477" height="497" cellpadding="0" cellspacing="0">
          <tr>
            <td>&nbsp;</td>
            <td height="15" class="style1"><img src="imagens/retalho/topo_news.jpg" width="450" height="70"></td>
            <td height="15">&nbsp;</td>
          </tr>
          <tr>
            <td width="15"><img src="imagens/retalho/cantoesquerdo.gif" width="15" height="15"></td>
            <td width="445" height="15" bgcolor="#FFFFFF" class="style1">--</td>
            <td width="15" height="15"><img src="imagens/retalho/cantodireito.gif" width="15" height="15"></td>
          </tr>
          <tr>
            <td colspan="3" bgcolor="#FFFFFF"><table width="464" height="312" border="0" align="center" cellpadding="0" cellspacing="0" background="figuras/fundo_news.gif">
                <tr bgcolor="#FFFFFF">
                  <td height="10" colspan="3" align="center" class="tit"><div align="left">
                      <p align="center" class="style16 style33 style19">&nbsp;<span class="style38">::<%=(RsVerNot.Fields.Item("titulo").Value)%>::</span></p>
                  </div></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td height="28" colspan="3" align="center" class="style19"><strong class="style19 style30"><%=(RsVerNot.Fields.Item("resumo").Value)%></strong></td>
                </tr>
                <tr>
                  <td width="175" height="30" class="style19"><span class="style30"><strong>Data:</strong> <em><%=(RsVerNot.Fields.Item("data").Value)%></em></span></td>
                    ...
                    <table width="146" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="150" align="right" valign="top">
                          ...
                          <table width="130" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" bgcolor="#666666">
                            <tr>
                              <td width="192" height="58" valign="top"><div align="center"><a href="javascript:openPictureWindow_Fever('fotos/noticia/<%=(Fotos.Fields.Item("arquivo").Value)%>','<%=(Fotos.Fields.Item("largura").Value)%>','<%=(Fotos.Fields.Item("altura").Value)%>','Foto - NEWS','10','10')"><img src="fotos/noticia/foto_<%=(Fotos.Fields.Item("arquivo").Value)%>" width="120" height="90" border="0" align="absmiddle" class="borda"></a><span class="style6"><br>
...
Wend %>
          ...
          <tr>
            <td height="15"><img src="imagens/retalho/cantodireitoesquerdo.gif" width="15" height="15"></td>
            <td bgcolor="#FFFFFF" class="style1">--</td>
            <td><img src="imagens/retalho/cantodireitobaixo.gif" width="15" height="15"></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td bgcolor="#666666" class="style1"><div align="right">Criado por : Wardesign.com.br </div></td>
            <td>&nbsp;</td>
          </tr>
      </table></th>
    </tr>
