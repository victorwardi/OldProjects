...
%>
      <table width="400" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#336699">
          <th height="20" colspan="2" scope="col"><div align="center" class="style16">Modelo:<%=(rs_oferta.Fields.Item("titulo").Value)%> </div></th>
        </tr>
        <tr bgcolor="#F2F2F2">
          <td width="113" height="167" align="center" valign="middle" bgcolor="#CCCCCC"><span class="style7"><a href="javascript:openPictureWindow_Fever('fotos/ofertas/<%=(rs_oferta.Fields.Item("foto").Value)%>','300','400','XpressBB','10','10')"><img src="fotos/ofertas/<%=(rs_oferta.Fields.Item("foto").Value)%>" width="90" height="120" border="1" align="middle" class="bordad_preta" bordercolor="#000000"></a><br>
        ...
        <tr>
          <td colspan="2" class="style16 style23">-</td>
        </tr>
      </table>
      <% 
