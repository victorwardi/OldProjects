...
<table width="741" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="739" height="25" bgcolor="#66CC99"><div align="center"><span class="tur"> <span class="style2"><span class="style1">:: Remover  :: </span></span></span></div></td>
  </tr>
  <tr>
    <td align="left">
...
%>
      <tr>
        <td width="36" height="92" align="center" valign="middle"><input name="MM_recordId" type="radio" value="<%=(RsAltera.Fields.Item("Cod").Value)%>"></td>
          <td width="703" align="left" valign="middle"><a href="alt_galerias.asp?CodNot=<%=(RsAltera.Fields.Item("Cod").Value)%>" class="nometur">   </a>
            <table width="530" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th width="131" scope="col"><img src="../fotos/galeria/<%=(RsAltera.Fields.Item("Foto").Value)%>" alt="" width="100" height="75" border="0"></th>
                <th width="399" scope="col"><div align="left" class="menulk"><%=(RsAltera.Fields.Item("titulo").Value)%></div></th>
              </tr>
            </table></td>
      </tr>
      <% 
