...
<table width="741" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="739" height="25" bgcolor="#66CC99"><div align="center"><span class="tur"> <span class="style2"><span class="style1">:: Alterar  :: </span></span></span></div></td>
  </tr>
  <tr>
    <td align="left">
...
%>
      <tr>
        <td width="36" height="18" align="center" valign="middle"><input name="MM_recordId" type="radio" value="<%=(RsAltera.Fields.Item("CodNoticia").Value)%>"></td>
          <td width="703"><a href="alt_noticia.asp?CodNot=<%=(RsAltera.Fields.Item("CodNoticia").Value)%>" class="nometur"> <%=(RsAltera.Fields.Item("titulo").Value)%>- </a><a href="alt_noticia.asp?CodNot=<%=(RsAltera.Fields.Item("CodNoticia").Value)%>" class="nometur"><%=(RsAltera.Fields.Item("data").Value)%></a></td>
      </tr>
      <% 
