...
<table width="741" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="739" height="25" bgcolor="#66CC99"><div align="center"><span class="tur"> <span class="style2"><span class="style1">:: Remover Galerias :: <br>
              <span class="mar">(selecione a galeria que deseja remover) </span></span></span></span></div></td>
  </tr>
  <tr>
    <td align="left">
...
%>
      <tr>
        <td width="36" height="45" align="center" valign="middle"><input name="MM_recordId" type="radio" value="<%=(RsAltera.Fields.Item("Cod").Value)%>"></td>
          <td width="703" align="left" valign="middle">             <table width="371" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th width="150" align="center" valign="middle" scope="col"><img src="../fotos/galeria/<%=(RsAltera.Fields.Item("Foto").Value)%>" alt="" border="1" class="brdnoticia"></th>
                <th width="221" align="left" valign="middle" class="menulk tbl tbl" scope="col"> ::. <%=(RsAltera.Fields.Item("titulo").Value)%></th>
              </tr>
            </table>
            <p>&nbsp;</p></td>
      </tr>
