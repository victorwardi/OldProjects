...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "foto_ofertas"
  MM_editColumn = "CodFoto"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "removerfotos_oferta.asp"
...
RsFotos.Source = "SELECT * FROM foto_ofertas ORDER BY CodNoticia DESC"
...
<table width="638" height="239" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="638" height="25" bordercolor="#E0DFE3" bgcolor="#66CC99"><div align="center"><span class="tur style1">:: Alterar Fotos da Sess&atilde;o Ofertas ::            <span class="style7"> </span><br>
    </span></div></td>
  </tr>
  <tr>
    <td align="center">
...
%>
      <tr>
        <td width="85" height="18" align="center" valign="middle">
          ...
          <td width="89"><img src="../fotos/ofertas/foto_<%=(RsFotos.Fields.Item("arquivo").Value)%>" alt="" width="79" height="59" vspace="5" border="0"></td>
