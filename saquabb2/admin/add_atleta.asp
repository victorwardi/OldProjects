...
destino= pasta & "fotos\atletas\" & nomecompletoimg
...
<table width="464" border="0" align="left" cellpadding="0" cellspacing="0" bordercolor="#000099">
  <tr>
    <td width="795" height="25" bgcolor="#FFFFFF"><div align="left"><span class="tur">:::<span class="style2">:: Adicionar Atleta</span></span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
      <form action="add_atleta.asp" method="post" enctype="multipart/form-data" target="_self" id=form>
        <div align="center">
          <center>
            ...
            (dd/mm/aaaa) </span></td>
              ...
              <tr>
                ...
                <td><table width="215" border="0" cellpadding="0" cellspacing="0" class="tbl">
                    ...
                    <tr>
                      <td height="36" colspan="2" valign="top"><img src="../fotos/atletas/<%=Session("nomedb")%>" alt="" border="0"></td>
                      <td width="144">&nbsp;</td>
