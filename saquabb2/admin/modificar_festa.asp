...
<body>
  <form ACTION="<%=MM_editAction%>" METHOD="POST" name="Formulario" id="Formulario">
        <br>
        <br>
        <table  border="0" align="center" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF" class="tdnot">
          <tr align="center" bgcolor="#FF9900">
            <td width="406" height="20" bgcolor="#FFFFFF" class="destaquepreto"><p align="center" class="style1">Festa - Modificar/Remover</p></td>
          </tr>
          <tr align="center">
...
%>
                <tr>
                  ...
                  <td width="183"><a href="evento_modificar2.asp?Cod=<%=(RsAlbuns.Fields.Item("Cod").Value)%>"><%=(RsAlbuns.Fields.Item("nome").Value)%></a></td>
                </tr>
                <% 
