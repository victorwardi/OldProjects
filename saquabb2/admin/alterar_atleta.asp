...
%>
<%
Dim Rs_atleta__MMColParam
Rs_atleta__MMColParam = "1"
If (Request.QueryString("CodNot") <> "") Then 
  Rs_atleta__MMColParam = Request.QueryString("CodNot")
End If
%>
<%
Dim Rs_atleta
...
Rs_atleta.Source = "SELECT * FROM atletas WHERE CodNoticia = " + Replace(Rs_atleta__MMColParam, "'", "''") + " ORDER BY CodNoticia DESC"
...
<table width="464" border="0" align="left" cellpadding="0" cellspacing="0" bordercolor="#000099">
  <tr>
    <td width="772" height="35" bgcolor="#FFFFFF"><div align="left"><span class="tur style2"><span class="tur  style4"><span class="style6">::<span class="style5">:</span></span><span class="style5">:: Alterar Not&iacute;cia Principal :: </span></span></span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
            ...
            <center>
              <table width="459" border="0" cellpadding="5" cellspacing="0" class="tbl">
                <tr>
                  ...
                  <td><input name="titulo2" type="text" id="titulo5" value="<%=(Rs_atleta.Fields.Item("titulo").Value)%>" size="50"></td>
                </tr>
                <tr>
                  <td valign="top">Mat&eacute;ria:</td>
                  <td><input name="materia" type="hidden" id="materia" value="<%=(Server.HTMLEncode( Rs_atleta.Fields.Item("materia").Value  & ""))%>">
                    <%
...
%></td>
                ...
                <tr>
                  ...
                  <td><textarea name="resumo" cols="45" rows="4" id="textarea10" style="border-style: solid; border-width: 2"><%=(Rs_atleta.Fields.Item("resumo").Value)%></textarea></td>
                </tr>
                <tr>
                  <td valign="top"><span class="desc"><font face="Verdana" size="2">Data:</font></span></td>
                  <td><span class="desc">
                    <input name="data2" type="text" id="data5" value="<%=(Rs_atleta.Fields.Item("data").Value)%>" size="13">
                  (dd/mm/aaaa) </span></td>
                </tr>
                <tr>
                  <td valign="top"><span class="desc"><font face="Verdana" size="2">Autor:</font></span></td>
                  <td><span class="desc">
                    <input name="autor2" type="text" id="autor5" value="<%=(Rs_atleta.Fields.Item("autor").Value)%>" size="20">
                  </span></td>
                </tr>
                <tr>
                  <td valign="top"><font face="Verdana" size="2">E-mail do Autor:</font></td>
                  <td><input name="autmail2" type="text" id="autmail5" value="<%=(Rs_atleta.Fields.Item("autmail").Value)%>" size="20"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
          ...
          <input type="hidden" name="MM_recordId" value="<%= Rs_atleta.Fields.Item("CodNoticia").Value %>">
</form></td>
  </tr>
</table>
</BODY>
