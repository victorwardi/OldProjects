...
<table width="461" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FF3399">
  <tr>
    <td width="772" height="25" bgcolor="#FF99CC"><div align="center"><span class="menulk">Alterar Not&iacute;cia </span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
...
%></td>
                ...
                <tr>
                  ...
                  <td><span class="desc">
                    <input name="autor2" type="text" id="autor5" value="<%=(RsNot.Fields.Item("autor").Value)%>" size="20">
                  </span></td>
                </tr>
                <tr>
                  <td valign="top"><font face="Verdana" size="2">E-mail do Autor:</font></td>
                  <td><input name="autmail2" type="text" id="autmail5" value="<%=(RsNot.Fields.Item("autmail").Value)%>" size="20"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
