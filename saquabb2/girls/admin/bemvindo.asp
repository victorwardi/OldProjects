...
-->
    ...
    <table width="464" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="791" height="239" bgcolor="#FFFFFF" class="tbl"><div align="center"><span class="style1">Bem-vindo ao Administrador do Saquabb <span class="style2">Girls </span></span><br>
        </div></td>
      </tr>
    </table>
</BODY>
