...
Response.Redirect("add_foto_galeria.asp")
End If
Set upl = Nothing 
%>
            ...
            <table width="459" border="0" align="left" cellpadding="5" cellspacing="0" class="tbl">
              <tr>
                ...
                <td><p>                        <input name="foto" type="file" id="foto5" size="30">
                    ...
                    <p>
                      <input name="Upload" type="submit" value="upload da foto">
                  </p></td>
              </tr>
              ...
              <tr>
               ...
               <tr>
                 ...
                 <td><input name="fotografo" type="text" id="titulo6" value="<%=fotografo%>" size="50"></td>
               </tr>
              <tr>
                <td>&nbsp;</td>
                <td><input name="submit" type="submit" id="submit5" value="Upload"></td>
              </tr>
            </table>
          </center>
        </div>
