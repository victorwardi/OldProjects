...
ocdAdminPassword = "saquarema" 'comma delimited list of passwords required to create dynamic connections.  Session cookies required for this option.
ocdADOConnection =  "Provider=Microsoft.Jet.OLEDB.4.0; Data Source=C:\inetpub\wwwroot\saquabb.com.br\banco_de_dados\db.mdb"
