                  ...
                  <td align="center" valign="top" background="figuras/fundo_news.gif"><table width="95%" height="220" border="0" align="center" cellpadding="0" cellspacing="0" background="figuras/fundo_news.gif">
                    <tr bgcolor="#FFFFFF">
                      <td height="10" align="center" background="figuras/fundo_news.gif" class="tit"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" height="67" align="center" valign="top"><div align="left">Por:<img src="imagens/colunistas/cris.jpg" width="250" height="65"></div></td>
                          <td width="50%" height="67" align="center" valign="bottom"><div align="left" class="style75">
                            <div align="right">Data:<%=(RsVerNot.Fields.Item("data").Value)%></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="32" colspan="2" align="center" valign="middle"><span class="style74">&nbsp;::</span><span class="style77"><%=(RsVerNot.Fields.Item("titulo").Value)%></span><span class="style79">::</span></td>
                        </tr>
                      </table></td>
                    </tr>
