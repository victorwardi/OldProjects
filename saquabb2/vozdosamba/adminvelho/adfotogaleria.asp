...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="25"><div align="center"><span class="texto">Adicionar Foto na Galeria </span></div></td>
  </tr>
  <tr>
        ...
        <% if (Session("nomefoto") <> "") then%>
				...
				<tr>
                  <td height="29" colspan="4" class="titur"><div align="center" class="textoCopy">
                    <div align="center">Erro: Escolha Galeria</div>
                  </div></td>
                </tr>
				<% End If %>

				<tr>
                  <td class="texto">Galeria:</td>
