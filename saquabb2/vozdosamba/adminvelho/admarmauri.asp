                    ...
                    <td>
                      ...
                      <form action="admar.asp" method="POST" enctype="multipart/form-data" target="_self" id=form>
                        ...
                        <div align="center">
                          <center>
                            <br>
                            <span class="titur">ATUALIZA</span><br>
                            <br>
                            <table width="50%" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000" class="tbl">
                              <tr>
                                <td width="379" valign="top" class="texto">Foto:</td>
                              ...
                              <tr>
                                <td class="texto">Coment&aacute;rios:</td>
