...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="25"><div align="center"><span class="texto">Adicionar Foto em Not&iacute;cia </span></div></td>
  </tr>
  <tr>
    <td><FORM ACTION="adfoto.asp" METHOD="POST" enctype="multipart/form-data" target="_self">
      <br>
      <table width="358" height="321" border="0" align="center" cellpadding="5" cellspacing="0" class="tbl">
        <% if (Session("nomefoto") = "") then%>
		<tr>
          <td class="texto">Foto:</td>
          <td height="46" colspan="3"><br>
              <input name="foto" type=FILE class="form1" id="foto4" size=30>
              <br>
              <input name="upload" type="submit" class="form1" id="upload4" value="upload"></td>
        </tr>
		<% End If %>
		<% if (Session("nomefoto") <> "") then%>
        <tr>
          <td class="texto"><div align="left">Not&iacute;cia:</div></td>
          <td height="46" colspan="3">
            <select name="CodNoticia" class="form1" id="select3">
...
%>
        ...
        <tr>
          <td><div align="left"><span class="texto">Descri&ccedil;&atilde;o:</span>:</div></td>
          <td height="46" colspan="3"><input name="descricao" type="text" class="form1" id="descricao4" size="50"></td>
        </tr>
        <tr>
          <td class="texto">Fot&oacute;grafo:</td>
          <td height="46" colspan="3"><input name="fotografo" type="text" class="form1" id="fotografo4" size="50"></td>
        </tr>
        <% if (Session("nomefoto") <> "") then%>
		<tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td width="334" height="34" colspan="3">
            <INPUT name="Submit" TYPE=SUBMIT class="form1" id="Submit4" VALUE="Enviar">
          </td>
        </tr>
		<% End If %>
      </table>
