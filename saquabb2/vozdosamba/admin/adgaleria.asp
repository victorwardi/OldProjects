...
<table width="564" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="564" height="25"><div align="center"></div></td>
  </tr>
  <tr>
        ...
        <div align="center">
          <center>
            <table width="100%" border="0" cellpadding="5" cellspacing="5" class="tbl">
              <tr>
                <td width="44%" valign="top" class="texto"><img src="../images/TITULO-GALERIA.jpg" width="200" height="27"></td>
                <td width="56%"><input name="titulo" type="text" class="form1" id="titulo5" value="<%=titulo%>" size="50"></td>
              </tr>
              <tr>
                <td height="111" valign="top" class="texto"><p><img src="../images/FOTO-MINIATURA.jpg" width="200" height="27"></p>
                </td>
                <td valign="top"><p>
                  <input name="foto" type="file" class="form1" id="foto5" size="30">
                  </p>
                  <p>
