...
fotos.Source = "SELECT * FROM midia ORDER BY Cod DESC"
fotos.CursorType = 0
					...
					<td width="530" height="348" align="left" valign="top" bgcolor="#FFFFFF"><table width="@@(width)@@" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <th height="337" colspan="2" align="center" valign="top" scope="col"><table width="530" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <th width="364" scope="col"><div align="left"><img src="imagens/retalhos/midia.jpg" width="200" height="40"></div></th>
...
%>
                                              <td width="109" height="75"><table width="109" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#E0E0D7">
                                                  <tr>
                                                    <th width="109" align="center" valign="middle" scope="col"><div class=ch id=Fl style="width:100;height:75; margin-right:9px;text-align:center;"> <a href="fotos/midia/<%=(fotos.Fields.Item("Foto").Value)%>" onclick="return enlarge('fotos/midia/foto_<%=(fotos.Fields.Item("Foto").Value)%>',event,'center',512,384);"> <img src="fotos/midia/<%=(fotos.Fields.Item("Foto").Value)%>" width="100" height="75"   border="0" class="brd_laranja"></a> </div>
