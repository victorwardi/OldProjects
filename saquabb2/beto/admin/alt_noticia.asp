...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "data2|value|titulo2|value|materia|value|resumo|value"
  MM_columnsStr = "data|',none,''|titulo|',none,''|materia|',none,''|resumo|',none,''"
...
Rsnot.Source = "SELECT * FROM noticia WHERE CodNoticia = " + Replace(Rsnot__MMColParam, "'", "''") + " ORDER BY CodNoticia DESC"
Rsnot.CursorType = 0
...
<table width="463" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="459" height="25" bgcolor="#FF9900"><div align="center"><span class="tur style1">:: Alterar Not&iacute;cia :: </span></div></td>
  </tr>
  <tr>
    <td><form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1" target="_self" id=form><div align="center"><center>
          <table width="459" border="0" cellpadding="5" cellspacing="0" class="tbl">
                <tr>
                  <td valign="top"><font size="2" face="Verdana">Data:</font></td>
                  <td><span class="desc">
                    <input name="data2" type="text" id="data5" value="<%=(Rsnot.Fields.Item("data").Value)%>" size="13">
                  </span></td>
                </tr>
                <tr>
                  <td valign="top">Titulo:</td>
                  <td><input name="titulo2" type="text" id="titulo5" value="<%=(Rsnot.Fields.Item("titulo").Value)%>" size="50"></td>
                </tr>
                <tr>
...
%></td>
                ...
                <tr>
                  ...
                  <td><textarea name="resumo" cols="45" rows="4" id="textarea10" style="border-style: solid; border-width: 2"><%=(Rsnot.Fields.Item("resumo").Value)%></textarea></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                </tr>
