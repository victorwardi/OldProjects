...
If MM_valUsername <> "" Then
  ...
  MM_rsUser.ActiveConnection = MM_con_bb_STRING
...
<HTML>
<HEAD>
<TITLE>Administra&ccedil;&atilde;o Erisberto.com</TITLE>
...
<img src="../images/spacer.gif" width="1" height="5"><table width="484" border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  <tr>
    <td width="484" height="182" bgcolor="#FFFFFF"><form action="<%=MM_LoginAction%>" method="POST" name="login" id="login">
      <table width="500" height="400" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" valign="bottom" background="login.jpg"><span class="menulk style9"></span>            <table width="263" border="0" align="left" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="109" height="18" class="desc style7"><!--DWLayoutEmptyCell-->&nbsp;</td>
            ...
            <tr>
              ...
              <td width="174"><input name="submit2" type = "submit" value = "Entrar"></td>
            </tr>
            <tr>
