...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "listar_noticia.asp"
...
RsAltera.Source = "SELECT * FROM noticia ORDER BY CodNoticia DESC"
...
<table width="741" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="739" height="25" bgcolor="#FF9900"><div align="center"><span class="tur"> <span class="style2"><span class="style1">:: Alterar  Not&iacute;cia :: </span></span></span></div></td>
  </tr>
  <tr>
    <td align="left">
...
%>
      <tr>
        <td width="36" height="18" align="center" valign="middle"><input name="MM_recordId" type="radio" value="<%=(RsAltera.Fields.Item("CodNoticia").Value)%>"></td>
          <td width="703"> <a href="alt_noticia.asp?CodNot=<%=(RsAltera.Fields.Item("CodNoticia").Value)%>" class="menulk"><%=(RsAltera.Fields.Item("data").Value)%>- <%=(RsAltera.Fields.Item("titulo").Value)%></a></td>
      </tr>
      <% 
