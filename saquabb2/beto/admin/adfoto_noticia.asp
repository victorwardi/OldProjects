...
If (Upload.Form("Upload")<>"") Then
	...
	File.SaveAs pasta & "fotos\noticia\original\" & File.OriginalFileName
...
Rs_foto.ActiveConnection = MM_con_bb_STRING
...
<table width="464" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
  <tr>
    <td width="795" height="24" bgcolor="#FF9900"><div align="center" class="style23">
      <div align="center" class="style26">:: Adicionar Foto À Noticia :: </div>
    </div></td>
  </tr>
  <tr>
        ...
        <tr>
          ...
          <td height="46" colspan="3">
            <select name="CodNoticia" id="select3">
              <option selected>Escolha uma notícia</option>
              <% 
...
%>
		...
		<tr>
          ...
          <td><table width="403" border="0" cellpadding="0" cellspacing="0" class="tbl">
              ...
              <tr>
                <td height="36" valign="top"><img src="../fotos/noticia/foto_<% =Session("nomefoto")%>" alt="" width="100" height="75" border="0"></td>
                </tr>
