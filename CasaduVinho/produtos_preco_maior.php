...
mysql_select_db($database_ConBD, $ConBD);
$query_RsProdutos = "SELECT * FROM produtos ORDER BY valor DESC";
            ...
            <tr>
              <th align="left" scope="row"><!-- InstanceBeginEditable name="conteudo" -->
                <table width="96%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <th height="22" align="left" valign="top" class="txt_vinho_12px_normal" scope="row">Produtos ordenados pelos <span class="txt_vinho_12px">maiores pre&ccedil;os</span>.</th>
                  </tr>
                  <tr>
                    <th align="left" valign="top" class="txt_vinho_12px_normal" scope="row">Ordenar por: <a href="produtos_preco_menor.php">Menor Pre&ccedil;o</a></th>
                  </tr>
                  <tr>
                    <th align="left" valign="top" scope="row">&nbsp;</th>
                  </tr>
