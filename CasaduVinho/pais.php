...
if (isset($_GET['pais'])) {
  $colname_RsProdutos = $_GET['pais'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsProdutos = sprintf("SELECT * FROM produtos WHERE pais = %s ORDER BY id DESC", GetSQLValueString($colname_RsProdutos, "text"));
            ...
            <tr>
              <th align="left" scope="row"><!-- InstanceBeginEditable name="conteudo" -->
                <table width="96%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <th align="left" valign="top" scope="row"> <?php if ($totalRows_RsProdutos > 0) { // Show if recordset not empty ?>
                        <div> <span class="txt_vinho_12px"><?php echo $totalRows_RsProdutos ?></span><span class="txt_vinho_12px_normal"> produtos listados  referente ao pa&iacute;s:</span> <span class="txt_vinho_12px"><?php echo $_GET['pais']; ?></span> </div>
                  ...
                  <tr>
                    <th align="center" scope="row"> <?php if ($totalRows_RsProdutos == 0) { // Show if recordset empty ?>
                        <div class="txt_vinho_12px"><span class="txt_vinho_12px_normal">N&atilde;o h&aacute; nenhum produto cadastrado para o pa&iacute;s:</span> <?php echo $_GET['pais']; ?></div>
