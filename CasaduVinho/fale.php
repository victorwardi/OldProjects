            ...
            <tr>
              <th align="left" scope="row"><!-- InstanceBeginEditable name="conteudo" -->
                <table width="96%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <th height="39" align="left" scope="row"><img src="img/titulos/faleconosco.jpg" alt="Destaques" width="520" height="39" border="0" /></th>
                  </tr>
                  <tr>
                    <th scope="row">&nbsp;</th>
                  </tr>
                  <tr>
                    <th align="left" scope="row"><span class="txt_vinho_12px_normal">Para entrar em contato conosco utilize o formul&aacute;rio abaixo, ou se preferir:</span><br />
                      <br />
                      <span class="txt_vinho_12px">Email: </span><span class="txt_vinho_12px_normal">contato@cantodovinho.com.br</span><br />
                      <br />
                      <span class="txt_vinho_12px">Telefone:</span><span class="txt_vinho_12px_normal"> (21) 2688 4158</span></th>
                  </tr>
                  <tr>
                    <th scope="row">&nbsp;</th>
                  </tr>
                  <tr>
                    <th scope="row"><table width="100%" border="0" cellpadding="6" cellspacing="2" bordercolor="#FFFFFF" class="fundo_tabela2">
                      <tr>
                        <th height="54" align="left" valign="top" scope="col"><div id="conteudo_interno" class="left">
                          ...
                          <div>
                              <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" onsubmit="MM_validateForm('Nome','','R','Cidade','','R','Email','','RisEmail','Telefone','','R');return document.MM_returnValue">
                                ...
                                <label for="Endere&ccedil;o" class="txt_novidades_data">Endere&ccedil;o:</label>
                                <input name="Endere&ccedil;o" type="text" tabindex="2" value="" size="37" maxlength="200" class="textbox" />
                                ...
                                <label for="Mensagen" class="txt_novidades_data">Mensagem:</label>
                                <textarea name="Mensagem" cols="37" rows="5" class="textbox" tabindex="7"></textarea>
