...
// Filter
$tfi_listprodutos3 = new TFI_TableFilter($conn_ConBD, "tfi_listprodutos3");
$tfi_listprodutos3->addColumn("produtos.id", "NUMERIC_TYPE", "id", "=");
$tfi_listprodutos3->addColumn("produtos.foto", "NUMERIC_TYPE", "foto", "=");
$tfi_listprodutos3->addColumn("produtos.nome", "STRING_TYPE", "nome", "%");
$tfi_listprodutos3->addColumn("produtos.valor", "STRING_TYPE", "valor", "%");
$tfi_listprodutos3->addColumn("produtos.promocao", "STRING_TYPE", "promocao", "%");
...
$tso_listprodutos3->addColumn("produtos.foto");
$tso_listprodutos3->addColumn("produtos.nome");
$tso_listprodutos3->addColumn("produtos.valor");
$tso_listprodutos3->addColumn("produtos.promocao");
...
$objDynamicThumb1->setRenameRule("{rsprodutos1.foto}");
...
<style type="text/css">
  ...
  .KT_col_foto {width:50px; overflow:hidden;}
  ...
  <tr>
    ...
    <td width="619" align="center" valign="top"><!-- InstanceBeginEditable name="conteudo" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
        ...
        <tr>
          <td height="19" align="center" valign="top"><?php
                  ...
                  <table align="center" cellpadding="2" cellspacing="0" class="borda_cinza" id="painel">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#CCCCCC" class="fonte" id="foto"> <a href="<?php echo $tso_listprodutos3->getSortLink('produtos.foto'); ?>">Foto</a> </th>
                        <th align="center" bgcolor="#CCCCCC" class="fonte" id="nome"> <a href="<?php echo $tso_listprodutos3->getSortLink('produtos.nome'); ?>">Nome</a> </th>
                        <th align="center" bgcolor="#CCCCCC" class="fonte" id="valor"> <a href="<?php echo $tso_listprodutos3->getSortLink('produtos.valor'); ?>">Valor</a> </th>
                        <th align="center" bgcolor="#CCCCCC" class="fonte" id="promocao"> <a href="<?php echo $tso_listprodutos3->getSortLink('produtos.promocao'); ?>">Promoção</a> </th>
...
?>
                        <tr class="KT_row_filter">
                          <td>&nbsp;</td>
                          <td><input type="text" name="tfi_listprodutos3_foto" id="tfi_listprodutos3_foto" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listprodutos3_foto']); ?>" size="20" maxlength="100" /></td>
                          <td><input type="text" name="tfi_listprodutos3_nome" id="tfi_listprodutos3_nome" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listprodutos3_nome']); ?>" size="20" maxlength="100" /></td>
                          <td><input type="text" name="tfi_listprodutos3_valor" id="tfi_listprodutos3_valor" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listprodutos3_valor']); ?>" size="20" maxlength="20" /></td>
                          <td><select name="tfi_listprodutos3_promocao" id="tfi_listprodutos3_promocao">
                              <option value="sim" <?php if (!(strcmp("sim", KT_escapeAttribute(@$_SESSION['tfi_listprodutos3_promocao'])))) {echo "SELECTED";} ?>>Sim</option>
                              <option value="nao" <?php if (!(strcmp("nao", KT_escapeAttribute(@$_SESSION['tfi_listprodutos3_promocao'])))) {echo "SELECTED";} ?>>Não</option>
                            </select>                          </td>
