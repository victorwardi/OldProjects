            ...
            <tr>
              <th align="left" scope="row"><!-- InstanceBeginEditable name="conteudo" -->
                <table width="96%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <th height="39" align="left" scope="row"><img src="img/titulos/destaques.jpg" alt="Destaques" width="520" height="39" border="0" /></th>
                  </tr>
                  ...
                  <tr>
                    <th align="left" valign="top" scope="row"><?php do { ?>
                      <table width="100%" border="0" cellspacing="3" cellpadding="0">
                        ...
                        <tr>
                          <td align="left" valign="top" class="txtValorProduto">R$ <?php echo number_format($row_RsProdutos['valor'],2,",","."); ?></td>
                        </tr>
                        <tr>
