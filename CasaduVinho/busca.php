...
if (isset($_GET['busca'])) {
  $colname_RsProdutos = $_GET['busca'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsProdutos = sprintf("SELECT * FROM produtos WHERE nome LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_RsProdutos . "%", "text"));
            ...
            <tr>
              <th align="left" scope="row"><!-- InstanceBeginEditable name="conteudo" -->
                <table width="96%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <th height="39" align="left" scope="row"><img src="img/titulos/pesquisar.jpg" alt="Destaques" width="520" height="39" border="0" /></th>
                  </tr>
                  ...
                  <tr>
                    <th align="center" valign="top" scope="row"> <?php if ($totalRows_RsProdutos > 0) { // Show if recordset not empty ?>
                        <div class="txt_vinho_12px_normal">Foram encontrados <span class="txt_vinho_12px"><?php echo $totalRows_RsProdutos ?></span> produtos na pesquisa por <span class="txt_vinho_12px">&quot;<?php echo $_GET['busca'];?>&quot;</span>.</div>
                        <?php } // Show if recordset not empty ?></th>
                  </tr>
                  <tr>
                    <th align="center" valign="top" scope="row"> <?php if ($totalRows_RsProdutos == 0) { // Show if recordset empty ?>
                          <div class="txt_vinho_12px_normal">Desculpe, sua pesquisa por<span class="txt_vinho_12px"> &quot;<?php echo $_GET['busca'];?>&quot; </span> n&atilde;o gerou resultados.</div>
