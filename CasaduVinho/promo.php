...
mysql_select_db($database_ConBD, $ConBD);
$query_RsProdutos = "SELECT * FROM produtos WHERE promocao = 'sim' ORDER BY id DESC";
            ...
            <tr>
              <th align="left" scope="row"><!-- InstanceBeginEditable name="conteudo" -->
                <table width="96%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <th height="39" align="left" scope="row"><img src="img/titulos/promocoes.jpg" alt="Destaques" width="520" height="39" border="0" /></th>
                  </tr>
