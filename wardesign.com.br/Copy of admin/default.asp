...
If MM_valUsername <> "" Then
  ...
  MM_rsUser.ActiveConnection = MM_conex_STRING
  ...
  <tr>
    <td width="791" height="182" bgcolor="#FFFFFF"><form action="<%=MM_LoginAction%>" method="POST" name="login" id="login">
      <table width="400" height="300" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center" valign="middle" background="/admin/fundo_login.jpg"><table width="263" border="0" align="center" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
            ...
            <tr>
              <td height="18"><span class="desc style7"><strong>Senha:</strong></span></td>
