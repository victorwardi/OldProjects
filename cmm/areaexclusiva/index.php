...
if (isset($_POST['login'])) {
  ...
  $LoginRS__query=sprintf("SELECT login, senha FROM vereadores WHERE login=%s AND senha=%s",
            ...
            <td><div align="left">
              <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="586" height="30" bgcolor="#657D99"><span class="txt_03"><a name="topo" id="topo"></a></span><img src="../img/titulo_areaexclusiva_01.gif" width="147" height="19" /></td>
                </tr>
              </table>
            </div></td>
          </tr>
 ...
 tipo=''; 
                      ...
                      <tr>
                        <td height="38" align="center"><div align="left">
                          <div id="erro"><?php if (isset ($_GET['erro']) ){?>
                            <div align="center"><span class="select_link_01">Usu&aacute;rio ou senha inv&aacute;lidos!</span>
                                <?php } ?>
                            </div>
                          </div>
                        </div></td>
                        ...
                        <td><div align="left" class="txt_01">
                          <form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
                            <table cellspacing="5" cellpadding="0" width="566" 
                              ...
                              <tbody>
                                <tr valign="top">
                                  <td width="12%" class="txt_03"><strong>Login:</strong></td>
                                  <td width="88%"><input class="txt_01" size="95" 
                                name="login" id="login" /></td>
                                </tr>
                                <tr valign="top">
                                ...
                                <tr valign="top">
                                  <td class="txt_03"><strong>Senha:</strong></td>
                                  <td><input 
                                name="senha" type="password" class="txt_01" size="95" id="senha" /></td>
                                </tr>
                                <tr valign="top">
                                  <td colspan="2" height="20"><div align="left"></div></td>
                                </tr>
                                <tr valign="top">
                                  <td colspan="2" height="20"><input name="enviar" type="submit" class="bt_01" id="enviar" value="Entrar" />
                                  </td>
                                </tr>
                                <tr valign="top">
                                  <td colspan="2" height="20"><div align="left"></div></td>
                                ...
                                <tr valign="top">
                                  <td colspan="2" height="20"><div align="left">A &Aacute;rea Exclusiva &eacute; um Sistema Interno Administrativo da C&acirc;mara  Municipal de Mangaratiba.</div></td>
                                </tr>
                              </tbody>
                            </table>
                                                    </form>
