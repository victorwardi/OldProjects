...
// Filter
$tfi_listfotosvereadores2 = new TFI_TableFilter($conn_ConBD, "tfi_listfotosvereadores2");
$tfi_listfotosvereadores2->addColumn("fotosvereadores.fotoID", "NUMERIC_TYPE", "fotoID", "=");
$tfi_listfotosvereadores2->addColumn("fotosvereadores.imagem", "NUMERIC_TYPE", "imagem", "=");
$tfi_listfotosvereadores2->addColumn("fotosvereadores.descricao", "STRING_TYPE", "descricao", "%");
$tfi_listfotosvereadores2->Execute();

// Sorter
$tso_listfotosvereadores2 = new TSO_TableSorter("rsfotosvereadores1", "tso_listfotosvereadores2");
$tso_listfotosvereadores2->addColumn("fotosvereadores.fotoID");
$tso_listfotosvereadores2->addColumn("fotosvereadores.imagem");
$tso_listfotosvereadores2->addColumn("fotosvereadores.descricao");
$tso_listfotosvereadores2->setDefault("fotosvereadores.fotoID DESC");
$tso_listfotosvereadores2->Execute();

// Navigation
$nav_listfotosvereadores2 = new NAV_Regular("nav_listfotosvereadores2", "rsfotosvereadores1", "../", $_SERVER['PHP_SELF'], 20);
...
$maxRows_rsfotosvereadores1 = $_SESSION['max_rows_nav_listfotosvereadores2'];
$pageNum_rsfotosvereadores1 = 0;
if (isset($_GET['pageNum_rsfotosvereadores1'])) {
  $pageNum_rsfotosvereadores1 = $_GET['pageNum_rsfotosvereadores1'];
}
$startRow_rsfotosvereadores1 = $pageNum_rsfotosvereadores1 * $maxRows_rsfotosvereadores1;

// Defining List Recordset variable
$NXTFilter_rsfotosvereadores1 = "1=1";
if (isset($_SESSION['filter_tfi_listfotosvereadores2'])) {
  $NXTFilter_rsfotosvereadores1 = $_SESSION['filter_tfi_listfotosvereadores2'];
}
// Defining List Recordset variable
$NXTSort_rsfotosvereadores1 = "fotosvereadores.fotoID DESC";
if (isset($_SESSION['sorter_tso_listfotosvereadores2'])) {
  $NXTSort_rsfotosvereadores1 = $_SESSION['sorter_tso_listfotosvereadores2'];
}
mysql_select_db($database_ConBD, $ConBD);

$colname_rsfotosvereadores1 = "-1";
if (isset($_GET['vereadorID'])) {
  $colname_rsfotosvereadores1 = $_GET['vereadorID'];
}
$query_rsfotosvereadores1 = "SELECT fotosvereadores.fotoID, fotosvereadores.imagem, fotosvereadores.descricao FROM fotosvereadores WHERE {$NXTFilter_rsfotosvereadores1} AND fotosvereadores.vereadorId= {$colname_rsfotosvereadores1} ORDER BY {$NXTSort_rsfotosvereadores1}";
$query_limit_rsfotosvereadores1 = sprintf("%s LIMIT %d, %d", $query_rsfotosvereadores1, $startRow_rsfotosvereadores1, $maxRows_rsfotosvereadores1);
$rsfotosvereadores1 = mysql_query($query_limit_rsfotosvereadores1, $ConBD) or die(mysql_error());
$row_rsfotosvereadores1 = mysql_fetch_assoc($rsfotosvereadores1);

if (isset($_GET['totalRows_rsfotosvereadores1'])) {
  $totalRows_rsfotosvereadores1 = $_GET['totalRows_rsfotosvereadores1'];
} else {
  $all_rsfotosvereadores1 = mysql_query($query_rsfotosvereadores1);
  $totalRows_rsfotosvereadores1 = mysql_num_rows($all_rsfotosvereadores1);
}
$totalPages_rsfotosvereadores1 = ceil($totalRows_rsfotosvereadores1/$maxRows_rsfotosvereadores1)-1;
//End NeXTenesio3 Special List Recordset

$nav_listfotosvereadores2->checkBoundries();

// Show Dynamic Thumbnail
$objDynamicThumb2 = new tNG_DynamicThumbnail("../", "KT_thumbnail1");
$objDynamicThumb2->setFolder("../uploads/fotos/");
$objDynamicThumb2->setRenameRule("{rsfotosvereadores1.imagem}");
$objDynamicThumb2->setResize(50, 40, false);
                        ...
                        <td width="260" height="160" class="txt_03"><table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
                          ...
                          <tr>
                            <td align="left" class="select_link_01"><table width="100%" border="0" cellspacing="0" cellpadding="6">
                              ...
                              <tr>
                                <td align="left" class="select_link_01">&raquo; Editar/excluir foto</td>
                              </tr>
                              <tr>
                          ...
                          <tr>
                            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td><span class="select_link_01">Fotos
                                    <?php
  $nav_listfotosvereadores2->Prepare();
  require("../includes/nav/NAV_Text_Statistics.inc.php");
?>
                                    </span>
                                  <div class="KT_tng" id="listfotosvereadores2">
                                      <div class="KT_tnglist">
                                      <form action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" method="post" id="form1">
                                        <div class="KT_options"> <a href="<?php echo $nav_listfotosvereadores2->getShowAllLink(); ?>"><?php echo NXT_getResource("Show"); ?>
                                          <?php 
  // Show IF Conditional region1
  if (@$_GET['show_all_nav_listfotosvereadores2'] == 1) {
?>
                                            <?php echo $_SESSION['default_max_rows_nav_listfotosvereadores2']; ?>
                                            <?php 
...
?>
  ...
  if (@$_SESSION['has_filter_tfi_listfotosvereadores2'] == 1) {
?>
                  <a href="<?php echo $tfi_listfotosvereadores2->getResetFilterLink(); ?>"><?php echo NXT_getResource("Reset filter"); ?></a>
                  <?php 
  // else Conditional region2
  } else { ?>
                  <a href="<?php echo $tfi_listfotosvereadores2->getShowFilterLink(); ?>"><?php echo NXT_getResource("Show filter"); ?></a>
                  <?php } 
...
?>
                                              <tr class="KT_row_filter">
                                                <td>&nbsp;</td>
                                                <td><input type="text" name="tfi_listfotosvereadores2_imagem" id="tfi_listfotosvereadores2_imagem" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listfotosvereadores2_imagem']); ?>" size="20" maxlength="255" /></td>
                                                <td><input type="text" name="tfi_listfotosvereadores2_descricao" id="tfi_listfotosvereadores2_descricao" value="<?php echo KT_escapeAttribute(@$_SESSION['tfi_listfotosvereadores2_descricao']); ?>" size="20" maxlength="255" /></td>
                                                <td><input type="submit" name="tfi_listfotosvereadores2" value="<?php echo NXT_getResource("Filter"); ?>" /></td>
                                              </tr>
                                              <?php } 
...
?>
                                          ...
                                          <tbody>
                                            <?php if ($totalRows_rsfotosvereadores1 == 0) { // Show if recordset empty ?>
                                              <tr>
                                                <td colspan="4"><?php echo NXT_getResource("Não há fotos cadastradas."); ?></td>
                                              </tr>
                                              <?php } // Show if recordset empty ?>
                                            <?php if ($totalRows_rsfotosvereadores1 > 0) { // Show if recordset not empty ?>
                                              <?php do { ?>
                                                <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                                                  <td bgcolor="#FFFFCC"><input type="checkbox" name="kt_pk_fotosvereadores" class="id_checkbox" value="<?php echo $row_rsfotosvereadores1['fotoID']; ?>" />
                                                      <input type="hidden" name="fotoID" class="id_field" value="<?php echo $row_rsfotosvereadores1['fotoID']; ?>" />                                                  </td>
                                                  <td bgcolor="#FFFFCC"><div align="center"><img src="<?php echo $objDynamicThumb2->Execute(); ?>" border="0" /></div></td>
                                                  <td bgcolor="#FFFFCC"><div class="txt_01"><?php echo KT_FormatForList($row_rsfotosvereadores1['descricao'], 20); ?></div></td>
                                                  <td bgcolor="#FFFFCC"><a class="KT_edit_link" href="adicionarfoto.php?fotoID=<?php echo $row_rsfotosvereadores1['fotoID']; ?>&amp;KT_back=1"><?php echo NXT_getResource("edit_one"); ?></a> <a class="KT_delete_link" href="#delete"><?php echo NXT_getResource("delete_one"); ?></a> </td>
                                                </tr>
                                                <?php } while ($row_rsfotosvereadores1 = mysql_fetch_assoc($rsfotosvereadores1)); ?>
...
mysql_free_result($rsfotosvereadores1);
?>
