...
$ins_vereadores->registerTrigger("END", "Trigger_Default_Redirect", 99, "editarinfo.php");
...
$upd_vereadores->registerTrigger("END", "Trigger_Default_Redirect", 99, "editarinfo.php");
...
$del_vereadores->registerTrigger("END", "Trigger_Default_Redirect", 99, "editarinfo.php");
                                  ...
                                  <tr>
                                    <td height="18" class="txt_01"><div align="left">
                                      <table width="258" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                          <td width="256" class="txt_01"><div class="classe1 style1" id="meutexto">
                                              <div align="justify">
                                                <p><strong><br />
                        ...
                        <td width="260" height="160" class="txt_03"><table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
                          ...
                          <tr>
                            <td align="left" class="select_link_01"><table width="100%" border="0" cellspacing="0" cellpadding="6">
                              ...
                              <tr>
                                <td align="left" class="select_link_01">&raquo; Editar informa&ccedil;&otilde;es pessoais</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="left" class="select_link_01">&raquo; <a href="editarrfoto.php?vereadorID=<?php echo $row_RsVereador['vereadorID']; ?>">Editar/excluir foto</a></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                  ...
                                  <tr>
                                    <td><div class="KT_tng"><div class="KT_tngform">
...
?>
                                              <table cellpadding="2" cellspacing="0" class="titulo_01">
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="nome_<?php echo $cnt1; ?>">Nome:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" align="left" class="KT_th"><input name="nome_<?php echo $cnt1; ?>" type="text" class="txt_01" id="nome_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsvereadores['nome']); ?>" size="45" maxlength="255" /></td>
                                                  </tr>
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="apelido_<?php echo $cnt1; ?>">Como &eacute; conhecido:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" align="left" class="KT_th"><input name="apelido_<?php echo $cnt1; ?>" type="text" class="txt_01" id="apelido_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsvereadores['apelido']); ?>" size="32" maxlength="255" /></td>
                                                  </tr>
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="partido_<?php echo $cnt1; ?>">Partido:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" align="left" class="KT_th"><input name="partido_<?php echo $cnt1; ?>" type="text" class="txt_01" id="partido_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsvereadores['partido']); ?>" size="32" maxlength="200" /></td>
                                                  </tr>
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="aniversario_<?php echo $cnt1; ?>">Anivers&aacute;rio:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" align="left" class="KT_th"><input name="aniversario_<?php echo $cnt1; ?>" type="text" class="txt_01" id="aniversario_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsvereadores['aniversario']); ?>" size="20" maxlength="50" /></td>
                                                  </tr>
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="participacaoNaCamara_<?php echo $cnt1; ?>">Participa&ccedil;&atilde;o na C&acirc;mara:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" align="left" class="KT_th"><textarea name="participacaoNaCamara_<?php echo $cnt1; ?>" cols="28" rows="8" id="participacaoNaCamara_<?php echo $cnt1; ?>"><?php echo KT_escapeAttribute($row_rsvereadores['participacaoNaCamara']); ?></textarea></td>
                                                  </tr>
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="homenageados_<?php echo $cnt1; ?>">Homenageados:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" align="left" class="KT_th"><textarea name="homenageados_<?php echo $cnt1; ?>" cols="28" rows="8" id="homenageados_<?php echo $cnt1; ?>"><?php echo KT_escapeAttribute($row_rsvereadores['homenageados']); ?></textarea></td>
                                                  </tr>
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="telefoneGabinete_<?php echo $cnt1; ?>">Telefone do Gabinete:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" align="left" class="KT_th"><input name="telefoneGabinete_<?php echo $cnt1; ?>" type="text" class="txt_01" id="telefoneGabinete_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsvereadores['telefoneGabinete']); ?>" size="32" maxlength="50" /></td>
                                                  </tr>
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="telefone_<?php echo $cnt1; ?>">Telefone:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" align="left" class="KT_th"><input name="telefone_<?php echo $cnt1; ?>" type="text" class="txt_01" id="telefone_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsvereadores['telefone']); ?>" size="32" maxlength="50" /></td>
                                                  </tr>
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="site_<?php echo $cnt1; ?>">Web Site:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" align="left" class="KT_th"><input name="site_<?php echo $cnt1; ?>" type="text" class="txt_01" id="site_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsvereadores['site']); ?>" size="45" maxlength="200" /></td>
                                                  </tr>
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="email_<?php echo $cnt1; ?>">Email:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" align="left" class="KT_th"><input name="email_<?php echo $cnt1; ?>" type="text" class="txt_01" id="email_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsvereadores['email']); ?>" size="40" maxlength="200" /></td>
                                                  </tr>
                                                <tr>
                                                  <td align="left" class="KT_th"><label for="foto_<?php echo $cnt1; ?>">Foto:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
            <td colspan="2" class="KT_th"><label for="foto_<?php echo $cnt1; ?>"></label>
<input name="foto_<?php echo $cnt1; ?>" type="file" class="txt_01" id="foto_<?php echo $cnt1; ?>" size="32" /></td>
            </tr>

                                                <tr>
                                                  <td align="left" class="KT_th"><label for="senha_<?php echo $cnt1; ?>">Alterar Senha:</label></td>
                                                  <td align="left">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2" class="KT_th"><input name="senha_<?php echo $cnt1; ?>" type="text" class="txt_01" id="senha_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsvereadores['senha']); ?>" size="32" maxlength="100" /></td>
                                                  </tr>
                                              </table>
