...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                        ...
                        <td width="260" height="160" class="txt_03"><table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
                          ...
                          <tr>
                            <td align="left" class="select_link_01"><table width="100%" border="0" cellspacing="0" cellpadding="6">
                              <tr>
                                <td align="left" class="select_link_01">&raquo; In&iacute;cio</td>
                              </tr>
                              <tr>
                          ...
                          <tr>
                            <td height="18" align="left" bgcolor="#657D99" class="bt_01">Informa&ccedil;&otilde;es Pessoais</td>
                          </tr>
                          <tr>
                            <td align="left">&nbsp;</td>
                          </tr>
                      ...
                      <tr>
                        <td width="260" valign="top" class="txt_03"><table width="258" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="256" class="txt_01"><div class="classe1 style1" id="meutexto">
                                  <div align="justify">
                                    <p><strong>Nome: </strong><?php echo $row_RsVereador['nome']; ?><strong><br />
                                        <br />
...
<?php echo $row_RsVereador['participacaoNaCamara']; ?><br />
                                ...
                                <tr>
                                  <td class="txt_01"><div align="left"><a href="#"></a>
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td align="left"><a href="../vereadores/noticia.php?novidadeId=<?php echo $row_RsNoticias['novidadeId']; ?>&vereadorID=<?php echo $row_RsNoticias['vereadorID']; ?>"><span class="select_link_01">&raquo;</span> <?php echo $row_RsNoticias['titulo']; ?></a></td>
                                            </tr>
                                            <tr>
                                              <td>&nbsp;</td>
                                            </tr>
                            ...
                            <tr>
                              <td height="50" class="txt_01">&nbsp;</td>
                            </tr>
                            <tr>
                              <td height="18" align="left" class="bt_01"><strong>Galeria de Fotos </strong></td>
                            </tr>
                            <tr>
