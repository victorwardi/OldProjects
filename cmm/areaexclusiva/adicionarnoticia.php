...
$ins_novidadesvereadores = new tNG_multipleInsert($conn_ConBD);
$tNGs->addTransaction($ins_novidadesvereadores);
// Register triggers
$ins_novidadesvereadores->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Insert1");
$ins_novidadesvereadores->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$ins_novidadesvereadores->registerTrigger("END", "Trigger_Default_Redirect", 99, "adicionarnoticia.php");
$ins_novidadesvereadores->registerTrigger("AFTER", "Trigger_ImageUpload", 97);
// Add columns
$ins_novidadesvereadores->setTable("novidadesvereadores");
$ins_novidadesvereadores->addColumn("vereadorID", "STRING_TYPE", "POST", "vereadorID");
$ins_novidadesvereadores->addColumn("titulo", "STRING_TYPE", "POST", "titulo");
$ins_novidadesvereadores->addColumn("materia", "STRING_TYPE", "POST", "materia");
$ins_novidadesvereadores->addColumn("data", "STRING_TYPE", "POST", "data");
$ins_novidadesvereadores->addColumn("imagem", "FILE_TYPE", "FILES", "imagem");
$ins_novidadesvereadores->setPrimaryKey("novidadeId", "NUMERIC_TYPE");

// Make an update transaction instance
$upd_novidadesvereadores = new tNG_multipleUpdate($conn_ConBD);
$tNGs->addTransaction($upd_novidadesvereadores);
// Register triggers
$upd_novidadesvereadores->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_novidadesvereadores->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_novidadesvereadores->registerTrigger("END", "Trigger_Default_Redirect", 99, "adicionarnoticia.php");
$upd_novidadesvereadores->registerTrigger("AFTER", "Trigger_ImageUpload", 97);
// Add columns
$upd_novidadesvereadores->setTable("novidadesvereadores");
$upd_novidadesvereadores->addColumn("vereadorID", "STRING_TYPE", "POST", "vereadorID");
$upd_novidadesvereadores->addColumn("titulo", "STRING_TYPE", "POST", "titulo");
$upd_novidadesvereadores->addColumn("materia", "STRING_TYPE", "POST", "materia");
$upd_novidadesvereadores->addColumn("data", "STRING_TYPE", "POST", "data");
$upd_novidadesvereadores->addColumn("imagem", "FILE_TYPE", "FILES", "imagem");
$upd_novidadesvereadores->setPrimaryKey("novidadeId", "NUMERIC_TYPE", "GET", "novidadeId");

// Make an instance of the transaction object
$del_novidadesvereadores = new tNG_multipleDelete($conn_ConBD);
$tNGs->addTransaction($del_novidadesvereadores);
// Register triggers
$del_novidadesvereadores->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Delete1");
$del_novidadesvereadores->registerTrigger("END", "Trigger_Default_Redirect", 99, "adicionarnoticia.php");
$del_novidadesvereadores->registerTrigger("AFTER", "Trigger_FileDelete", 98);
// Add columns
$del_novidadesvereadores->setTable("novidadesvereadores");
$del_novidadesvereadores->setPrimaryKey("novidadeId", "NUMERIC_TYPE", "GET", "novidadeId");

// Execute all the registered transactions
$tNGs->executeTransactions();

// Get the transaction recordset
$rsnovidadesvereadores = $tNGs->getRecordset("novidadesvereadores");
$row_rsnovidadesvereadores = mysql_fetch_assoc($rsnovidadesvereadores);
$totalRows_rsnovidadesvereadores = mysql_num_rows($rsnovidadesvereadores);
                        ...
                        <td width="260" height="160" class="txt_03"><table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
                          ...
                          <tr>
                            <td align="left" class="select_link_01"><table width="100%" border="0" cellspacing="0" cellpadding="6">
                              ...
                              <tr>
                                <td align="left" class="select_link_01">&raquo; Adiconar not&iacute;cia</td>
                              </tr>
                              <tr>
                          ...
                          <tr>
                            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td><div class="KT_tng"><div class="KT_tngform"><form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" enctype="multipart/form-data">
                                <?php $cnt1 = 0; ?>
                                        <?php do { ?>
                                          <?php $cnt1++; ?>
                                          <?php 
// Show IF Conditional region1 
if (@$totalRows_rsnovidadesvereadores > 1) {
?>
                                            <h2>&nbsp;</h2>
                                            <?php } 
...
?>
                                          <table cellpadding="2" cellspacing="0" class="titulo_01">
                                            ...
                                            <tr>
                                              <td colspan="2" class="KT_th"><input name="titulo_<?php echo $cnt1; ?>" type="text" class="txt_01" id="titulo_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsnovidadesvereadores['titulo']); ?>" size="40" maxlength="255" /></td>
                                              </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              <td colspan="2" class="KT_th"><textarea name="materia_<?php echo $cnt1; ?>" id="materia_<?php echo $cnt1; ?>" cols="30" rows="10"><?php echo KT_escapeAttribute($row_rsnovidadesvereadores['materia']); ?></textarea></td>
                                              </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              <td colspan="2" class="KT_th"><input name="data_<?php echo $cnt1; ?>" type="text" class="txt_01" id="data_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsnovidadesvereadores['data']); ?>" size="20" maxlength="20" /></td>
                                              </tr>
                                          </table>
                                          <input type="hidden" name="kt_pk_novidadesvereadores_<?php echo $cnt1; ?>" class="id_field" value="<?php echo KT_escapeAttribute($row_rsnovidadesvereadores['kt_pk_novidadesvereadores']); ?>" />
                                          <input type="hidden" name="vereadorID_<?php echo $cnt1; ?>" id="vereadorID_<?php echo $cnt1; ?>" value="<?php echo $row_RsVereador['vereadorID']; ?>" />
                                          <?php } while ($row_rsnovidadesvereadores = mysql_fetch_assoc($rsnovidadesvereadores)); ?>
      ...
      // else Conditional region1
                                              ...
                                              <div class="KT_operations">
                                                <input type="submit" name="KT_Insert1" value="<?php echo NXT_getResource("Insert as new_FB"); ?>" onclick="nxt_form_insertasnew(this, 'novidadeId')" />
                                              </div>
      ...
      ?>
                      ...
                      <tr>
                        <td width="260" valign="top" class="txt_03"><table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="256" height="18" align="left" valign="middle" class="bt_01"><strong >Not&iacute;cias Cadastradas</strong></td>
                            </tr>
                            <tr>
                              <td height="10" class="txt_01"><div align="left"></div></td>
                            </tr>
                            <tr>
                              <td class="txt_01"><div align="left"><a href="#"></a>
                                  <?php do { ?>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                          <td align="left"><a href="../noticia.php?"><?php echo $row_RsNoticias['titulo']; ?></a></td>
                                      </tr>
                                      <tr>
                                          <td>&nbsp;</td>
                                      </tr>
