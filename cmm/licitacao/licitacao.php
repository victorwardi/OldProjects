...
$colname_RsLicitacao = "-1";
if (isset($_GET['licitacaoID'])) {
  $colname_RsLicitacao = $_GET['licitacaoID'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsLicitacao = sprintf("SELECT * FROM licitacao WHERE licitacaoID = %s", GetSQLValueString($colname_RsLicitacao, "int"));
$RsLicitacao = mysql_query($query_RsLicitacao, $ConBD) or die(mysql_error());
                ...
                <tr>
                  <td width="160" height="470" valign="top" bgcolor="#FEDDA5"><div align="left">
                    <table width="160" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        <td height="25" class="select_link_01"><div align="left"><a href="../vereadores/index.php"><strong>Vereadores</strong></a></div></td>
                      </tr>
                      <tr>
                        <td height="25"><div align="left"></div></td>
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                                ...
                                <td width="260" valign="top" bgcolor="#DFDFDF"><div align="left">
                                  <table width="260" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="222" class="txt_01"><div align="left"><a href="print.php?licitacaoID=<?php echo $row_RsLicitacao['licitacaoID']; ?>">Vers&atilde;o para Impress&atilde;o</a></div></td>
                                      <td width="19" class="pri"><div align="right"></div></td>
                                    </tr>
                                    <tr>
                                      <td height="19"><div align="left"></div></td>
                      ...
                      <tr>
                        <td class="txt_01"><div align="left" id="meutexto">
                          <p><strong>Edital:<br />
                              </strong> <?php echo $row_RsLicitacao['titulo']; ?><strong><br />
                                  <br />
                                  <br />
                                  Data do Edital:</strong><br />
                                  <?php echo $row_RsLicitacao['data']; ?><br />
                            <br />
                            <br />
                              <strong>Objeto da Licita&ccedil;&atilde;o:</strong><br />
                              <?php echo $row_RsLicitacao['objeto']; ?></p>
                          <p><br />
                              <br />
                              <?php if ($row_RsLicitacao['pdf'] != "") { // Show if recordset not empty ?>
                                <a href="../uploads<?php echo $row_RsLicitacao['pdf']; ?>"><img src="../img/pdf_logo_01.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;<a href="../uploads<?php echo $row_RsLicitacao['pdf']; ?>" target="_blank"><strong>Download da Edital </strong></a>
