...
$colname_RsLeiPorData = "-1";
if (isset($_POST['titulo'])) {
  $colname_RsLeiPorData = $_POST['titulo'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsLeiPorData = sprintf("SELECT * FROM licitacao WHERE titulo LIKE %s", GetSQLValueString("%" . $colname_RsLeiPorData . "%", "text"));
$RsLeiPorData = mysql_query($query_RsLeiPorData, $ConBD) or die(mysql_error());
$row_RsLeiPorData = mysql_fetch_assoc($RsLeiPorData);
$totalRows_RsLeiPorData = mysql_num_rows($RsLeiPorData);
            ...
            <td><div align="left">
              <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="586" height="30" bgcolor="#657D99"><span class="txt_03"><a name="topo" id="topo"></a></span><img src="../img/titulo_processolegislativo_01.gif" width="196" height="20" /></td>
                </tr>
              </table>
            </div></td>
          </tr>
                ...
                <tr>
                  <td width="160" height="470" valign="top" bgcolor="#FEDDA5"><div align="left">
                    <table width="160" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        <td height="25" class="select_link_01"><div align="left" class="txt_01"><a href="../vereadores/index.php"><strong>Vereadores</strong></a></div></td>
                      </tr>
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        <td height="25" class="select_link_01"><div align="left"><a href="../mesadiretora/index.php"><strong>Mesa Diretora</strong></a></div></td>
                      </tr>
                      ...
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        <td height="25" class="txt_01"><div align="left"><a href="index.php"><strong>Licita&ccedil;&otilde;es</strong></a></div></td>
                      </tr>
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                                ...
                                <td width="260" valign="top" bgcolor="#DFDFDF"><div align="left">
                                  <table width="260" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="222" class="txt_01"><div align="left"><a href="../lei/print.php">Vers&atilde;o para Impress&atilde;o</a></div></td>
                                      <td width="19" class="pri"><div align="right"></div></td>
                                    </tr>
                                    <tr>
                                      <td height="19"><div align="left"></div></td>
                      ...
                      <tr>
                        <td height="38" align="left"><span class="txt_01">Sua busca pela licita&ccedil;&atilde;o </span> <span class="titulo_01"><?php echo $_POST['titulo'];?></span><span class="txt_01">, retornou </span><span class="titulo_01"><?php echo $totalRows_RsLeiPorData ?></span><span class="txt_01"> resultado(s).</span></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top" class="txt_01"><?php do { ?>
                              <?php if ($totalRows_RsLeiPorData > 0) { // Show if recordset not empty ?>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td>&raquo; <span class="titulo_01"><?php echo $row_RsLeiPorData['titulo']; ?>,</span> <span class="titulo_01">de <?php echo $row_RsLeiPorData['data']; ?> - <a href="licitacao.php?licitacaoID=<?php echo $row_RsLeiPorData['licitacaoID']; ?>">ver licita&ccedil;&atilde;o.</a></span></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                  </tr>
                              ...
                              <?php } while ($row_RsLeiPorData = mysql_fetch_assoc($RsLeiPorData)); ?></td>
                      </tr>
                      <tr>
                        <td height="38">&nbsp;</td>
                      </tr>
...
<?php
mysql_free_result($RsLeiPorData);
?>
