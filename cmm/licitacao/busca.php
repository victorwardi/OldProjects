...
if (isset($_POST['data'])) {
  $colname_RsLeiPorData = $_POST['data'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsLeiPorData = sprintf("SELECT * FROM licitacao WHERE `data` LIKE %s", GetSQLValueString("%" . $colname_RsLeiPorData . "%", "text"));
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                      ...
                      <tr>
                        <td height="38" align="left"><span class="txt_01">Sua busca pela licita&ccedil;&atilde;o de</span> <span class="titulo_01"><?php echo $_POST['data'];?></span><span class="txt_01">, retornou </span><span class="titulo_01"><?php echo $totalRows_RsLeiPorData ?></span><span class="txt_01"> resultado(s).</span></td>
                      </tr>
                      <tr>
