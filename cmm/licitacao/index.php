            ...
            <td><div align="left">
              <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="586" height="30" bgcolor="#657D99"><span class="txt_03"><a name="topo" id="topo"></a></span><img src="../img/titulo_licitacoes_01.gif" width="105" height="19" /></td>
                </tr>
              </table>
            </div></td>
          </tr>
                ...
                <tr>
                  <td width="160" height="470" valign="top" bgcolor="#FEDDA5"><div align="left">
                    <table width="160" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        <td height="25" class="select_link_01"><div align="left"><strong>Licita&ccedil;&otilde;es</strong></div></td>
                      </tr>
                  ...
                  <td width="586" valign="top"><div align="center">
                    <table width="566" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td><div align="left">
                            <table width="566" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="260" valign="top"><div align="left"> <span class="txt_03">
                                    <script type="text/javascript"> 
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                                        ...
                                        <table width="260" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td><div align="left">
                                                <table width="260" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                    <td width="120"><div align="left"><img src="../img/foto_01.jpg" width="120" height="90" /></div></td>
                                                    <td width="20"><div align="left"></div></td>
                                                    <td width="120"><div align="left"><img src="../img/foto_02.jpg" width="120" height="90" /></div></td>
                                                  </tr>
                                                </table>
                                            </div></td>
                                          </tr>
                                            ...
                                            <td><div align="left">
                                                <table width="259" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                    ...
                                                    <td width="165" height="20" align="left"><div align="left"><span class="txt_01"><strong>Alterar o tamanho do texto</strong></span></div></td>
                                                    <td width="14" height="20" align="center" valign="middle" class="txt_01"><div align="center"><a href="javascript:;" onclick="mudafonte(0)"><strong> A</strong></a></div></td>
                                                    <td width="14" height="20" align="center" valign="middle" class="txt_06"><div align="center"><strong>|</strong></div></td>
                                                    <td width="16" height="20" align="center" valign="middle" class="txt_01"><div align="center"><a href="javascript:;" onclick="mudafonte(1)"><strong> A+</strong></a></div></td>
                                                    <td width="14" height="20" align="center" valign="middle" class="txt_06"><div align="center"><strong>|</strong></div></td>
                                                    <td width="22" height="20" align="center" valign="middle" class="txt_01"><div align="center"><a href="javascript:;" onclick="mudafonte(2)"><strong> A++</strong></a></div></td>
                                                  </tr>
                                                </table>
                                            </div></td>
                                          </tr>
                                ...
                                <td width="46" valign="top"><div align="left"></div></td>
                                <td width="260" valign="top" bgcolor="#DFDFDF"><div align="left">
                                  <table width="260" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="222" class="txt_01"><div align="left"><a href="printi.php">Vers&atilde;o para Impress&atilde;o</a></div></td>
                                      <td width="19" class="pri"><div align="right"></div></td>
                                    </tr>
                                    <tr>
                                      <td height="19"><div align="left"></div></td>
                                    ...
                                    <tr>
                                      ...
                                      <td width="19" class="pri"><div align="right"><a href="../noticias/newsletter/index.html"></a></div></td>
                                    </tr>
                                    <tr>
                                      <td height="19">&nbsp;</td>
                                      <td>&nbsp;</td>
                      ...
                      <tr>
                        <td><div align="left">
                          <table width="566" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td bgcolor="#DFDFDF" class="titulo_01">&nbsp;</td>
                              <td class="titulo_01">&nbsp;</td>
                              <td bgcolor="#DFDFDF" class="titulo_01">&nbsp;</td>
                            </tr>
                            <tr>
                              <td width="265" bgcolor="#DFDFDF" class="titulo_01"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;Localizar  Licita&ccedil;&atilde;o:</div></td>
                              <td width="10" class="titulo_01">&nbsp;</td>
                              <td width="265" bgcolor="#DFDFDF" class="titulo_01"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;Localizar  Licita&ccedil;&atilde;o:</div></td>
                            </tr>
                            <tr>
                              <td width="265" height="10" bgcolor="#DFDFDF" class="titulo_01"><div align="left"></div></td>
                              <td width="10" class="titulo_01">&nbsp;</td>
                              <td width="265" bgcolor="#DFDFDF" class="titulo_01"><div align="left"></div></td>
                            </tr>
                            <tr>
                              <td width="265" bgcolor="#DFDFDF" class="txt_01"><form id="licitacao" name="licitacao" method="post" action="../licitacao/buscaTitulo.php">
                                  <div align="left">
                                    <table width="260" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="100"><div align="left">&nbsp;&nbsp;&nbsp;Por T&iacute;tulo:</div></td>
                                        <td width="160"><div align="left">
                                            <input name="titulo" type="text" class="form_01" size="30" id="titulo" />
                                        </div></td>
                                      </tr>
                                      <tr>
                                        <td height="10">&nbsp;</td>
                                      ...
                                      <tr>
                                        ...
                                        <td height="10"><div align="left">
                                            <label>
                                            <input name="Submit" type="submit" class="bt_01" value="Localizar" />
                                            </label>
                                        </div></td>
                                      </tr>
                                    </table>
                              ...
                              <td width="10" class="txt_01">&nbsp;</td>
                              <td width="265" bgcolor="#DFDFDF" class="txt_01"><form id="licitacaoData" name="licitacaoData" method="post" action="../licitacao/busca.php">
                                  <div align="left">
                                    <table width="260" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="100"><div align="left">&nbsp;&nbsp;&nbsp;Por Data:</div></td>
                                        <td width="160"><div align="left">
                                            <input name="data" type="text" class="form_01" size="30" id="data" />
                                        </div></td>
                                      </tr>
                                      <tr>
                                        <td height="10">&nbsp;</td>
                            ...
                            <tr>
                              <td height="20" bgcolor="#DFDFDF" class="txt_01"><div align="left"></div></td>
                              <td width="10" class="txt_01">&nbsp;</td>
                              <td bgcolor="#DFDFDF" class="txt_01"><div align="left"></div></td>
                            </tr>
                          </table>
                        </div></td>
                      </tr>
                      ...
                      <tr>
                        <td><div align="left" class="txt_01" id="meutexto">
                          <p align="justify">As licita&ccedil;&otilde;es destinam-se a selecionar a proposta mais vantajosa para a Administra&ccedil;&atilde;o, propiciando igual oportunidade a todos os participantes, sendo processada e julgada na estrita conformidade com os princ&iacute;pios b&aacute;sicos da legalidade, da impessoalidade, da moralidade, da igualdade, da publicidade, da probidade administrativa, da vincula&ccedil;&atilde;o ao instrumento convocat&oacute;rio, do julgamento objetivo e dos que lhe s&atilde;o correlatos.<br />
                            <br />
                            Nossas licita&ccedil;&otilde;es s&atilde;o disciplinadas pela Lei Federal n&ordm; <a href="http://www.planalto.gov.br/Ccivil_03/Leis/L8666cons.htm" target="_blank"><strong>8.666/93</strong></a>.<br />
                            <br />
                            <br />
                            <strong>Modalidades Licitat&oacute;rias:</strong><br />
                            <br />
                            Limites pecuni&aacute;rios adotados para fins de estabelecimento de modalidades licitat&oacute;rias<br />
                            <br />
                            <strong>I - Para Obras e Servi&ccedil;os de Engenharia:</strong><br />
                            <br />
                            <strong>Dispensa:</strong> at&eacute; R$ 15.000,00 <br />
                            <br />
                            <strong>Convite:</strong> at&eacute; R$ 150.000,00 <br />
                            <br />
                            <strong>Tomada de Pre&ccedil;os:</strong> at&eacute; R$ 1.500.000,00 <br />
                            <br />
                            <strong>Concorr&ecirc;ncia:</strong> acima de R$ 1.500.000,00 <br />
                            <br />
                            <br />
                            <br />
                            <strong>II - Para Compras e Servi&ccedil;os:<br />
                            </strong><br />
                            <strong>Dispensa:</strong> at&eacute; R$ 8.000,00 <br />
                            <br />
                            <strong>Convite: </strong>at&eacute; R$ 80.000,00 <br />
                            <br />
                            <strong>Tomada de Pre&ccedil;os:</strong> at&eacute; R$ 650.000,00 <br />
                            <strong><br />
                            Concorr&ecirc;ncia:</strong> acima de R$ 650.000,00 </p>
                          </div></td>
                      </tr>
                      <tr>
                        <td height="38"><div align="left"></div></td>
