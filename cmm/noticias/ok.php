...
$objDynamicThumb1->setRenameRule("{RsNoticias.foto1}");
...
$objDynamicThumb2->setRenameRule("{RsNoticias.foto2}");
$objDynamicThumb2->setResize(120, 90, false);
...
var para = document.getElementById('para');
 ...
 if(de.value=="" || para.value=="" || nome.value==""){
                ...
                <tr>
                  <td width="160" height="470" valign="top" bgcolor="#FEDDA5"><div align="left">
                    <table width="160" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        <td class="select_link_01"><div align="left"><a href="../telefonesuteis/index.php"><strong>Telefones &Uacute;teis </strong></a></div></td>
                      </tr>
                      <tr>
                        <td height="25"><div align="left"></div></td>
                      ...
                      <tr>
                        <td width="322"><div align="left">
                            <table width="264" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="413" valign="top"><div align="left"> <span class="txt_03">
                                    <script type="text/javascript"> 
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                                        ...
                                        <table width="260" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td><div align="left">
                                                <table width="260" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                    <td width="120"><div align="center"><img src="<?php echo $objDynamicThumb1->Execute(); ?>" width="120" height="90" border="0" /></div></td>
                                                    <td width="20"><div align="left"></div></td>
                                                    <td width="120"><div align="center"><img src="<?php echo $objDynamicThumb2->Execute(); ?>" width="120" height="90" border="0" /></div></td>
                                                  </tr>
                                                </table>
                                            </div></td>
                                          </tr>
                        ...
                        <td width="244" rowspan="3" align="center" valign="top" bgcolor="#DFDFDF" class="txt_01"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="260" cellpadding="0" cellspacing="0">
                              <tr>
                              ...
                              <tr>
                                ...
                                <td width="222" class="txt_01"><div align="left"><a href="../telefonesuteis/print.php">Vers&atilde;o para Impress&atilde;o</a></div></td>
                                <td width="19" class="pri"><div align="right"></div></td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td width="19" class="pri"><div align="right"><a href="newsletter/index.html"></a></div></td>
                              </tr>
                              <tr>
                                <td height="19">&nbsp;</td>
                                <td align="center"><img src="../img/icone_02.gif" width="13" height="20" /></td>
                                <td align="left" class="txt_01">Enviar por E-mail</td>
                                <td class="pri">&nbsp;</td>
                              </tr>
                          ...
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                               <tr>
                                <td colspan="2"><form id="form1" name="form1" method="post" action="email.php?noticiaID=<?php echo $row_RsNoticias['noticiaID']; ?>">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                    <tr>
                                      <td align="left" valign="middle">&nbsp;</td>
                                      <td align="left" valign="middle">* Preencha corretamente os dados para enviar a not&iacute;cia por email.</td>
                                      <td align="left" valign="middle">&nbsp;</td>
                                    </tr>
                                    <tr>
                                      <td align="left" valign="middle">&nbsp;</td>
                                    ...
                                    <tr>
                                      <td align="left" valign="middle">&nbsp;</td>
                                      <td align="left" valign="middle"><div align="center"><span class="select_link_01">Email Enviado com Sucesso!</span></div></td>
                                      <td align="left" valign="middle">&nbsp;</td>
                                    </tr>
                                    <tr>
                                      <td align="left" valign="middle">&nbsp;</td>
                                    ...
                                    <tr>
                                      ...
                                      <td width="200" align="left" valign="middle"><label>
                                          Seu nome:
                                            <input name="nome" type="text" class="txt_01" id="nome" size="40" maxlength="255" />
                                        </label></td>
                                      <td width="30" align="left" valign="middle">&nbsp;</td>
                                    </tr>
                                    <tr>
                                      <td align="left" valign="middle">&nbsp;</td>
                                      <td align="left" valign="middle"><span class="txt_02">
                                          <label>                                          </label>
                                      </span>
                                        <label>
                                        Seu email:
                                        <input name="de" type="text" class="txt_01" id="de" size="40" maxlength="255" />
                                        </label></td>
                                      <td align="left" valign="middle">&nbsp;</td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td align="left" valign="middle"><label>
                                          Enviar para:
                                            <input name="para" type="text" class="txt_01" id="para" size="40" maxlength="255" />
                                        </label></td>
                                      <td align="left" valign="middle">&nbsp;</td>
                                    </tr>
                                    <tr>
                                      <td align="left" valign="middle">&nbsp;</td>
                                      <td align="left" valign="middle"><label>
                                        <input name="enviar" type="button" class="bt_01" id="enviar" value="enviar" onclick="validarEmail();" />
                                      </label></td>
                                      <td align="left" valign="middle">&nbsp;</td>
                                    </tr>
                                    <tr>
                      ...
                      <tr>
                        <td align="left" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0">
                          <tr>
                            <td align="left" valign="middle" class="titulo_01"><?php echo $row_RsNoticias['titulo']; ?></td>
                            <td align="left" valign="middle" class="titulo_01">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle" class="txt_01"><div align="justify" id="meutexto"><?php echo $row_RsNoticias['materia']; ?></div></td>
                            <td align="left" valign="middle" class="txt_01">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle"><span class="select_link_01">Data:</span><span class="txt_02"> <?php echo $row_RsNoticias['data']; ?></span></td>
                            <td align="left" valign="middle">&nbsp;</td>
                          </tr>
                        </table></td>
                        <td>&nbsp;</td>
