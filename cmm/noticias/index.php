...
$query_RsNoticias = "SELECT * FROM novidades ORDER BY noticiaID DESC";
            ...
            <td><div align="left">
              <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="586" height="30" bgcolor="#657D99"><span class="txt_03"><a name="topo" id="topo"></a></span><img src="../img/titulo_index_01.gif" width="322" height="20" /></td>
                </tr>
              </table>
            </div></td>
          </tr>
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                                ...
                                <td width="260" valign="top" bgcolor="#DFDFDF"><div align="left">
                                  <table width="260" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="222" class="txt_01"><div align="left"><a href="../partidos/print.php">Vers&atilde;o para Impress&atilde;o</a></div></td>
                                      <td width="19" class="pri"><div align="right"></div></td>
                                    </tr>
                                    <tr>
                                      <td height="19"><div align="left"></div></td>
                      ...
                      <tr>
                        <td align="left" valign="top"><div align="left" class="txt_01" id="meutexto">
                            <?php do { ?>
                              <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                  <tr>
                                      <td width="6%" valign="top" bgcolor="#FEDDA5"><a href="noticia.php?noticiaID=<?php echo $row_RsNoticias['noticiaID']; ?>"><img src="<?php echo $objDynamicThumb1->Execute(); ?>" width="60" height="45" border="0" /></a></td>
                                    <td width="94%" align="left" valign="top" class="titulo_01"><?php echo $row_RsNoticias['titulo']; ?> - <span class="titulo_01"><?php echo $row_RsNoticias['data']; ?></span><br />
                                        <span class="txt_01"><?php echo $row_RsNoticias['resumo']; ?></span><br />
                                      <a href="noticia.php?noticiaID=<?php echo $row_RsNoticias['noticiaID']; ?>" class="titulo_01">Ver not&iacute;cia</a></td>
                                  </tr>
                                  <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <?php } while ($row_RsNoticias = mysql_fetch_assoc($RsNoticias)); ?><p>

                            <table border="0" align="center">
                              <tr>
                                <td width="102"><?php if ($pageNum_RsNoticias > 0) { // Show if not first page ?>
                                    <a href="<?php printf("%s?pageNum_RsNoticias=%d%s", $currentPage, 0, $queryString_RsNoticias); ?>">Primeira P&aacute;gina</a> |
                                    <?php } // Show if not first page ?>
                                </td>
                                <td width="99"><?php if ($pageNum_RsNoticias > 0) { // Show if not first page ?>
                                    <a href="<?php printf("%s?pageNum_RsNoticias=%d%s", $currentPage, max(0, $pageNum_RsNoticias - 1), $queryString_RsNoticias); ?>">P&aacute;gina Anterior </a>
                                    <?php } // Show if not first page ?>
                                </td>
                                <td width="106"><?php if ($pageNum_RsNoticias < $totalPages_RsNoticias) { // Show if not last page ?>
                                    | <a href="<?php printf("%s?pageNum_RsNoticias=%d%s", $currentPage, min($totalPages_RsNoticias, $pageNum_RsNoticias + 1), $queryString_RsNoticias); ?>"> Pr&oacute;xima P&aacute;gina </a> 
                                    <?php } // Show if not last page ?>
                                </td>
                                <td width="85"><p>
                                  <?php if ($pageNum_RsNoticias < $totalPages_RsNoticias) { // Show if not last page ?>
                                      | <a href="<?php printf("%s?pageNum_RsNoticias=%d%s", $currentPage, $totalPages_RsNoticias, $queryString_RsNoticias); ?>">&Uacute;tima P&aacute;gina</a>
                                      <?php } // Show if not last page ?>
                                    </p>
                                  </td>
                              </tr>
