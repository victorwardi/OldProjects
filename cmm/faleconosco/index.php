...
if ( isset( $_POST["submit"] ) ) 
{
	...
	$remetente = "contato@cmmangaratiba.rj.gov.br";
            ...
            <td><div align="left">
              <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="586" height="30" bgcolor="#657D99"><span class="txt_03"><a name="topo" id="topo"></a></span><img src="../img/titulo_falecomacamara_01.gif" width="135" height="16" /></td>
                </tr>
              </table>
            </div></td>
          </tr>
                ...
                <tr>
                  <td width="160" height="470" valign="top" bgcolor="#FEDDA5"><div align="left">
                    <table width="160" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        <td height="25" class="select_link_01"><div align="left"><strong>Fale Conosco </strong></div></td>
                      </tr>
                    </table>
                  </div></td>
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                      ...
                      <tr>
                        ...
                        <p class="select_link_01">
                                    <?php if ( !empty( $msg ) ) echo( "<b style=\"color:$cor\">".$msg."</b>" );  ?>
                        </div></td>
                      </tr>
                      <tr>
                        <td><div align="left" class="txt_01">
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" onsubmit="return document.MM_returnValue">
                                            <fieldset class="link_12px_preto_n">
                            <table cellspacing="5" cellpadding="0" width="566" 
                                border="0">
                              <tbody>
                                <tr valign="top">
                                  <td width="12%" class="txt_03"><label for="Nome">Nome:</label></td>
                                  <td width="88%"><input class="txt_01" size="95" 
                                name="Nome" /></td>
                                </tr>
                                <tr valign="top">
                                  <td height="5" class="txt_03"><div align="left"></div></td>
                                  <td height="5"><div align="left"></div></td>
                                </tr>
                                <tr valign="top">
                                  <td class="txt_03"><label for="Email">E-mail:</label></td>
                                  <td><input class="txt_01" size="95" 
                                name="Email" /></td>
                                </tr>
                                <tr valign="top">
                                  <td height="5" class="txt_03"><div align="left"></div></td>
                                ...
                                <tr valign="top">
                                  <td height="5" class="txt_03"><label for="Telefone">Telefone:</label></td>
                                  <td height="5"><div align="left">
                                    <input class="txt_01" size="95" 
                                name="Telefone:" />
                                  </div></td>
                                </tr>
                                <tr valign="top">
                                ...
                                <tr valign="top">
                                  <td class="txt_03"><label for="Assunto" >Assunto:</label></td>
                                  <td>
                                    <select class="txt_01" name="Assunto">
                                      <option selected="selected">Selecione ...</option>
                                      <option 
                                value="Denuncia">Den&uacute;ncia</option>
                                      <option 
                                value="Sugestao">Sugest&atilde;o</option>
                                      <option 
                                value="Duvida">D&uacute;vida</option>
                                    </select>
                                  </td>
                                </tr>
                                <tr valign="top">
                                  <td height="5" class="txt_03">&nbsp;</td>
                                  <td height="5"><div align="left"></div></td>
                                </tr>
                                <tr valign="top">
                                  <td class="txt_03"><label for="Assunto" >Mensagem:</label></td>
                                  <td><textarea name="Mensagem" cols="92" rows="5" class="txt_01"></textarea></td>
                                </tr>
                                <tr valign="top">
                                  <td height="5" class="txt_01"><div align="left"></div></td>
                                  <td height="5"><div align="left"></div></td>
                                </tr>
                                <tr>
                                  <td colspan="2"><font size="1"><b class="txt_05">ATEN&Ccedil;&Atilde;O:</b> <br />
                                        <br />
                                        <span class="style1">R</span>ecomendamos o 
                                ...
                                <tr valign="top">
                                  <td colspan="2" height="20"><input name="submit" type="submit" class="bt_01" id="enviar" value="Enviar" />                                  </td>
                                </tr>
                              </tbody>
                            </table>
                        </div></td>
