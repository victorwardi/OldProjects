...
.style2 {font-size: 10px; color: #4F4C69; text-decoration: none; font-family: Verdana, Arial, Helvetica, sans-serif;}
-->
</style>
</head>

<body onload="MM_preloadImages('../img/link_noticias_0102.gif','../img/top_menu_0102.gif','../img/top_menu_0202.gif','../img/top_menu_0302.gif')">
<div align="center">
                              ...
                              <td width="383"><div align="left">
                                <table border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="31"><div align="center"><img src="../img/div_01.gif" width="3" height="9" /></div></td>
                                    <td><div align="center"><img src="../img/top_menu_0402.gif" width="63" height="9" /></div></td>
                                  </tr>
                                </table>
                              </div></td>
            ...
            <td><div align="left">
              <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="586" height="30" bgcolor="#657D99"><span class="txt_03"><a name="topo" id="topo"></a></span><img src="../img/titulo_newsletter_01.gif" width="118" height="16" /></td>
                </tr>
              </table>
            </div></td>
          </tr>
                ...
                <tr>
                  <td width="160" height="470" valign="top" bgcolor="#FEDDA5"><div align="left">
                    <table width="160" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        <td height="25" class="select_link_01"><div align="left"><a href="../faleconosco/index.php"><strong>Fale Conosco</strong></a></div></td>
                      </tr>
                    </table>
                  </div></td>
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                                ...
                                <td width="260" valign="top" bgcolor="#DFDFDF"><div align="left">
                                  <table width="260" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="222" class="txt_01"><div align="left"><a href="../newsletter/index.html">Receber Newsletter</a></div></td>
                      ...
                      <tr>
                        <td><div align="left" class="txt_01">
                          <table width="566" cellspacing="0" cellpadding="0">

                            <tr>
                              <td width="533" class="txt_03">Receba informa&ccedil;&otilde;es e not&iacute;cias sobre a C&acirc;mara Municipal de Mangaratiba preenchendo o formul&aacute;rio abaixo.</td>
                            </tr>
                            <tr>
                              <td height="25">&nbsp;</td>
                            </tr>
                            <tr>
                              <td><table width="566" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td><form action="http://www.easymailing.com.br/easy/smart_integracao_xp.php"  method="post" name="form1" id="form1">
                                        <input type="hidden" name="CON_ID" value="031098ba319fe30ce099aad41e1cf15dcc06b" />
                                        <input type="hidden" name="DESTINO" value="http://www.mangaratiba.rj.gov.br/newsletter/index2.html" />
                                        <input type="hidden" name="GRUPOS" value="28862" />
                                        <table width="566" border="0">
                                          <tr>
                                            <td width="58" class="txt_03"><strong>Nome: </strong></td>
                                            <td width="460"><input name="SMT_NOME" type="text" class="txt_01" value="" size="95" /></td>
                                          </tr>
                                          <tr>
                                            <td class="txt_03">&nbsp;</td>
                                            <td>&nbsp;</td>
                                          ...
                                          <tr>
                                            <td class="txt_03"><strong>E-Mail: </strong></td>
                                            <td><input name="SMT_MAIL" type="text" class="txt_01" value="" size="95" /></td>
                                          </tr>
                                          <tr>
                                            <td class="txt_03">&nbsp;</td>
                                            <td>&nbsp;</td>
                                          ...
                                          <tr>
                                            <td colspan="2"><input name="submit2" type="submit" class="bt_01" value="enviar" /></td>
                                          </tr>
                                          <tr>
                                            <td height="40" colspan="2">&nbsp;</td>
                                          </tr>
                                          <tr>
                                            <td colspan="2"><div align="justify"><span class="txt_04">O que &eacute; Newsletter?</span><span class="txt_03"><br />
                                                      <br />
                                            </span><span class="style2">Newsletter</span><span class="txt_03">, que em portugu&ecirc;s poderia ser traduzido para <strong>Boletim   informativo</strong></span><span class="style2">,</span><span class="txt_03"> &eacute; um tipo de mensagem eletr&ocirc;nica na qual o usu&aacute;rio pode receber    not&iacute;cias,  novidades e informa&ccedil;&otilde;es sobre um determinado assunto, ap&oacute;s efetuar um   cadastramento em algum site.</span></div></td>
                                          </tr>
                                        </table>
                                    </form></td>
                                  </tr>
