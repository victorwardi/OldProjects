...
$tfi_listnovidades2->addColumn("novidades.noticiaID", "NUMERIC_TYPE", "noticiaID", "=");
...
$tso_listnovidades2->addColumn("novidades.noticiaID");
$tso_listnovidades2->addColumn("novidades.titulo");
$tso_listnovidades2->addColumn("novidades.data");
$tso_listnovidades2->setDefault("novidades.noticiaID DESC");
$tso_listnovidades2->Execute();

// Navigation
$nav_listnovidades2 = new NAV_Regular("nav_listnovidades2", "rsnovidades1", "../../", $_SERVER['PHP_SELF'], 20);
...
// Defining List Recordset variable
$NXTSort_rsnovidades1 = "novidades.noticiaID DESC";
if (isset($_SESSION['sorter_tso_listnovidades2'])) {
  $NXTSort_rsnovidades1 = $_SESSION['sorter_tso_listnovidades2'];
}
mysql_select_db($database_ConBD, $ConBD);

$query_rsnovidades1 = "SELECT novidades.noticiaID, novidades.titulo, novidades.data FROM novidades WHERE {$NXTFilter_rsnovidades1} ORDER BY {$NXTSort_rsnovidades1}";
...
$NXT_LIST_SETTINGS = {
  ...
  .KT_col_noticiaID {width:140px; overflow:hidden;}
  .KT_col_titulo {width:180px; overflow:hidden;}
  .KT_col_data {width:140px; overflow:hidden;}
      </style>
<table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td class="titulo">Not&iacute;cia - Editar / Excluir</td>
        </tr>
        <tr>
          <td>&nbsp;
            <div class="KT_tng" id="listnovidades2">
              <h1 class="text">Not&iacute;cias
                <?php
                  ...
                  <table cellpadding="2" cellspacing="0" class="borda_roxa" id="painel">
                    <thead>
                      <tr class="KT_row_order">
                        <th align="center" bgcolor="#FEDDA5"> <input type="checkbox" name="KT_selAll" id="KT_selAll"/>                        </th>
                        <th align="center" bgcolor="#FEDDA5" class="KT_sorter KT_col_titulo <?php echo $tso_listnovidades2->getSortIcon('novidades.titulo'); ?>" id="titulo"> <a href="<?php echo $tso_listnovidades2->getSortLink('novidades.titulo'); ?>">Titulo</a> </th>
                        <th align="center" bgcolor="#FEDDA5" class="KT_sorter KT_col_data <?php echo $tso_listnovidades2->getSortIcon('novidades.data'); ?>" id="data"> <a href="<?php echo $tso_listnovidades2->getSortLink('novidades.data'); ?>">Data</a> </th>
                        <th align="center" bgcolor="#FEDDA5">&nbsp;</th>
                      </tr>
                      <?php 
...
?>
                      ...
                      <?php if ($totalRows_rsnovidades1 > 0) { // Show if recordset not empty ?>
                        <?php do { ?>
                          <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                            <td><input type="checkbox" name="kt_pk_novidades" class="id_checkbox" value="<?php echo $row_rsnovidades1['noticiaID']; ?>" />
                                <input type="hidden" name="noticiaID" class="id_field" value="<?php echo $row_rsnovidades1['noticiaID']; ?>" />                            </td>
                            <td><div class="KT_col_titulo"><?php echo KT_FormatForList($row_rsnovidades1['titulo'], 100); ?></div></td>
                            <td><div class="KT_col_data"><?php echo KT_FormatForList($row_rsnovidades1['data'], 20); ?></div></td>
                            <td><a class="KT_edit_link" href="noticia_inserir.php?noticiaID=<?php echo $row_rsnovidades1['noticiaID']; ?>&amp;KT_back=1"><?php echo NXT_getResource("edit_one"); ?></a> <a class="KT_delete_link" href="#delete"><?php echo NXT_getResource("delete_one"); ?></a> </td>
                          </tr>
          ...
          ?>
                  ...
                  <div class="KT_bottombuttons">
                    ...
                    <a class="KT_additem_op_link" href="noticia_inserir.php?KT_back=1" onclick="return nxt_list_additem(this)"><?php echo NXT_getResource("add new"); ?></a> </div>
                </form>
              </div>
