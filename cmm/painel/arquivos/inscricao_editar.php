                  ...
                  <table cellpadding="2" cellspacing="0" class="borda_roxa" id="painel">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th bgcolor="#FEDDA5" class="KT_sorter KT_col_numero <?php echo $tso_listinscricao1->getSortIcon('inscricao.numero'); ?>" id="numero"> <div align="center"><a href="<?php echo $tso_listinscricao1->getSortLink('inscricao.numero'); ?>">Número</a> </div></th>
                        <th bgcolor="#FEDDA5" class="KT_sorter KT_col_descricao <?php echo $tso_listinscricao1->getSortIcon('inscricao.descricao'); ?>" id="descricao"> <div align="center"><a href="<?php echo $tso_listinscricao1->getSortLink('inscricao.descricao'); ?>">Descrição</a> </div></th>
