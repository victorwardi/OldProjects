...
$colname_RsLeiPorNumero = "-1";
if (isset($_POST['descricao'])) {
  $colname_RsLeiPorNumero = $_POST['descricao'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsLeiPorNumero = sprintf("SELECT * FROM lei WHERE descricao LIKE %s ORDER BY leiID ASC", GetSQLValueString("%" . $colname_RsLeiPorNumero . "%", "text"));
$RsLeiPorNumero = mysql_query($query_RsLeiPorNumero, $ConBD) or die(mysql_error());
$row_RsLeiPorNumero = mysql_fetch_assoc($RsLeiPorNumero);
$totalRows_RsLeiPorNumero = mysql_num_rows($RsLeiPorNumero);
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                      ...
                      <tr>
                        <td height="38" align="left"><span class="txt_01">Sua busca pela lei contendo a descri&ccedil;&atilde;o: </span><span class="titulo_01"><?php echo $_POST['descricao'];?></span><span class="txt_01">, retornou </span><span class="titulo_01"><?php echo $totalRows_RsLeiPorNumero ?></span><span class="txt_01"> resultado(s).</span></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top" class="txt_01"><?php do { ?>
                              <?php if ($totalRows_RsLeiPorNumero > 0) { // Show if recordset not empty ?>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td>&raquo; Lei n&deg;: <span class="titulo_01"><?php echo $row_RsLeiPorNumero['numero']; ?>,</span> <span class="titulo_01">de <?php echo $row_RsLeiPorNumero['data']; ?> - <a href="lei.php?leiID=<?php echo $row_RsLeiPorNumero['leiID']; ?>">ver lei.</a></span></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                  </tr>
                              ...
                              <?php } while ($row_RsLeiPorNumero = mysql_fetch_assoc($RsLeiPorNumero)); ?></td>
                      </tr>
                      <tr>
                        <td height="38">&nbsp;</td>
                      </tr>
...
<?php
mysql_free_result($RsLeiPorNumero);
?>
