...
$colname_RsLei = "-1";
if (isset($_GET['leiID'])) {
  $colname_RsLei = $_GET['leiID'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsLei = sprintf("SELECT * FROM lei WHERE leiID = %s", GetSQLValueString($colname_RsLei, "int"));
$RsLei = mysql_query($query_RsLei, $ConBD) or die(mysql_error());
 ...
 tipo=''; 
                                ...
                                <td width="260" valign="top" bgcolor="#DFDFDF"><div align="left">
                                  <table width="260" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="222" class="txt_01"><div align="left"><a href="print.php?leiID=<?php echo $row_RsLei['leiID']; ?>">Vers&atilde;o para Impress&atilde;o</a></div></td>
                                      <td width="19" class="pri"><div align="right"></div></td>
                                    </tr>
                                    <tr>
                                      <td height="19"><div align="left"></div></td>
                      ...
                      <tr>
                        <td class="txt_01"><div align="left" id="meutexto">
                          <p>Lei n &deg;.: <strong><?php echo $row_RsLei['numero']; ?>,  de  <?php echo $row_RsLei['data']; ?></strong><br />
                              <br />
                              <?php echo $row_RsLei['descricao']; ?><br />
                                <br />
                                <br />
                                <strong>                                LEI:</strong><br />
                                <br />
                                <br />
                                <?php echo $row_RsLei['lei']; ?><br />
                                <br />
                                <br />
                                <strong>Mangaratiba, <?php echo $row_RsLei['data']; ?>.</strong><br />
                                <br />
                                <br />
                                <br />
                      ...
                      <tr>
                        <td class="txt_01"><a href="../uploads/<?php echo $row_RsLei['pdf']; ?>">
                        <?php if ($row_RsLei['pdf'] != "") { // Show if recordset not empty ?>
