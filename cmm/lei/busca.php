...
if (isset($_POST['numero'])) {
  $colname_RsLeiPorNumero = $_POST['numero'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsLeiPorNumero = sprintf("SELECT * FROM lei WHERE numero LIKE %s ORDER BY leiID ASC", GetSQLValueString("%" . $colname_RsLeiPorNumero . "%", "text"));
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                      ...
                      <tr>
                        <td height="38" align="left"><span class="txt_01">Sua busca pela lei n&deg;</span> <span class="titulo_01"><?php echo $_POST['numero'];?></span><span class="txt_01">, retornou </span><span class="titulo_01"><?php echo $totalRows_RsLeiPorNumero ?></span><span class="txt_01"> resultado(s).</span></td>
                      </tr>
                      <tr>
