...
$query_RsLei = "SELECT * FROM lei ORDER BY leiID ASC";
                        ...
                        <td class="txt_01"><?php do { ?>
                            <table width="100%" border="0" cellspacing="8" cellpadding="0">
                                  ...
                                  <td width="3%" class="select_link_01">&raquo;</td>
                                    <td width="97%" align="left" valign="middle">Lei n &deg;.: <strong><?php echo $row_RsLei['numero']; ?>,  de <?php echo $row_RsLei['data']; ?> -<span class="select_link_01"> <a href="lei.php?leiID=<?php echo $row_RsLei['leiID']; ?>">ver lei</a></span></strong></td>
                                  </tr>
                                                        </table>
