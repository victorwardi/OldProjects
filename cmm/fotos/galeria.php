...
$colname_RsGaleria = "-1";
if (isset($_GET['galeriaID'])) {
  $colname_RsGaleria = $_GET['galeriaID'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsGaleria = sprintf("SELECT * FROM galerias WHERE galeriaID = %s ORDER BY galeriaID DESC", GetSQLValueString($colname_RsGaleria, "int"));
...
$colname_RsFotos = "-1";
if (isset($_GET['galeriaID'])) {
  $colname_RsFotos = $_GET['galeriaID'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsFotos = sprintf("SELECT * FROM fotos WHERE galeriaID = %s ORDER BY fotoID DESC", GetSQLValueString($colname_RsFotos, "int"));
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','750','height','160','src','../flash/banner_princ_01','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','wmode','Transparent','movie','../flash/banner_princ_01' ); //end AC code
                ...
                <embed src="../flash/banner_princ_01.swf" width="750" height="160" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent"></embed>
              </object>
            </noscript></div></td>
          </tr>
          <tr>
                ...
                <tr>
                  ...
                  <td width="586" valign="top"><div align="right">
                    <table width="586" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="22" height="10"><div align="left"></div></td>
                        <td width="545" height="10"><div align="left"></div></td>
                        <td width="19">&nbsp;</td>
                      </tr>
                      <tr>
                        ...
                        <td class="titulo_01"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                          <tr>
                            <td align="left" valign="top"><p><?php echo $row_RsGaleria['titulo']; ?> - <?php echo $row_RsGaleria['data']; ?><br />
...
?>
                                  <td><table width="44" border="0" cellpadding="0" cellspacing="4" bgcolor="#FEDDA5">
                                      <tr>
                                        <td width="36"><a href="<?php echo tNG_showDynamicImage("../", "../uploads/fotos/", "{RsFotos.arquivo}");?>" rel="lightbox" title="<?php echo $row_RsFotos['descricao']; ?>"><img src="<?php echo $objDynamicThumb1->Execute(); ?>" border="0" /></a></td>
                                      </tr>
                                  </table></td>
                                  <?php
$row_RsFotos = mysql_fetch_assoc($RsFotos);
