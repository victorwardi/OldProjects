...
$objDynamicThumb1->setResize(215, 0, true);
 ...
 tipo=''; 
                        ...
                        <td width="260" rowspan="3" valign="top" bgcolor="#DFDFDF" class="txt_03"><table width="291" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td width="222" class="txt_01"><div align="left"><a href="imprimirnoticia.php?novidadeId=<?php echo $row_RsNoticias['novidadeId']; ?>&amp;vereadorID=<?php echo $row_RsNoticias['vereadorID']; ?>">Vers&atilde;o para Impress&atilde;o</a></div></td>
                              <td width="19" class="pri"><div align="right"></div></td>
                            </tr>
                            <tr>
                              <td height="19"><div align="left"></div></td>
                            ...
                            <tr>
                              ...
                              <td colspan="2" align="center" valign="top"><div align="center">
                                <table width="215" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td height="240" align="center" valign="top" class="txt_01"><div align="center"><img src="<?php echo $objDynamicThumb1->Execute(); ?>" border="0" /></div>
                                        <br /></td>
                                  </tr>
                                  <tr>
                      ...
                      <tr>
                        <td width="260" valign="top" class="txt_03"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                          <tr>
                            <td align="left" valign="top" ><table width="100%" border="0" cellpadding="2" cellspacing="0" class="bt_01">
                                <tr>
                                  <td align="left">Not&iacute;cias</td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td align="left" valign="top" class="titulo_01"><?php echo $row_RsNoticias['titulo']; ?></td>
                          </tr>
                          <tr>
                            <td id="meutexto" align="left" valign="top" class="txt_01"><div align="justify"><?php echo $row_RsNoticias['materia']; ?></div></td>
                          </tr>
                          <tr>
                            <td align="left" valign="top" class="txt_01"></td>
                          </tr>
                          <tr>
                            <td align="left" valign="top"><span class="select_link_01">Data:</span> <span class="txt_01"><?php echo $row_RsNoticias['data']; ?></span></td>
                          </tr>
                        </table></td>
