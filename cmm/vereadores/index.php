...
$query_RsVereador = "SELECT * FROM vereadores ORDER BY nome ASC";
...
$objDynamicThumb1->setRenameRule("{RsVereador.foto}");
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                      ...
                      <tr>
                        <td align="left" valign="top" class="txt_01"><div align="left" id="meutexto"> 
                          <?php do { ?>
                            <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                  <td width="7%"><a href="vereador.php?vereadorID=<?php echo $row_RsVereador['vereadorID']; ?>"><img src="<?php echo $objDynamicThumb1->Execute(); ?>" border="0" /></a></td>
                                  <td width="93%" align="left" valign="middle" class="titulo_01"><p><?php echo $row_RsVereador['nome']; ?> - <span class="txt_01"><?php echo $row_RsVereador['apelido']; ?><br />
                                    </span><span class="select_link_01"><a href="vereador.php?vereadorID=<?php echo $row_RsVereador['vereadorID']; ?>">Ver Perfil</a></span></p>                                    </td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                            ...
                            <?php } while ($row_RsVereador = mysql_fetch_assoc($RsVereador)); ?><strong>&nbsp;&nbsp;</strong><br />
                            </div></td>
                      </tr>
                      <tr>
                        <td height="38"><div align="left"></div></td>
