...
if (isset($_GET['vereadorID'])) {
  $colname_RsNoticias = $_GET['vereadorID'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsNoticias = sprintf("SELECT * FROM novidadesvereadores WHERE vereadorID = %s ORDER BY novidadeId DESC", GetSQLValueString($colname_RsNoticias, "text"));
...
$colname_RsFotos = "-1";
if (isset($_GET['vereadorID'])) {
  $colname_RsFotos = $_GET['vereadorID'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsFotos = sprintf("SELECT * FROM fotosvereadores WHERE vereadorID = %s ORDER BY fotoID DESC", GetSQLValueString($colname_RsFotos, "int"));
...
document.write(monthNames[now.getMonth()] + " de " + thisYear);
          ...
          <tr>
            <td height="160"><div align="center">
              <script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','750','height','160','src','../flash/banner_princ_01','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','wmode','Transparent','movie','../flash/banner_princ_01' ); //end AC code
 ...
 tipo=''; 
                        ...
                        <td width="260" rowspan="3" valign="top" bgcolor="#DFDFDF" class="txt_03"><table width="291" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td width="222" class="txt_01"><div align="left"><a href="drruy_print.php">Vers&atilde;o para Impress&atilde;o</a></div></td>
                              <td width="19" class="pri"><div align="right"></div></td>
                            </tr>
                            <tr>
                              <td height="19"><div align="left"></div></td>
                            ...
                            <tr>
                              ...
                              <td colspan="2" align="center" valign="top"><div align="center">
                                <table width="215" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td height="240" align="center" valign="top" class="txt_01"><div align="center"><img src="<?php echo tNG_showDynamicImage("../", "../uploads/fotos/", "{RsVereador.foto}");?>" /></div></td>
                                  </tr>
                                  <tr>
                        ...
                        <td width="260" valign="top" class="txt_03"><table width="260" cellspacing="0" cellpadding="0">
                            <tr>
                              <td class="txt_01"><div class="classe1 style1" id="meutexto">
                                  <div align="justify">
                                    <p><strong><?php echo $row_RsVereador['nome']; ?><br />
                                    </strong><br />
                                    <?php echo $row_RsVereador['apelido']; ?><br />
<br />
<br />
<strong>Partido:<br />
</strong><br />
<?php echo $row_RsVereador['partido']; ?> <br />
<br />
<br />
<strong>Anivers&aacute;rio:</strong><br />
<br />
<?php echo $row_RsVereador['aniversario']; ?><br />
<br />
<br />
...
<?php echo $row_RsVereador['participacaoNaCamara']; ?><br />
                             ...
                             <tr>
                              <td height="50" class="txt_01"><table width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="256" height="18" align="left" valign="middle"><strong class="titulo_01" >Not&iacute;cias</strong></td>
                                </tr>
                                <tr>
                                  <td height="10" class="txt_01"><div align="left"><?php if ($totalRows_RsNoticias == 0) { // Show if recordset empty ?>
                                      <p class="select_link_01">N&atilde;o h&aacute; not&iacute;cias cadastradas.</p>
                                      <?php } // Show if recordset empty ?></div></td>
                                </tr>
                                <tr>
                                  <td align="left" class="txt_01"><div align="left"><a href="#"></a>
                                          <?php do { ?>
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td align="left"><a href="../vereadores/noticia.php?novidadeId=<?php echo $row_RsNoticias['novidadeId']; ?>&amp;vereadorID=<?php echo $row_RsNoticias['vereadorID']; ?>">
                                              <?php if ($totalRows_RsNoticias > 0) { // Show if recordset not empty ?>
                                                <span class="select_link_01">&raquo;</span> <?php echo $row_RsNoticias['titulo']; ?>
                            ...
                            <tr>
                              <td class="txt_01"><div align="left"><strong>Galeria de Fotos </strong></div></td>
                            </tr>
                            <tr>
                              <td height="20" class="txt_01"><div align="left"><?php if ($totalRows_RsFotos == 0) { // Show if recordset empty ?>
                                      <span class="select_link_01">N&atilde;o h&aacute; fotos cadastradas.</span>
  <?php } // Show if recordset empty ?></div></td>
                            </tr>
                            <tr>
...
?>
                                    <td><?php if ($totalRows_RsFotos > 0) { // Show if recordset not empty ?>
                                        <table width="48" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
                                          <tr>
                                            <td width="44" align="center"><table width="40" border="0" cellspacing="0" cellpadding="4">
                                                <tr>
                                                  <td width="36" bgcolor="#FEDDA5"><a href="<?php echo tNG_showDynamicImage("../", "../uploads/fotos/", "{RsFotos.imagem}");?>" rel="lightbox[fotos]"  title="<?php echo $row_RsFotos['descricao']; ?>"><img src="<?php echo $objDynamicThumb1->Execute(); ?>" width="50" height="50" border="0" /></a></td>
                                                </tr>
                                            </table></td>
                                          </tr>
                                        </table>
                        ...
                        <td colspan="3" class="txt_01"><div align="right">
                          <table width="566" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="100" valign="middle" class="txt_01"><div align="left"><a href="index.php"><strong>&lt; Voltar</strong></a></div></td>
