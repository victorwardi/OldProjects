...
$query_RsMesa = "SELECT * FROM mesadiretora";
$RsMesa = mysql_query($query_RsMesa, $ConBD) or die(mysql_error());
$row_RsMesa = mysql_fetch_assoc($RsMesa);
$totalRows_RsMesa = mysql_num_rows($RsMesa);

// Show Dynamic Thumbnail
$objDynamicThumb1 = new tNG_DynamicThumbnail("../", "KT_thumbnail1");
$objDynamicThumb1->setFolder("../uploads/");
$objDynamicThumb1->setRenameRule("{RsMesa.fotoPresidente}");
...
$objDynamicThumb2->setRenameRule("{RsMesa.fotoVicePresidente}");
$objDynamicThumb2->setResize(60, 0, true);
...
$objDynamicThumb3->setRenameRule("{RsMesa.fotoSecretario1}");
$objDynamicThumb3->setResize(60, 0, true);
...
$objDynamicThumb4->setRenameRule("{RsMesa.fotoSecretario2}");
$objDynamicThumb4->setResize(60, 0, true);
            ...
            <td><div align="left">
              <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="586" height="30" bgcolor="#657D99"><span class="txt_03"><a name="topo" id="topo"></a></span><img src="../img/titulo_mesadiretora_01.gif" width="144" height="16" /></td>
                </tr>
              </table>
            </div></td>
          </tr>
                ...
                <tr>
                  <td width="160" height="470" valign="top" bgcolor="#FEDDA5"><div align="left">
                    <table width="160" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        <td height="25" class="select_link_01"><div align="left"><strong>Mesa Diretora</strong></div></td>
                      </tr>
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                      ...
                      <tr>
                        <td><div align="left" class="txt_01" id="meutexto"><strong>Presidente:</strong><br />
                            <br />
                      <img src="<?php echo $objDynamicThumb1->Execute(); ?>" border="0" /> <?php echo $row_RsMesa['presidente']; ?><br />
                                    <br />
                                    <br />
                                  <br />
                                      <strong>Vice-Presidente:</strong><br />
                                    <br />
                                    <img src="<?php echo $objDynamicThumb2->Execute(); ?>" border="0" /> <?php echo $row_RsMesa['vicePresidente']; ?><br />
                          <br />
                          <br />
                          <br />
                            <strong>1&ordm; Secret&aacute;rio:</strong><br />
                          <br />
                          <img src="<?php echo $objDynamicThumb3->Execute(); ?>" border="0" /> <?php echo $row_RsMesa['secretario1']; ?><br />
                          <br />
                          <br />
                          <br />
                          <strong>2&ordm; Secret&aacute;rio:</strong><br />
                          <br />
                          <img src="<?php echo $objDynamicThumb4->Execute(); ?>" border="0" /> <?php echo $row_RsMesa['secretario2']; ?></div></td>
                      </tr>
                      <tr>
                        <td height="38"><div align="left"></div></td>
                      </tr>
