...
$colname_RsIndicacao = "-1";
if (isset($_GET['inscricaoID'])) {
  $colname_RsIndicacao = $_GET['inscricaoID'];
}
mysql_select_db($database_ConBD, $ConBD);
$query_RsIndicacao = sprintf("SELECT * FROM inscricao WHERE inscricaoID = %s", GetSQLValueString($colname_RsIndicacao, "int"));
$RsIndicacao = mysql_query($query_RsIndicacao, $ConBD) or die(mysql_error());
$row_RsIndicacao = mysql_fetch_assoc($RsIndicacao);
$totalRows_RsIndicacao = mysql_num_rows($RsIndicacao);
 ...
 tipo=''; 
                                ...
                                <td width="260" valign="top" bgcolor="#DFDFDF"><div align="left">
                                  <table width="260" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="222" class="txt_01"><div align="left"><a href="print.php?inscricaoID=<?php echo $row_RsIndicacao['inscricaoID']; ?>">Vers&atilde;o para Impress&atilde;o</a></div></td>
                                      <td width="19" class="pri"><div align="right"></div></td>
                                    </tr>
                                    <tr>
                                      <td height="19"><div align="left"></div></td>
                      ...
                      <tr>
                        <td class="txt_01"><div align="left" id="meutexto">
                          <p>Inscri&ccedil;&atilde;o n&deg;.: <strong><?php echo $row_RsIndicacao['numero']; ?> / <?php echo $row_RsIndicacao['dataIndicacao']; ?></strong><br />
                              <br />
                                <br />
                                <?php echo $row_RsIndicacao['descricao']; ?><br />
                                <br />
                            <strong><br />
                            JUSTIFICATIVA:</strong><br />  
                            <br />
                            <br />
                            <?php echo $row_RsIndicacao['justificativa']; ?><br />
                            <br />
                            <br />
                            Sala das Sess&otilde;es, <span class="titulo_01"><?php echo $row_RsIndicacao['data']; ?>.</span><br />
                            <br />
                            <br />
                            <?php echo $row_RsIndicacao['autor']; ?><br />
                            Vereador autor</p>
                          </div></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td align="left" class="txt_01"><a href="../uploads/<?php echo $row_RsIndicacao['pdf']; ?>">
                        <?php if ($row_RsIndicacao['pdf'] != "") { // Show if recordset not empty ?>
                          <img src="../img/pdf_logo_01.gif" alt="Baixar PDF" width="35" height="36" border="0" />
