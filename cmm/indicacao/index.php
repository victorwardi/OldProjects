...
$query_RsLei = "SELECT * FROM inscricao ORDER BY inscricaoID ASC";
                      ...
                      <tr>
                        <td class="txt_01"><?php do { ?>
                            <table width="100%" border="0" cellspacing="8" cellpadding="0">
                                  <tr>
                                  <td width="3%" class="select_link_01">&raquo;</td>
                                    <td width="97%" align="left" valign="middle">Indica&ccedil;&atilde;o n &deg;.: <strong><?php echo $row_RsLei['numero']; ?>/<?php echo $row_RsLei['dataIndicacao']; ?> -<span class="select_link_01"> <a href="../indicacao/indicacao.php?inscricaoID=<?php echo $row_RsLei['inscricaoID']; ?>">ver indica&ccedil;&atilde;o</a></span></strong></td>
                                  </tr>
                                                        </table>
                            <?php } while ($row_RsLei = mysql_fetch_assoc($RsLei)); ?></td>
                      </tr>
                      <tr>
                        <td height="38"><div align="left"></div></td>
                      </tr>
