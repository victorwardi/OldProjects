...
$query_RsLeiPorNumero = sprintf("SELECT * FROM inscricao WHERE numero LIKE %s ORDER BY inscricaoID ASC", GetSQLValueString("%" . $colname_RsLeiPorNumero . "%", "text"));
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                      ...
                      <tr>
                        <td height="38" align="left"><span class="txt_01">Sua busca pela indica&ccedil;&atilde;o n&deg;</span> <span class="titulo_01"><?php echo $_POST['numero'];?></span><span class="txt_01">, retornou </span><span class="titulo_01"><?php echo $totalRows_RsLeiPorNumero ?></span><span class="txt_01"> resultado(s).</span></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top" class="txt_01"><?php do { ?>
                              <?php if ($totalRows_RsLeiPorNumero > 0) { // Show if recordset not empty ?>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td>&raquo; Indica&ccedil;&atilde;o inscri&ccedil;&atilde;o n&deg;: <span class="titulo_01"><?php echo $row_RsLeiPorNumero['numero']; ?>,</span> <span class="titulo_01">de <?php echo $row_RsLeiPorNumero['data']; ?> - <a href="../indicacao/indicacao.php?inscricaoID=<?php echo $row_RsLeiPorNumero['inscricaoID']; ?>">ver indica&ccedil;&atilde;o.</a></span></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                  </tr>
