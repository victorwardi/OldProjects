 ...
 tipo=''; 
                                ...
                                <td width="260" valign="top" bgcolor="#DFDFDF"><div align="left">
                                  <table width="260" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="222" class="txt_01"><div align="left"><a href="pv_print.php">Vers&atilde;o para Impress&atilde;o</a></div></td>
                                      <td width="19" class="pri"><div align="right"></div></td>
                                    </tr>
                                    <tr>
                                      <td height="19"><div align="left"></div></td>
                      ...
                      <tr>
                        <td><div align="left" class="txt_01" id="meutexto">
                            <p><strong>Representatividade do Partido Verde 
[ PV/RJ ] na C&acirc;mara Municipal de  Mangaratiba.</strong><br />
                              <br />
                              <br />
                              <br />
                                      <strong>PV/RJ</strong> [ 22,2 % ] N&ordm; de Vereadores: 2<br />
                                        <br />
                                        ...
                                        <br />
                                        <strong><strong>Vereador Marcos Ant&ocirc;nio da Silva Santos</strong></strong><span class="style1"> - Marquinho da Ilha</span><strong><br />
                                        <br />
                                        <a href="../vereadores/marquinhodailha.php"><strong>Ver Perfil</strong></a><br />
                                        <br />
                                        <br />
                                        <br />
                                        <strong>Vereador Ruy Tavares Quintanilha</strong></strong> - Dr. Ruy<strong><br />
                                        <br />
                                        <a href="../vereadores/drruy.php"><strong>Ver Perfil</strong></a></strong><br />  
                                    <br />
                            </p>
                            </div></td>
                      </tr>
