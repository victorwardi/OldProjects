 ...
 tipo=''; 
                                ...
                                <td width="260" valign="top" bgcolor="#DFDFDF"><div align="left">
                                  <table width="260" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="222" class="txt_01"><div align="left"><a href="pmdb_print.php">Vers&atilde;o para Impress&atilde;o</a></div></td>
                                      <td width="19" class="pri"><div align="right"></div></td>
                                    </tr>
                                    <tr>
                                      <td height="19"><div align="left"></div></td>
                      ...
                      <tr>
                        <td><div align="left" class="txt_01" id="meutexto">
                            <p><strong>Representatividade do Partido do Movimento Democr&aacute;tico Brasileiro 
[ PMDB/RJ ] na C&acirc;mara Municipal de  Mangaratiba.</strong><br />
                              <br />
                              <br />
                              <br />
                              <strong>PMDB/RJ</strong> [ 11,1 % ] N&ordm; de Vereadores: 1<br />
                                          <br />
                                          <img src="../img/grafico 03.gif" width="90" height="17" /><br />
                                                <br />
                                                <br />
                                                <br />
                                                <strong>Vereador:</strong><br />
                                                <br />
                                                <strong><strong>Vereador Nelson Lu&iacute;s Bertino dos Santos</strong></strong><span class="style1"> - Nelsinho Bertino</span><strong><br />
                                                <br />
                                                <a href="../vereadores/nelsinhobertino.php"><strong>Ver Perfil</strong></a></strong><br />  
                                    <br />
                            </p>
                            </div></td>
                      </tr>
