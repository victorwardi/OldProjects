 ...
 tipo=''; 
                                ...
                                <td width="260" valign="top" bgcolor="#DFDFDF"><div align="left">
                                  <table width="260" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="222" class="txt_01"><div align="left"><a href="dem_print.php">Vers&atilde;o para Impress&atilde;o</a></div></td>
                                      <td width="19" class="pri"><div align="right"></div></td>
                                    </tr>
                                    <tr>
                                      <td height="19"><div align="left"></div></td>
                      ...
                      <tr>
                        <td><div align="left" class="txt_01" id="meutexto">
                            <p><strong>Representatividade do Partido Democrata 
[ DEM/RJ ] na C&acirc;mara Municipal de  Mangaratiba.</strong><br />
                              <br />
                              <br />
                              <br />
                                    <strong>DEM/RJ</strong> [ 22,2 % ] N&ordm; de Vereadores: 2<br />
                                      <br />
                                      <img src="../img/grafico 02.gif" width="181" height="17" /><br />
                                          <br />
                                          <br />
                                          <br />
                                          <strong>Vereador:</strong><br />
                                          <br />
                                          <strong><strong>Vereador Eduardo Ferreira Jord&atilde;o</strong></strong><span class="style1"> - Edu Jord&atilde;o</span><strong><br />
                                          <br />
                                          <a href="../vereadores/edujordao.php"><strong>Ver Perfil</strong></a><br />
                                          <br />
                                          <br />
                                          <br />
                                          <strong>Vereador Vitor Ten&oacute;rio Santos</strong></strong> - Vitinho<strong><br />
                                          <br />
                                          <a href="../vereadores/vitinho.php"><strong>Ver Perfil</strong></a></strong><br />  
                                    <br />
                            </p>
                            </div></td>
                      </tr>
