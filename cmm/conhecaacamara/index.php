...
$query_RsFotos = "SELECT * FROM acontecenacamara ORDER BY fotoID DESC";
            ...
            <td><div align="left">
              <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="586" height="30" bgcolor="#657D99"><span class="txt_03"><a name="topo" id="topo"></a></span><img src="../img/titulo_conhecaacamara_01.gif" width="186" height="19" /></td>
                </tr>
              </table>
            </div></td>
          </tr>
                  ...
                  <td width="160" height="470" valign="top" bgcolor="#FEDDA5"><div align="left">
                    <table width="160" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td height="25" class="select_link_01"><div align="left"><strong>Conhe&ccedil;a a C&acirc;mara</strong></div></td>
                      </tr>
                      <tr>
                        <td height="25"><div align="left"></div></td>
...
document.getElementById("meutexto").style.fontSize="14px"; 
 tipo=''; 
                        ...
                        <td width="260" rowspan="3" valign="top" bgcolor="#DFDFDF" class="txt_03"><table width="291" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td height="19"><div align="left"></div></td>
                              <td colspan="2" align="center" valign="top" class="txt_01"><div align="center">
                                <table width="215" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td class="txt_01"><div align="justify"><strong>Primeira C&acirc;mara Municipal 
                                      1831<br />
                                      <br />
                                        </strong>Padre Ant&ocirc;nio   Correa de Carvalho<br />
                                      [ 1&ordm; Governador do Munic&iacute;pio ] <br />
                                      <br />
                                      Luiz Fernandes   Monteiro<br />
                                      [ Bar&atilde;o do Sahy ] <br />
                                      <br />
                                      Jos&eacute; Cust&oacute;dio Henriques<br />
                                      <br />
                                      Joaquim   Jo&atilde;o Pinheiro<br />
                                      <br />
                                      Padre Manoel Afonso Nogueira<br />
                                      <br />
                                      Antonio Luiz   Vieira<br />
                                      <br />
                                      <br />
                                      <strong>Primeira Administra&ccedil;&atilde;o   Juridica 
                                        1832</strong><br />
                                      <br />
                                      1&ordm; Juiz Ordin&aacute;rio &ndash; Vicente Alvares Teixeira   Rubi&atilde;o<br />
                                      <br />
                                      2&ordm; Juiz Ordin&aacute;rio &ndash; Manoel Jo&atilde;o Pinheiro<br />
                                      <br />
                                      1&ordm; Juiz de &Oacute;rf&atilde;os   &ndash; Capit&atilde;o Rodrigo Jos&eacute; de Ara&uacute;jo Azambuja<br />
                                      <br />
                                      1&ordm; Deposit&aacute;rio da &Aacute;rea de   &Oacute;rf&atilde;os &ndash; Jos&eacute; Eloy da Silva Passos</div></td>
                                  </tr>
                                </table>
                              </div></td>
                              <td class="pri">&nbsp;</td>
                        ...
                        <td width="260" valign="top" class="txt_03"><table width="260" cellspacing="0" cellpadding="0">
                            <tr>
                              <td class="txt_01"><div class="classe1 style1" id="meutexto">
                                  <div align="justify">
                                    <p><strong>C&acirc;mara Municipal de Mangaratiba</strong><br />
                                      <br />
                                      <strong>CNPJ:</strong><br />
                                      <br />
27.215.946/0001-21<br />
<br />
<br />
<strong>Endere&ccedil;o:</strong><br />
<br />
Travessa Vereador Vivaldo Eloy da Silva Passos, s/ n&ordm;<br />
Centro - Mangaratiba - Rio de Janeiro<br />
<br />
<br />
...
<strong>Fax<br />
<br />
</strong>Ramal: 215<strong><br />
<br /> 
<br />
Web Site:</strong><br />
<br />
www.cmmangaratiba.rj.gov.br<br />
<br />
<br />
<strong>E-Mail:</strong><br />
<br />
contato@cmmangaratiba.rj.gov.br</p>
                                  </div>
                              </div></td>
                            </tr>
                            <tr>
                              <td height="40" class="txt_01"><div align="left"></div></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td align="left" valign="top" class="txt_01"><div align="left">
                                <table width="48" border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <?php
do { // horizontal looper version 3
?>
                                    <td width="66"><table width="48" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
                                        <tr>
                                          <td width="44" align="center"><table width="40" border="0" cellspacing="0" cellpadding="4">
                                              <tr>
                                                <td width="50" bgcolor="#FEDDA5"><p><a href="<?php echo tNG_showDynamicImage("../", "../uploads/fotos/", "{RsFotos.arquivo}");?>" rel="lightbox[fotos]"  title="<?php echo $row_RsFotos['descricao']; ?>"><img src="<?php echo $objDynamicThumb1->Execute(); ?>" width="32" height="32" border="0" /></a></p>
                                                  </td>
                                              </tr>
                                          </table></td>
                                        </tr>
                        ...
                        <td colspan="3" class="txt_01"><div align="right">
                          <table width="566" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="100" valign="middle" class="txt_01"><div align="right"><a href="../index.php"><strong>&lt;&lt; P&aacute;gina Inicial </strong></a><a href="/index.php"></a> <a href="/index.php"></a> <a href="/index.php"></a> </div></td>
                            </tr>
                          </table>
                        </div></td>
                      </tr>
