            ...
            <td><div align="left">
              <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="586" height="30" bgcolor="#657D99"><span class="txt_03"><a name="topo" id="topo"></a></span><img src="../img/titulo_comissoes_01.gif" width="114" height="16" /></td>
                </tr>
              </table>
            </div></td>
          </tr>
                ...
                <tr>
                  <td width="160" height="470" valign="top" bgcolor="#FEDDA5"><div align="left">
                    <table width="160" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        <td height="25" class="select_link_01"><div align="left"><strong>Comiss&otilde;es</strong></div></td>
                      </tr>
                      <tr>
                        <td height="25"><div align="left"></div></td>
                        ...
                        <td align="left" valign="top"><div align="left" class="txt_01" id="meutexto">
                          <?php do { ?>
                            <table width="100%" border="0" cellspacing="8" cellpadding="0">
                                <tr>
                                  <td align="left" valign="top" class="titulo_01"><?php echo $row_RsComissao['titulo']; ?></td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top"><?php echo $row_RsComissao['texto']; ?></td>
                                </tr>
                                <tr>
                            ...
                            <?php } while ($row_RsComissao = mysql_fetch_assoc($RsComissao)); ?><p>&nbsp;</p>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="38"><div align="left"></div></td>
