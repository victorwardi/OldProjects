...
// Filter
$tfi_listuser1 = new TFI_TableFilter($conn_fotos, "tfi_listuser1");
...
$query_rsuser1 = sprintf("SELECT user.nome, user.senha, user.id FROM user WHERE %s ORDER BY %s", $NXTFilter_rsuser1, $NXTSort_rsuser1);
$query_limit_rsuser1 = sprintf("%s LIMIT %d, %d", $query_rsuser1, $startRow_rsuser1, $maxRows_rsuser1);
$rsuser1 = mysql_query($query_limit_rsuser1, $fotos) or die(mysql_error());
      ...
      <tr>
        ...
        <td width="541" align="left" valign="top"><!-- InstanceBeginEditable name="conteudo" -->
          <table width="100%" border="0" cellspacing="2" cellpadding="4">
            ...
            <tr>
              <th align="left" scope="col"><span class="Titulo_galeria">Usu&aacute;rio
                  <?php
                      ...
                      <table border="1" cellpadding="2" cellspacing="0" bordercolor="#313639" class="KT_tngtable">
                        <thead>
                          <tr class="KT_row_order">
                            <th align="center" bgcolor="#313639" class="menu"> <input type="checkbox" name="KT_selAll" id="KT_selAll"/>                            </th>
                            <th align="center" bgcolor="#313639" class="menu" id="nome"> <a href="<?php echo $tso_listuser1->getSortLink('user.nome'); ?>">Nome</a> </th>
                            <th align="center" bgcolor="#313639" class="menu" id="senha"> <a href="<?php echo $tso_listuser1->getSortLink('user.senha'); ?>">Senha</a> </th>
                            <th align="center" bgcolor="#313639" class="menu">&nbsp;</th>
                          </tr>
                          <?php 
                          ...
                          <?php if ($totalRows_rsuser1 > 0) { // Show if recordset not empty ?>
                            <?php do { ?>
                              <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                                ...
                                <td align="center" class="menu"><div class="KT_col_nome"><?php echo KT_FormatForList($row_rsuser1['nome'], 20); ?></div></td>
                                <td align="center" class="menu"><div class="KT_col_senha"><?php echo KT_FormatForList($row_rsuser1['senha'], 20); ?></div></td>
