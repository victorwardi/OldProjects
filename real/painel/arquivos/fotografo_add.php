...
$ins_fotografo = new tNG_multipleInsert($conn_fotos);
$tNGs->addTransaction($ins_fotografo);
// Register triggers
$ins_fotografo->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Insert1");
$ins_fotografo->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$ins_fotografo->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../includes/nxt/back.php");
// Add columns
$ins_fotografo->setTable("fotografo");
$ins_fotografo->addColumn("nome", "STRING_TYPE", "POST", "nome");
$ins_fotografo->setPrimaryKey("id", "NUMERIC_TYPE");

// Make an update transaction instance
$upd_fotografo = new tNG_multipleUpdate($conn_fotos);
$tNGs->addTransaction($upd_fotografo);
// Register triggers
$upd_fotografo->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_fotografo->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_fotografo->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../includes/nxt/back.php");
// Add columns
$upd_fotografo->setTable("fotografo");
$upd_fotografo->addColumn("nome", "STRING_TYPE", "POST", "nome");
$upd_fotografo->setPrimaryKey("id", "NUMERIC_TYPE", "GET", "id");

// Make an instance of the transaction object
$del_fotografo = new tNG_multipleDelete($conn_fotos);
$tNGs->addTransaction($del_fotografo);
// Register triggers
$del_fotografo->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Delete1");
$del_fotografo->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../includes/nxt/back.php");
// Add columns
$del_fotografo->setTable("fotografo");
$del_fotografo->setPrimaryKey("id", "NUMERIC_TYPE", "GET", "id");

// Execute all the registered transactions
$tNGs->executeTransactions();

// Get the transaction recordset
$rsfotografo = $tNGs->getRecordset("fotografo");
$row_rsfotografo = mysql_fetch_assoc($rsfotografo);
$totalRows_rsfotografo = mysql_num_rows($rsfotografo);
                  ...
                  <div class="KT_tngform">
                    <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>">
                      ...
                      <?php do { ?>
                        ...
                        <?php 
// Show IF Conditional region1 
if (@$totalRows_rsfotografo > 1) {
?>
                          <h2 class="titulo_menu"><?php echo NXT_getResource("Record_FH"); ?> <?php echo $cnt1; ?></h2>
                          <?php } 
// endif Conditional region1
?>
                        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                          <tr>
                            <td class="titulo"><label for="nome_<?php echo $cnt1; ?>">Nome:</label></td>
                            <td class="titulo"><input type="text" name="nome_<?php echo $cnt1; ?>" id="nome_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsfotografo['nome']); ?>" size="32" maxlength="100" />
                                <?php echo $tNGs->displayFieldHint("nome");?> <?php echo $tNGs->displayFieldError("fotografo", "nome", $cnt1); ?> </td>
                          </tr>
                        </table>
                        <input type="hidden" name="kt_pk_fotografo_<?php echo $cnt1; ?>" class="id_field" value="<?php echo KT_escapeAttribute($row_rsfotografo['kt_pk_fotografo']); ?>" />
                        <?php } while ($row_rsfotografo = mysql_fetch_assoc($rsfotografo)); ?>
