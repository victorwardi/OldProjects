      ...
      <tr>
        ...
        <td width="541" align="left" valign="top"><!-- InstanceBeginEditable name="conteudo" -->
          <table width="100%" border="0" cellspacing="2" cellpadding="4">
            ...
            <tr>
              <th align="left" scope="col"><span class="Titulo_galeria">Galeria Inserida com Sucesso!</span><br />
                <br />
                <span class="titulo_coment">Para inserir outra galeria <a href="galeria_add.php">clique aqui</a>. </span><br /></th>
            </tr>
            <tr>
