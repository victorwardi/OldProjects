...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
   <td colspan="4" align="center" valign="top" bgcolor="#575C60"><table width="80%" border="0" cellspacing="0" cellpadding="0">
     <tr>
       <th bgcolor="#575C60" scope="col"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#24282B" class="borda_menu">
         <tr>
           ...
           <th width="1%" align="center" valign="middle" class="menu" scope="col">|</th>
           <th width="14%" align="center" valign="middle" class="menu" scope="col"><a href="servico.php">Serviços</a></th>
           <th width="1%" align="center" valign="middle" class="menu" scope="col">|</th>
     ...
     <tr>
       <th scope="row"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#575C60" bgcolor="#34393C" class="borda_menu">
         <tr>
     ...
     <tr>
       <th scope="row"><table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#24282B" class="borda_menu">
         <tr>
           <th class="texto_rodape2" scope="col">Proibida cópia total ou parcial de qualquer conteúdo deste site sem autorização! </th>
         </tr>
       </table></th>
     </tr>
     <tr>
       <th height="18" class="texto_rodape2" scope="row">RealFotos.com.br® -2007- Todos os direitos reservados </th>
     </tr>
     <tr>
