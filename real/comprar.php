     ...
     <tr>
       <th scope="row"><!-- InstanceBeginEditable name="conteudo" -->
         <table width="100%" border="0" cellpadding="0" cellspacing="4" bordercolor="#575C60" bgcolor="#34393C" class="borda_menu">
           <tr>
             <th height="30" align="left" valign="top" scope="col"><img src="imagens/titulos/grandes/comprar.jpg" alt="Comprar Foto" width="180" height="30" /></th>
           </tr>
           <tr>
             <th height="54" align="center" valign="top" scope="col"><table width="95%" border="0" cellspacing="2" cellpadding="0">
               <tr>
               ...
               <tr>
                 <th align="left" valign="middle" class="titulo" scope="col"><?php echo $row_fotos['descricao']; ?></th>
                 <td width="37%" rowspan="4" align="center" valign="top"><img src="<?php echo tNG_showDynamicThumbnail("", "fotos/", "{fotos.arquivo}", 150, 0, true); ?>" class="borda_galeria" /></td>
                 <td width="6%" rowspan="4">&nbsp;</td>
                 <td width="6%" rowspan="4">&nbsp;</td>
               </tr>
               <tr>
                 <th align="left" valign="middle" scope="row"><span class="negrito">Galeria: </span><span class="fonte"><?php echo $row_capa['nome']; ?></span></th>
               </tr>
               <tr>
                 <th align="left" valign="middle" scope="row"><span class="negrito">Local:</span> <span class="fonte"><?php echo $row_fotos['local']; ?></span></th>
               </tr>
               <tr>
                 <th align="left" valign="middle" scope="row"><span class="negrito">Fot&oacute;grafo:</span> <span class="fonte"><?php echo $row_fotos['fotografo']; ?></span></th>
               </tr>
               <tr>
                 <th height="52" colspan="3" align="center" valign="middle" class="negrito" scope="row"><a href="javascript:abrir('info.php','','width=510,height=610')" class="negrito">Clique aqui para saber das formas de envio e pagamento! </a></th>
                 <td>&nbsp;</td>
               </tr>
             </table>
               <table width="95%" border="1" cellpadding="4" cellspacing="0" bordercolor="#24282B">
                 <tr>
                   <th align="left" valign="middle" bgcolor="#24282B" scope="col"><span class="Titulo_galeria">                     Dados para a Compra </span></th>
                 </tr>
                 <tr>
                   <th align="left" valign="top" scope="row"><div id="conteudo_interno" class="left">
				<h2>
				...
				<div>
					...
					<label for="Nome" class="titulo_coment">Nome:</label>
						...
						<label for="cod" class="titulo_coment">C&oacute;digo da Foto :</label>
					...
					<label for="Tipo" class="titulo_coment">Tipo da Foto :</label>
					...
					<label for="quant" class="titulo_coment">Quantidade de C&oacute;pias  :</label>
					<select name="Quantidade" class="textbox2" id="quantidade">
					  ...
					  <option value="3">3 c&oacute;pias</option>
						...
						<label for="Mensagem" class="titulo_coment">Observa&ccedil;&otilde;es:</label>
