...
?>
                     <td><table width="145" height="100" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#24282B"   background="<?php echo tNG_showDynamicThumbnail("", "design/", "{fotos.arquivo}", 300, 0, true); ?>" id="ver">
                           <tr>
