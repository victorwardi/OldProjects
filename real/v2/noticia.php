...
mysql_select_db($database_fotos, $fotos);
$query_not = sprintf("SELECT * FROM noticias WHERE id = %s ORDER BY id DESC", $colname_not);
$not = mysql_query($query_not, $fotos) or die(mysql_error());
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <th scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                <tr>
                  <td colspan="2" align="left" class="titulo_galerias"><?php echo $row_not['titulo']; ?> - <?php echo $row_not['data']; ?></td>
                  </tr>
                <tr>
                  <td width="17%" align="left" valign="top"><img src="<?php echo tNG_showDynamicThumbnail("../", "../fotos/", "{not.imagem}", 300, 0, true); ?>" class="borda_4pxcinza_escuto" /></td>
                  <td width="83%" align="left" valign="top" class="texto_11px_preto"><?php echo $row_not['materia']; ?></td>
                </tr>
                <tr>
                  <td colspan="2">&nbsp;</td>
                  </tr>
