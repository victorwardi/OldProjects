...
mysql_select_db($database_fotos, $fotos);
$query_fotos = sprintf("SELECT * FROM fotos_digitais WHERE descricao LIKE '%%%s%%' ORDER BY id_foto DESC", $colname_fotos);
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <th align="left" valign="middle" bgcolor="#333333" scope="col"><table width="100%" border="0" cellpadding="0" cellspacing="4" bgcolor="#333333">
                <tr>
                  <th align="left" valign="middle" class="titulo_branco_16px" scope="col">Resultado da busca de fotos pelo nome da Atleta </th>
                </tr>
              </table></th>
            </tr>
            <tr>
