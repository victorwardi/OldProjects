...
$colname_nome = "-1";
if (isset($_GET['id'])) {
  $colname_nome = (get_magic_quotes_gpc()) ? $_GET['id'] : addslashes($_GET['id']);
}
mysql_select_db($database_fotos, $fotos);
$query_nome = sprintf("SELECT * FROM galeria WHERE id = %s ORDER BY id DESC", $colname_nome);
$nome = mysql_query($query_nome, $fotos) or die(mysql_error());
$row_nome = mysql_fetch_assoc($nome);
$totalRows_nome = mysql_num_rows($nome);
?>
     ...
     <tr>
       <th scope="row"><!-- InstanceBeginEditable name="conteudo" -->
         <table width="100%" border="0" cellpadding="0" cellspacing="4" bordercolor="#575C60" bgcolor="#34393C" class="borda_menu">
           <tr>
             <th width="7%" height="30" align="left" valign="top" scope="col"><img src="imagens/titulos/grandes/circulo.jpg" width="35" height="30" /></th>
             <th width="93%" align="left" valign="middle" class="Titulo_galeria" scope="col"><?php echo $row_nome['nome']; ?></th>
           </tr>
           <tr>
             <th height="54" colspan="2" align="left" valign="top" scope="col"><table border="0">
               <tr>
                 <?php
  do { // horizontal looper version 3
?>
                 <td><a href="javascript:abrir('foto.php?id_foto=<?php echo $row_galerias['id_foto']; ?>&amp;id=<?php echo $row_galerias['id']; ?>','','width=600,height=610')"><img src="<?php echo tNG_showDynamicThumbnail("", "fotos/", "{galerias.arquivo}", 142, 0, true); ?>" border="0" class="borda_galeria" /></a></td>
                 <?php
    $row_galerias = mysql_fetch_assoc($galerias);
...
?>
           ...
           <tr>
             <th height="54" colspan="2" align="left" valign="top" scope="col"><table width="100%" border="0" cellspacing="3" cellpadding="0">
               <tr>
               ...
               <tr>
                 <td height="79" align="left" valign="top"><p><span class="texto_galeria">O RealFotos.com.br n&atilde;o publicar&aacute; coment&aacute;rios ofensivos, desrespeitosos  e que venham h&aacute; prejudicar ou insultar quem quer que seja! 
               ...
               <tr>
                 <td align="center" valign="middle"><table width="126" height="22" border="0" cellpadding="0" cellspacing="2" class="borda_tabela">
                     <tr>
                       <td width="122" align="center" valign="middle" bgcolor="#575C60"><a href="javascript:abrir('comentar.php?id=<?php echo $row_nome['id']; ?>','','width=420,height=540')" class="titulo">Comentar</a></td>
                     </tr>
                 </table>                   </td>
               </tr>
               <tr>
