...
mysql_select_db($database_fotos, $fotos);
$query_fotos = "SELECT * FROM design ORDER BY id DESC";
     ...
     <tr>
       <th scope="row"><!-- InstanceBeginEditable name="conteudo" -->
         <table width="100%" border="0" cellpadding="0" cellspacing="4" bordercolor="#575C60" bgcolor="#34393C" class="borda_menu">
           <tr>
             <th height="30" align="left" valign="top" scope="col"><img src="imagens/titulos/grandes/design.jpg" alt="Design" width="110" height="30" /></th>
           </tr>
           <tr>
             <th height="52" align="left" valign="top" scope="col">&nbsp;
               <table border="0" cellpadding="0" cellspacing="4">
                 <tr>
                   <?php
  do { // horizontal looper version 3
?>
                     <td><table width="145" height="100" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#24282B"   background="<?php echo tNG_showDynamicThumbnail("", "design/", "{fotos.arquivo}", 200, 0, true); ?>" id="ver">
                           <tr>
                             <th width="100%" height="100%" align="center" valign="bottom"  scope="col"><a href="<?php echo tNG_showDynamicImage("", "design/", "{fotos.arquivo}");?>" 
				title="<?php echo $row_fotos['descricao']; ?> &lt;br /&gt;
Autor: <?php echo $row_fotos['autor']; ?>" class="Titulo_galeria" 
				rel="lightbox[<?php echo $row_fotos['design']; ?>]">+ Visualizar</a></th>
                           </tr>
                                    </table></td>
                     <?php
    $row_fotos = mysql_fetch_assoc($fotos);
...
?>
               ...
               <p class="texto_galeria">&nbsp;</p>
               <p class="texto_galeria"><a href="#"></a></p></th>
           </tr>
         </table>
