     ...
     <tr>
       <th scope="row"><!-- InstanceBeginEditable name="conteudo" -->
         <table width="100%" border="0" cellpadding="0" cellspacing="4" bordercolor="#575C60" bgcolor="#34393C" class="borda_menu">
           <tr>
             <th height="30" align="left" valign="top" scope="col"><img src="imagens/titulos/grandes/quem.jpg" alt="Quem Somos" width="150" height="30" /></th>
           </tr>
           <tr>
             <th height="54" align="center" valign="top" scope="col"><table width="95%" border="0" cellspacing="0" cellpadding="4">
               <tr>
                 <th width="21%" align="left" valign="middle" scope="col">&nbsp;</th>
                 <th width="31%" align="left" valign="middle" scope="col">&nbsp;</th>
                 <th width="21%" align="left" valign="middle" scope="col">&nbsp;</th>
