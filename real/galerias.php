     ...
     <tr>
       <th scope="row"><!-- InstanceBeginEditable name="conteudo" -->
         <table width="100%" border="0" cellpadding="0" cellspacing="4" bordercolor="#575C60" bgcolor="#34393C" class="borda_menu">
           <tr>
             <th height="24" align="left" valign="top" scope="col"><img src="imagens/titulos/grandes/galerias.jpg" alt="Galerias de Fotos" width="180" height="30" /></th>
           </tr>
           <tr>
             <th height="54" align="left" valign="top" scope="col"><table border="0">
               <tr>
                 <?php
...
?>
                 <td><table width="162" border="0" cellspacing="0" cellpadding="0">
                     <tr>
                       <th align="center" valign="middle" scope="col">&nbsp;<a href="galeria.php?id=<?php echo $row_capa['id']; ?>"><img src="<?php echo tNG_showDynamicThumbnail("", "fotos/capa/", "{capa.imagem}", 165, 0, true); ?>" border="0" class="borda_galeria" /></a></th>
                     </tr>
                     <tr>
