...
<%
	...
	Count = Upload.Save("C:\inetpub\wwwroot\saquabb.com.br\fotos_principal\upload")
	...
	Else
		...
		If File.ImageType <> "UNKNOWN" Then
			...
			SavePath = "C:\inetpub\wwwroot\saquabb.com.br\fotos_principal\400x300_" & File.ExtractFileName
			...
			SavePath = "C:\inetpub\wwwroot\saquabb.com.br\fotos_principal\th_" & File.ExtractFileName
