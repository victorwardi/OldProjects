...
If (Request.QueryString("key") <> "") Then 
  RsGaleria__MMColParam = Request.QueryString("key")
End If
%>
<%
Dim RsGaleria
...
If Request.QueryString("key") <> "" then
RsGaleria.Source = "SELECT *  FROM fotos  WHERE descricao LIKE '%" + Replace(RsGaleria__MMColParam, "'", "''") + "%'  ORDER BY CodFoto DESC"
Else
RsGaleria.Source = "SELECT * FROM fotos ORDER BY CodFoto DESC"
End If
...
<body>
<img src="/galeria_fotos/images/spacer.gif" width="1" height="10">
<table border="0" align="center" cellpadding="0" cellspacing="0">
  <% 
While ((Repeat1__numRows <> 0) AND (NOT RsGaleria.EOF)) 
%>
  <tr>
    <td><a href="/galeria_fotos/galeria/foto.asp?CodFoto=<%=(RsGaleria.Fields.Item("CodFoto").Value)%>" target="foto"><img src="/galeria_fotos/galeria/gerath.asp?arquivo=../fotos/<%=(RsGaleria.Fields.Item("arquivo").Value)%>" border="0"></a></td>
  </tr>
  <tr>
    <td height="3" ></td>
  </tr>
...
<table border="0" width="100" align="center">
  <tr>
    <td width="31%" align="center">
      <% If MM_offset <> 0 Then %>
      <a href="<%=MM_movePrev%>" class="mar">&lt;&lt;</a>
      <% End If ' end MM_offset <> 0 %>
    </td>
    <td width="23%" align="center">
      <% If Not MM_atTotal Then %>
      <a href="<%=MM_moveNext%>" class="mar">&gt;&gt;</a>
