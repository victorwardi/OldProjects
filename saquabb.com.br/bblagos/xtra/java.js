...
function openPictureWindow_Fever(imageName,imageWidth,imageHeight,alt,posLeft,posTop) {
	...
	newWindow.document.write('<html><title>'+alt+'</title><body bgcolor="#D65501" leftmargin="0" topmargin="0" marginheight="0" marginwidth="0" onBlur="self.close()">'); 
	newWindow.document.write('<img src='/xtra/+imageName+' width='+imageWidth+' height='+imageHeight+' alt='+alt+'>'); 
