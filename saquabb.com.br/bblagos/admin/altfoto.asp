...
RsFoto.ActiveConnection = MM_conexao_STRING
...
RsGalerias.ActiveConnection = MM_conexao_STRING
...
RsNoticias.ActiveConnection = MM_conexao_STRING
...
<table width="776" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000099">
  <tr>
    <td width="772" height="25" bgcolor="#000000"><div align="center"><span class="tur">Administrativo Saquabb</span></div></td>
  </tr>
  <tr>
    <td height="25" bgcolor="#000000"><div align="center"><span class="tur">Alterar Foto </span></div></td>
  </tr>
  <tr>
    <td><p>&nbsp;</p>
        <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1" target="_self" id=form>
          <div align="center">
            <center>
              <table width="459" border="0" cellpadding="5" cellspacing="0" bordercolor="#FFFFFF" class="tbl">
                <tr>
                  <td valign="top">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td><textarea name="descricao" cols="45" rows="3" class="caixa" id="textarea9" style="border-style: solid; border-width: 2"><%=(RsFoto.Fields.Item("descricao").Value)%></textarea>
                  </td>
                </tr>
                <tr>
                  <td valign="top">Fot&oacute;grafo:</td>
                  <td><input name="fotografo" type="text" class="caixa" id="fotografo" value="<%=(RsFoto.Fields.Item("fotografo").Value)%>" size="50"></td>
                </tr>
                <tr>
                  <td valign="top"><font face="Verdana" size="2">Altura<span class="desc">:</span></font></td>
                  <td><span class="desc">
                    <input name="altura" type="text" class="caixa" id="autor5" value="<%=(RsFoto.Fields.Item("altura").Value)%>" size="20">
                  </span></td>
                </tr>
                <tr>
                  <td valign="top"><font face="Verdana" size="2">Largura:</font></td>
                  <td><input name="largura" type="text" class="caixa" id="autmail5" value="<%=(RsFoto.Fields.Item("largura").Value)%>" size="20"></td>
                </tr>
                <tr>
                  <td>Galeria:</td>
                  <td>
                    <select name="galeria" class="caixa" id="galeria">
...
Wend %>
                ...
                <tr>
                  ...
                  <td>
                    <select name="noticia" class="caixa" id="noticia">
