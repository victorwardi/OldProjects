...
Rs_update.Source = "SELECT * FROM ranking_a ORDER BY colocacao ASC"
...
<table width="524" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <th height="20" bgcolor="#0099FF" scope="col"><span class="style5">Ranking Amador </span></th>
  </tr>
  <tr>
...
%>
          <table width="500" border="0" cellpadding="0" cellspacing="0" class="linha">
            <tr>
                <th width="25" scope="col"><a href="atualizar_ranking_a.asp?Cod=<%=(Rs_update.Fields.Item("Cod").Value)%>"><img src="bola.jpg" alt="Editar" width="10" height="10" border="0"></a></th>
                <th width="100" scope="col"><%=(Rs_update.Fields.Item("colocacao").Value)%></th>
                <th width="250" height="25" scope="col"><a href="atualizar_ranking_a.asp?Cod=<%=(Rs_update.Fields.Item("Cod").Value)%>"><%=(Rs_update.Fields.Item("nome").Value)%></a></th>
