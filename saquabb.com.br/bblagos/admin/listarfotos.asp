...
RsFotos.ActiveConnection = MM_conexao_STRING
...
<table width="464" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="772" height="25" bgcolor="#0099FF"><div align="center"><span class="tur style1"> Alterar Fotos da Sess&atilde;o de Noticias            <span class="style7"> </span><br>
    </span></div></td>
  </tr>
  <tr>
    <td align="center">
...
%>
      <tr>
        <td width="85" height="18" align="center" valign="middle">
          ...
          <td width="89"><a href="altfoto.asp?CodFoto=<%=(RsFotos.Fields.Item("CodFoto").Value)%>"><img src="../fotos/<%=(RsFotos.Fields.Item("arquivo").Value)%>" alt="" width="79" height="59" vspace="5" border="0"></a></td>
