...
Fotos.ActiveConnection = MM_conexao_STRING
          ...
          <table width="610" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="center" valign="top" background="../imagens/fundo_tabela.jpg"><table width="610" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center" valign="top"><table width="550" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <th height="30" colspan="2" scope="col"><div align="center"><span class="style2 style3 style4 style5"><span class="style60 style70"><%=(RsNot.Fields.Item("titulo").Value)%></span></span></div></th>
                      </tr>
                      <tr align="center" valign="middle">
                        <td colspan="2"><div align="center"><span class="style1">
                          <%
' Show If File Exists (region1)
  If tNG_fileExists("../bblagos/fotos/fotos/", "{Fotos.arquivo}") Then
%>
                          <img src="fotos/upload/foto_<%=(Fotos.Fields.Item("arquivo").Value)%>" border="0" align="absmiddle" class="brd" bordercolor="#000000">
                          <%
  End If
' End Show If File Exists (region1)
%>
                        </span></div></td>
                      </tr>
                      <tr>
                        <td width="268" height="30" bgcolor="#FFFFFF" class="data style71"><span class="mar">Autor: </span><a href="mailto:<%=(RsNot.Fields.Item("autmail").Value)%>" class="autor"><em><strong><%=(RsNot.Fields.Item("autor").Value)%></strong></em></a></td>
                        <td width="203" bgcolor="#FFFFFF" class="data">&nbsp;<span class="style71">Data: <strong><%=(RsNot.Fields.Item("data").Value)%></strong></span></td>
                      </tr>
                      <tr align="left" valign="top">
                        <td colspan="2"><% if  (Not Fotos.eof) then %>
                            ...
                            <% end if  %>
                            <% response.write replace((RsNot.Fields.Item("materia").Value), vbcrlf,"<br>")%></td>
                      </tr>
                      <tr>
                        <td colspan="2">&nbsp;</td>
                      </tr>
