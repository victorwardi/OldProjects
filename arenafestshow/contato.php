      ...
      <table width="100%" border="0" cellspacing="6" cellpadding="0">
        <tr>
          <td width="70%" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="6">
            <tr>
              <td width="70%" height="25" align="left" valign="middle" class="TITULOS">Contato</td>
            </tr>
            <tr>
            ...
            <tr>
              <td align="left" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="4">
                <tr>
                  <th height="77" align="left" valign="top" class="txt_padrao" scope="row"><p class="txt_galeria_descricao">Para entrar em contato com a Arena Fest utilize: </p>
                      <ul>
                        <li class="txt_padrao">EMAIL: contato@arenafestshow.com.br</li>
                        <li><span class="txt_padrao">TEL: (22) 9997-7190 </span><br />
                        </li>
                      </ul></th>
                </tr>
                <tr>
                  <th height="30" align="left" valign="top" class="txt_padrao" scope="row">Se preferir  preencha o formul&aacute;rio abaixo!<br />
                      * preencha todos os campos corretamente.</th>
                </tr>
                <tr>
