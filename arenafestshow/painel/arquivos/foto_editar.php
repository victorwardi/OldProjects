...
$tfi_listfotos1->addColumn("fotos.arquivo", "STRING_TYPE", "arquivo", "%");
...
$objDynamicThumb1->setResize(80, 50, false);
                  ...
                  <table cellpadding="2" cellspacing="0" class="borda_roxa" id="painel">
                    <thead>
                      <tr class="KT_row_order">
                        ...
                        <th align="center" bgcolor="#3333FF" class="KT_sorter KT_col_arquivo <?php echo $tso_listfotos1->getSortIcon('fotos.arquivo'); ?>" id="arquivo"> <a href="<?php echo $tso_listfotos1->getSortLink('fotos.arquivo'); ?>">Arquivo</a> </th>
                        <th align="center" bgcolor="#3333FF" class="KT_sorter KT_col_descricao <?php echo $tso_listfotos1->getSortIcon('fotos.descricao'); ?>" id="descricao"> <a href="<?php echo $tso_listfotos1->getSortLink('fotos.descricao'); ?>">Descri&ccedil;&atilde;o</a> </th>
