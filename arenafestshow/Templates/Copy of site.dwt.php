...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','900','height','134','src','flash/topo','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','wmode','Transparent','movie','flash/topo' ); //end AC code
  ...
  <tr>
    <td height="80" align="center" valign="top" background="../img/fundo_meio.jpg"><table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td height="120" align="center" valign="middle"><table width="98%" border="0" cellpadding="0" cellspacing="2" bgcolor="#FFFFFF" class="borda_propaganda">
          <tr>
            <td align="center">
			<script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','880','height','80','src','flash/contagemRegressiva','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','wmode','Transparent','movie','flash/contagemRegressiva' ); //end AC code
    </script><noscript><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="880" height="80">
              <param name="movie" value="../flash/contagemRegressiva.swf" />
			    <param name="wmode" value="transparent"/>
              <param name="quality" value="high" />
              <embed src="../flash/contagemRegressiva.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="880" height="80"></embed>
            </object></noscript></td>
          </tr>
        </table></td> 
      </tr>
  ...
  <tr>
    <td height="216" align="center" valign="top" background="../img/fundo_meio.jpg"><!-- TemplateBeginEditable name="conteudo" -->
