...
// Sistema de notícias em Flash - Adapatado por Victor Caetano
  ...
  //conectando ao mysql
  $conn = @mysql_connect("localhost", "arenafest","arena");  
  $db   = @mysql_select_db("arena", $conn);
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','467','height','240','src','capa','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','capa' ); //end AC code
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th scope="col"><table width="200" border="0" cellpadding="0" cellspacing="2" class="borda_cinza">
                  ...
                  <tr>
                    <th scope="col"><img src="<?php echo tNG_showDynamicImage("", "uploads/fotos/", "{RsEventos.capa}");?>" width="210" height="120" /></th>
                  </tr>
                  <tr>
        ...
        <tr>
          <td width="55%" align="center" valign="top" bgcolor="#F3F8A6"><table width="98%" border="0" cellpadding="0" cellspacing="4" bgcolor="#F3F8A6">
              ...
              <tr>
                <td height="76" align="center" valign="middle" bgcolor="#FFFFFF" class="txt_galeria_descricao"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="borda_4px_azul">
                  <tr>
                    <th scope="col"><img src="img/propagandas/promo.jpg" alt="promo&ccedil;&otilde;es" width="453" height="100" /></th>
                  </tr>
                </table></td>
              </tr>
              <tr>
          ...
          <td width="45%" height="468" align="left" valign="top" bgcolor="#F3F8A6"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="4">
              <tr>
                <td height="76" align="center" valign="middle" bgcolor="#F3F8A6" class="txt_galeria_descricao"><table width="96%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="borda_4px_azul">
                  <tr>
                    <th scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <th scope="col"><p><img src="img/propagandas/orkut.jpg" width="370" height="82" /></p></th>
                        </tr>
                    </table></th>
                  </tr>
                </table></td>
              ...
              <tr>
                <td height="45" align="center" valign="middle" bgcolor="#F3F8A6" class="txt_galeria_descricao"><table width="96%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="borda_4px_azul">
                  <tr>
                    <th scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <th scope="col"><p><img src="img/propagandas/leo2.jpg" width="370" height="82" /></p>
                            </th>
                        </tr>
                    </table></th>
                  </tr>
              ...
              <tr>
                <td height="76" align="center" valign="middle" bgcolor="#F3F8A6" class="txt_galeria_descricao"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="borda_4px_azul">
                  <tr>
                    <th scope="col"><img src="img/propagandas/peter2.jpg" alt="Peter" width="370" height="82" /></th>
                  </tr>
                </table></td>
              </tr>
