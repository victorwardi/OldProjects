...
<script type="text/javascript" src="js/functionAddEvent.js"></script>
	...
	label { display:block; }
	input.text,textarea { width:300px;font:12px/12px 'courier new',courier,monospace;color:#333;padding:3px;margin:1px 0;border:1px solid #333; }
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center" valign="middle" bgcolor="#0E0C0D"><img src="images/titulos/contato.jpg" alt="Contato" width="260" height="40" /></td>
  ...
  <tr>
    <td colspan="5" align="center" valign="top" background="images/conteudo/conteudo_r6_c1.jpg"><table width="90%" border="0" cellpadding="0">
      <tr>
        <th height="52" align="left" class="texto_negrito" scope="col"><p>Para entrar em contato com a Banda Legionn&aacute;rios sobre  shows, cr&iacute;ticas, parcerias...<br />
          utilize o formul&aacute;rio ou se preferir:
          </p>
          <p><br />
            Telefone:</p>
          <ul><li>(21)  9275 - 0900</li>
            <li>(21) 9751 - 7460</li>
            <li>              (22) 2031 - 5082<br />
            </li>
            </ul>
          <p>Email:</p>
          <ul><li>comercial@legionnarios.com</li>
            <li>faclube@legionnarios.com</li>
          </ul>          
          <p>Produ&ccedil;&atilde;o: Bruno Fontes - email: fb.producoes@globo.com </p>
          <p>Dire&ccedil;&atilde;o: Fl&aacute;vio Barreto - email: fb.direcao@globo.com</p>
          <p>Comercial: Fernando Soares - email: comercial@legionnarios.com </p>
          <p>&nbsp;</p></th>
      </tr>
      <tr>
        <th align="left" valign="top" scope="col"><p id="loadBar" style="display:none;">
		<span class="texto_negrito">Aguarde enquanto a mensagem é enviada!</span><br />

		<img src="images/loading.gif" alt="Loading" title="Sending Email" />
	</p>
	<p class="texto_negrito" id="emailSuccess" style="display:none;">
		<strong>Success! Your Email has been sent.</strong>	</p>
	<div id="contactFormArea">
		<form action="scripts/contact.php" method="post" id="cForm">
			<fieldset>
				<label for="posName" class="texto_negrito">Nome:</label>
				<input class="text" type="text" size="25" name="posName" id="posName" />
				<label for="posEmail" class="texto_negrito">Email:</label>
				<input class="text" type="text" size="25" name="posEmail" id="posEmail" />
				<label for="posRegard" class="texto_negrito">Cidade:</label>
				<input class="text" type="text" size="25" name="posRegard" id="posRegard" />
				<label for="posText"><span class="texto_negrito">Mensagem</span><span class="texto_negrito">:</span></label>
				<textarea cols="50" rows="5" name="posText" id="posText"></textarea>
				<label for="selfCC">
					<input type="checkbox" name="selfCC" id="selfCC" value="send" />
					<span class="texto_negrito"> Enviar um cópia para o você mesmo. </span><br />
				    <br />
				</label>
				<label>
...
<area shape="rect" coords="12,132,83,153" href="jornais.php" />
</map>
...
<map name="conteudo_r1_c1Map" id="conteudo_r1_c1Map"><area shape="rect" coords="6,5,141,17" href="mailto:saquabb@hotmail.com" />
</map></body>
</html>
