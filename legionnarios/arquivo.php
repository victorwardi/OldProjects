...
$query_agenda = "SELECT * FROM noticias ORDER BY id DESC";
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center" valign="middle" bgcolor="#0E0C0D"><img src="images/titulos/noticias.jpg" alt="Agenda" width="260" height="40" /></td>
  ...
  <tr>
    <td colspan="5" align="center" valign="top" background="images/conteudo/conteudo_r6_c1.jpg"><table width="90%" border="0" cellpadding="0">
      <tr>
        <th height="42" align="left" class="texto" scope="col">Confira todas as not&iacute;cias e novidades da Banda! </th>
      </tr>
      <tr>
        <th align="left" valign="top" scope="col"><?php do { ?>
            <table width="76%" border="0" cellpadding="4" cellspacing="0">
                <tr>
                  <th width="11%" align="center" valign="middle" scope="col"><a href="noticia.php?id=<?php echo $row_agenda['id'];?>"><img src="<?php echo tNG_showDynamicThumbnail("", "fotos/", "{agenda.imagem}",60,46, false); ?>" border="0" class="borda_branca_1px" /></a></th>
                  <th width="71%" align="left" valign="middle" class="texto_negrito" scope="col"><?php echo $row_agenda['titulo']; ?> -   <?php echo $row_agenda['data']; ?></th>
                  <th width="18%" align="left" valign="middle" class="texto_negrito" scope="col"><a href="noticia.php?id=<?php echo $row_agenda['id'];?>"><img src="images/mais.jpg" alt="leia mais" width="81" height="25" border="0" /></a></th>
                </tr>
              </table>
...
<area shape="rect" coords="15,133,81,155" href="jornais.php" />
</map>
...
<map name="conteudo_r1_c1Map" id="conteudo_r1_c1Map"><area shape="rect" coords="3,4,146,17" href="mailto:saquabb@hotmail.com" />
</map></body>
</html>
<?php
