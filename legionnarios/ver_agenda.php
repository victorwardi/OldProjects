...
$query_Recordset1 = sprintf("SELECT * FROM agenda WHERE id = %s ORDER BY id ASC", $colname_Recordset1);
$Recordset1 = mysql_query($query_Recordset1, $legion) or die(mysql_error());
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3"><img name="conteudo_r1_c1" src="images/conteudo/conteudo_r1_c1.jpg" width="398" height="166" border="0" id="conteudo_r1_c1" alt="" /></td>
    ...
    <td colspan="5" align="center" valign="top" background="images/conteudo/conteudo_r6_c1.jpg"><table width="90%" border="0" cellpadding="0">
      <tr>
        <th align="left" scope="col"><table width="100%" border="0" cellspacing="4" cellpadding="0">
          <tr>
            <th height="26" colspan="2" align="center" valign="middle" class="titulo_diogo" scope="col"><?php echo $row_Recordset1['titulo']; ?></th>
          </tr>
          <tr>
            <th colspan="2" align="center" valign="middle" scope="row">&nbsp;
              <?php 
// Show If File Exists (region1)
if (tNG_fileExists("fotos/", "{Recordset1.foto}")) {
?>
                <img src="<?php echo tNG_showDynamicThumbnail("", "fotos/", "{Recordset1.foto}", 500, 0, true); ?>" class="borda_branca_1px" />
                <?php } 
// EndIf File Exists (region1)
?></th>
          </tr>
          <tr>
            <th width="50%" height="28" align="center" class="texto_negrito" scope="row">Local: <span class="texto"><?php echo $row_Recordset1['local']; ?></span></th>
            <th width="50%" align="center" class="texto_negrito" scope="row">Data: <span class="texto"><?php echo $row_Recordset1['data']; ?></span></th>
          </tr>
          <tr>
            <th colspan="2" align="left" valign="top" class="texto" scope="row"><?php echo $row_Recordset1['descricao']; ?></th>
          </tr>
        </table></th>
      </tr>
      <tr>
...
<area shape="rect" coords="12,135,84,156" href="jornais.php" />
</map>
